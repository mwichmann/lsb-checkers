...
extern size_t __confstr_chk_db(int, char *, size_t, size_t);
...
extern int __getlogin_r_chk_db(char *, size_t, size_t);
CheckInterfacedef(__getlogin_r_chk,__getlogin_r_chk_db);
extern ssize_t __pread64_chk_db(int, void *, size_t, off64_t, size_t);
CheckInterfacedef(__pread64_chk,__pread64_chk_db);
extern ssize_t __pread_chk_db(int, void *, size_t, off_t, size_t);
CheckInterfacedef(__pread_chk,__pread_chk_db);
extern ssize_t __read_chk_db(int, void *, size_t, size_t);
CheckInterfacedef(__read_chk,__read_chk_db);
extern ssize_t __readlink_chk_db(const char *, char *, size_t, size_t);
CheckInterfacedef(__readlink_chk,__readlink_chk_db);
extern int __ttyname_r_chk_db(int, char *, size_t, size_t);
CheckInterfacedef(__ttyname_r_chk,__ttyname_r_chk_db);
extern ssize_t readlinkat_db(int, const char *, char *, size_t);
