...
#elif 1
CheckTypeSize(struct XDR,0, 9934, 1);
Msg("Missing member data for XDR on All\n");
CheckOffset(struct XDR,x_op,0,1,32162);
CheckOffset(struct XDR,x_ops,0,1,32193);
CheckOffset(struct XDR,x_public,0,1,32194);
CheckOffset(struct XDR,x_private,0,1,32195);
CheckOffset(struct XDR,x_base,0,1,32196);
CheckOffset(struct XDR,x_handy,0,1,32197);
#endif
...
#elif 1
CheckTypeSize(xdrproc_t,0, 9948, 1);
#endif
...
#elif 1
CheckTypeSize(struct xdr_ops,0, 9935, 1);
Msg("Missing member data for xdr_ops on All\n");
CheckOffset(struct xdr_ops,x_getlong,0,1,32165);
CheckOffset(struct xdr_ops,x_putlong,0,1,32168);
CheckOffset(struct xdr_ops,x_getbytes,0,1,32172);
CheckOffset(struct xdr_ops,x_putbytes,0,1,32176);
CheckOffset(struct xdr_ops,x_getpostn,0,1,32178);
CheckOffset(struct xdr_ops,x_setpostn,0,1,32181);
CheckOffset(struct xdr_ops,x_inline,0,1,32184);
CheckOffset(struct xdr_ops,x_destroy,0,1,32186);
CheckOffset(struct xdr_ops,x_getint32,0,1,32189);
CheckOffset(struct xdr_ops,x_putint32,0,1,32192);
#endif
...
#elif 1
CheckTypeSize(struct xdr_discrim,0, 9949, 1);
Msg("Missing member data for xdr_discrim on All\n");
CheckOffset(struct xdr_discrim,value,0,1,32198);
CheckOffset(struct xdr_discrim,proc,0,1,32199);
#endif
