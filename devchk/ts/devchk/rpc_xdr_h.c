...
CheckMemberSize(struct XDR,x_ops,0,6,32193)
CheckOffset(struct XDR,x_ops,4,6,32193)
CheckMemberSize(struct XDR,x_public,0,6,32194)
CheckOffset(struct XDR,x_public,8,6,32194)
CheckMemberSize(struct XDR,x_private,0,6,32195)
CheckOffset(struct XDR,x_private,12,6,32195)
CheckMemberSize(struct XDR,x_base,0,6,32196)
CheckOffset(struct XDR,x_base,16,6,32196)
CheckMemberSize(struct XDR,x_handy,0,6,32197)
CheckOffset(struct XDR,x_handy,20,6,32197)
#elif __powerpc64__
CheckTypeSize(struct XDR,48, 9934, 9)
CheckMemberSize(struct XDR,x_ops,0,9,32193)
CheckOffset(struct XDR,x_ops,8,9,32193)
CheckMemberSize(struct XDR,x_public,0,9,32194)
CheckOffset(struct XDR,x_public,16,9,32194)
CheckMemberSize(struct XDR,x_private,0,9,32195)
CheckOffset(struct XDR,x_private,24,9,32195)
CheckMemberSize(struct XDR,x_base,0,9,32196)
CheckOffset(struct XDR,x_base,32,9,32196)
CheckMemberSize(struct XDR,x_handy,0,9,32197)
...
CheckMemberSize(struct xdr_ops,x_putlong,0,6,32168)
CheckOffset(struct xdr_ops,x_putlong,4,6,32168)
CheckMemberSize(struct xdr_ops,x_getbytes,0,6,32172)
CheckOffset(struct xdr_ops,x_getbytes,8,6,32172)
CheckMemberSize(struct xdr_ops,x_putbytes,0,6,32176)
CheckOffset(struct xdr_ops,x_putbytes,12,6,32176)
CheckMemberSize(struct xdr_ops,x_getpostn,0,6,32178)
CheckOffset(struct xdr_ops,x_getpostn,16,6,32178)
CheckMemberSize(struct xdr_ops,x_setpostn,0,6,32181)
CheckOffset(struct xdr_ops,x_setpostn,20,6,32181)
CheckMemberSize(struct xdr_ops,x_inline,0,6,32184)
CheckOffset(struct xdr_ops,x_inline,24,6,32184)
CheckMemberSize(struct xdr_ops,x_destroy,0,6,32186)
CheckOffset(struct xdr_ops,x_destroy,28,6,32186)
CheckMemberSize(struct xdr_ops,x_getint32,0,6,32189)
CheckOffset(struct xdr_ops,x_getint32,32,6,32189)
CheckMemberSize(struct xdr_ops,x_putint32,0,6,32192)
CheckOffset(struct xdr_ops,x_putint32,36,6,32192)
#elif __powerpc64__
CheckTypeSize(struct xdr_ops,80, 9935, 9)
CheckMemberSize(struct xdr_ops,x_putlong,0,9,32168)
CheckOffset(struct xdr_ops,x_putlong,8,9,32168)
CheckMemberSize(struct xdr_ops,x_getbytes,0,9,32172)
CheckOffset(struct xdr_ops,x_getbytes,16,9,32172)
CheckMemberSize(struct xdr_ops,x_putbytes,0,9,32176)
CheckOffset(struct xdr_ops,x_putbytes,24,9,32176)
CheckMemberSize(struct xdr_ops,x_getpostn,0,9,32178)
CheckOffset(struct xdr_ops,x_getpostn,32,9,32178)
CheckMemberSize(struct xdr_ops,x_setpostn,0,9,32181)
CheckOffset(struct xdr_ops,x_setpostn,40,9,32181)
CheckMemberSize(struct xdr_ops,x_inline,0,9,32184)
CheckOffset(struct xdr_ops,x_inline,48,9,32184)
CheckMemberSize(struct xdr_ops,x_destroy,0,9,32186)
CheckOffset(struct xdr_ops,x_destroy,56,9,32186)
CheckMemberSize(struct xdr_ops,x_getint32,0,9,32189)
CheckOffset(struct xdr_ops,x_getint32,64,9,32189)
CheckMemberSize(struct xdr_ops,x_putint32,0,9,32192)
...
CheckMemberSize(struct xdr_discrim,proc,0,6,32199)
CheckOffset(struct xdr_discrim,proc,4,6,32199)
#elif __powerpc64__
CheckTypeSize(struct xdr_discrim,16, 9949, 9)
CheckMemberSize(struct xdr_discrim,proc,0,9,32199)
