...
#if defined __s390x__
CheckTypeSize(XcmsConversionProc,8, 8867, 12, 1.3, NULL, 8865, NULL)
#elif defined __x86_64__
CheckTypeSize(XcmsConversionProc,8, 8867, 11, 2.0, NULL, 8865, NULL)
#elif defined __s390__ && !defined __s390x__
CheckTypeSize(XcmsConversionProc,4, 8867, 10, 1.3, NULL, 8865, NULL)
#elif defined __powerpc64__
CheckTypeSize(XcmsConversionProc,8, 8867, 9, 2.0, NULL, 8865, NULL)
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(XcmsConversionProc,4, 8867, 6, 1.2, NULL, 8865, NULL)
#elif defined __ia64__
CheckTypeSize(XcmsConversionProc,8, 8867, 3, 1.3, NULL, 8865, NULL)
#elif defined __i386__
