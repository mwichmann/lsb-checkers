...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.2""',NULL,25115,NULL);\n",architecture,27339,0);
#endif
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.2""',NULL,7018,NULL);\n",architecture,27415,0);
#endif
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.2""',NULL,9858, NULL);\n",architecture,27848,0);
#endif
...
return;
#else
Msg("%d tests passed out of %d tests in alsa/global.h\n\n",pcnt,cnt);
return cnt;
#endif
