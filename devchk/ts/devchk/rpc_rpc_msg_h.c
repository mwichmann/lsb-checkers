...
CheckMemberSize(struct accepted_reply,ar_stat,0,6,34801)
CheckOffset(struct accepted_reply,ar_stat,12,6,34801)
CheckMemberSize(struct accepted_reply,ru,0,6,34830)
...
CheckMemberSize(struct rejected_reply,ru,0,6,34813)
...
CheckMemberSize(struct reply_body,ru,0,6,34817)
...
CheckMemberSize(struct call_body,cb_prog,0,6,34819)
CheckOffset(struct call_body,cb_prog,4,6,34819)
CheckMemberSize(struct call_body,cb_vers,0,6,34820)
CheckOffset(struct call_body,cb_vers,8,6,34820)
CheckMemberSize(struct call_body,cb_proc,0,6,34821)
CheckOffset(struct call_body,cb_proc,12,6,34821)
CheckMemberSize(struct call_body,cb_cred,0,6,34822)
CheckOffset(struct call_body,cb_cred,16,6,34822)
CheckMemberSize(struct call_body,cb_verf,0,6,34823)
