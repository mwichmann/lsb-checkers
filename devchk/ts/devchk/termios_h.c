...
CheckOffset(struct winsize,ws_col,0,6,34488)
CheckOffset(struct winsize,ws_xpixel,0,6,34489)
CheckOffset(struct winsize,ws_ypixel,0,6,34490)
#elif __s390__
CheckTypeSize(struct winsize,8, 10301, 10)
Msg("Missing member data for winsize on S390\n");
CheckOffset(struct winsize,ws_row,0,10,34487)
CheckOffset(struct winsize,ws_col,0,10,34488)
CheckOffset(struct winsize,ws_xpixel,0,10,34489)
CheckOffset(struct winsize,ws_ypixel,0,10,34490)
#else
...
CheckOffset(struct termios,c_oflag,0,6,34269)
CheckOffset(struct termios,c_cflag,0,6,34270)
CheckOffset(struct termios,c_lflag,0,6,34271)
CheckOffset(struct termios,c_line,0,6,34272)
CheckOffset(struct termios,c_cc,0,6,34273)
CheckOffset(struct termios,c_ispeed,0,6,34274)
CheckOffset(struct termios,c_ospeed,0,6,34275)
#elif __s390__
CheckTypeSize(struct termios,60, 9187, 10)
Msg("Missing member data for termios on S390\n");
CheckOffset(struct termios,c_iflag,0,10,34268)
CheckOffset(struct termios,c_oflag,0,10,34269)
CheckOffset(struct termios,c_cflag,0,10,34270)
CheckOffset(struct termios,c_lflag,0,10,34271)
CheckOffset(struct termios,c_line,0,10,34272)
CheckOffset(struct termios,c_cc,0,10,34273)
CheckOffset(struct termios,c_ispeed,0,10,34274)
CheckOffset(struct termios,c_ospeed,0,10,34275)
#else
Msg("REPLACE INTO ArchType VALUES (%d,%d,%d);\n",architecture,9187,0);
