...
CheckMemberSize(struct winsize,ws_col,0,6,34488)
CheckOffset(struct winsize,ws_col,2,6,34488)
CheckMemberSize(struct winsize,ws_xpixel,0,6,34489)
CheckOffset(struct winsize,ws_xpixel,4,6,34489)
CheckMemberSize(struct winsize,ws_ypixel,0,6,34490)
CheckOffset(struct winsize,ws_ypixel,6,6,34490)
#elif __s390__
CheckTypeSize(struct winsize,8, 10301, 10)
CheckMemberSize(struct winsize,ws_col,0,10,34488)
CheckOffset(struct winsize,ws_col,2,10,34488)
CheckMemberSize(struct winsize,ws_xpixel,0,10,34489)
CheckOffset(struct winsize,ws_xpixel,4,10,34489)
CheckMemberSize(struct winsize,ws_ypixel,0,10,34490)
CheckOffset(struct winsize,ws_ypixel,6,10,34490)
#elif __powerpc64__
CheckTypeSize(struct winsize,8, 10301, 9)
CheckMemberSize(struct winsize,ws_col,0,9,34488)
CheckOffset(struct winsize,ws_col,2,9,34488)
CheckMemberSize(struct winsize,ws_xpixel,0,9,34489)
CheckOffset(struct winsize,ws_xpixel,4,9,34489)
CheckMemberSize(struct winsize,ws_ypixel,0,9,34490)
...
CheckMemberSize(struct termios,c_oflag,0,6,34269)
CheckOffset(struct termios,c_oflag,4,6,34269)
CheckMemberSize(struct termios,c_cflag,0,6,34270)
CheckOffset(struct termios,c_cflag,8,6,34270)
CheckMemberSize(struct termios,c_lflag,0,6,34271)
CheckOffset(struct termios,c_lflag,12,6,34271)
CheckMemberSize(struct termios,c_line,0,6,34272)
CheckOffset(struct termios,c_line,16,6,34272)
CheckMemberSize(struct termios,c_cc,0,6,34273)
CheckOffset(struct termios,c_cc,17,6,34273)
CheckMemberSize(struct termios,c_ispeed,0,6,34274)
CheckOffset(struct termios,c_ispeed,52,6,34274)
CheckMemberSize(struct termios,c_ospeed,0,6,34275)
CheckOffset(struct termios,c_ospeed,56,6,34275)
#elif __s390__
CheckTypeSize(struct termios,60, 9187, 10)
CheckMemberSize(struct termios,c_oflag,0,10,34269)
CheckOffset(struct termios,c_oflag,4,10,34269)
CheckMemberSize(struct termios,c_cflag,0,10,34270)
CheckOffset(struct termios,c_cflag,8,10,34270)
CheckMemberSize(struct termios,c_lflag,0,10,34271)
CheckOffset(struct termios,c_lflag,12,10,34271)
CheckMemberSize(struct termios,c_line,0,10,34272)
CheckOffset(struct termios,c_line,16,10,34272)
CheckMemberSize(struct termios,c_cc,0,10,34273)
CheckOffset(struct termios,c_cc,17,10,34273)
CheckMemberSize(struct termios,c_ispeed,0,10,34274)
CheckOffset(struct termios,c_ispeed,52,10,34274)
CheckMemberSize(struct termios,c_ospeed,0,10,34275)
CheckOffset(struct termios,c_ospeed,56,10,34275)
#elif __powerpc64__
CheckTypeSize(struct termios,60, 9187, 9)
CheckMemberSize(struct termios,c_oflag,0,9,34269)
CheckOffset(struct termios,c_oflag,4,9,34269)
CheckMemberSize(struct termios,c_cflag,0,9,34270)
CheckOffset(struct termios,c_cflag,8,9,34270)
CheckMemberSize(struct termios,c_lflag,0,9,34271)
CheckOffset(struct termios,c_lflag,12,9,34271)
CheckMemberSize(struct termios,c_line,0,9,34272)
CheckOffset(struct termios,c_line,16,9,34272)
CheckMemberSize(struct termios,c_cc,0,9,34273)
CheckOffset(struct termios,c_cc,17,9,34273)
CheckMemberSize(struct termios,c_ispeed,0,9,34274)
CheckOffset(struct termios,c_ispeed,52,9,34274)
CheckMemberSize(struct termios,c_ospeed,0,9,34275)
