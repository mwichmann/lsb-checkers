...
CheckMemberSize(struct stat,st_atimensec,4,10,40329)
CheckOffset(struct stat,st_atimensec,60,10,40329)
CheckMemberSize(struct stat,st_mtime,4,10,40330)
CheckOffset(struct stat,st_mtime,64,10,40330)
CheckMemberSize(struct stat,st_mtimensec,4,10,40331)
CheckOffset(struct stat,st_mtimensec,68,10,40331)
CheckMemberSize(struct stat,st_ctime,4,10,40332)
CheckOffset(struct stat,st_ctime,72,10,40332)
CheckMemberSize(struct stat,st_ctimensec,4,10,40333)
CheckOffset(struct stat,st_ctimensec,76,10,40333)
...
CheckMemberSize(struct stat64,st_atimensec,4,10,40559)
CheckOffset(struct stat64,st_atimensec,76,10,40559)
CheckMemberSize(struct stat64,st_mtime,4,10,40560)
CheckOffset(struct stat64,st_mtime,80,10,40560)
CheckMemberSize(struct stat64,st_mtimensec,4,10,40561)
CheckOffset(struct stat64,st_mtimensec,84,10,40561)
CheckMemberSize(struct stat64,st_ctime,4,10,40562)
CheckOffset(struct stat64,st_ctime,88,10,40562)
CheckMemberSize(struct stat64,st_ctimensec,4,10,40563)
CheckOffset(struct stat64,st_ctimensec,92,10,40563)
