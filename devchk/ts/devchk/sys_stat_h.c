...
CheckMemberSize(struct stat,st_atim,4,2,33644)
CheckOffset(struct stat,st_atim,56,2,33644)
CheckMemberSize(struct stat,st_mtim,4,2,33646)
CheckOffset(struct stat,st_mtim,64,2,33646)
CheckMemberSize(struct stat,st_ctim,4,2,33648)
...
CheckMemberSize(struct stat64,st_atim,4,2,33664)
CheckOffset(struct stat64,st_atim,64,2,33664)
CheckMemberSize(struct stat64,st_mtim,4,2,33666)
CheckOffset(struct stat64,st_mtim,72,2,33666)
CheckMemberSize(struct stat64,st_ctim,4,2,33668)
...
CheckMemberSize(struct stat,st_atim,8,3,34679)
CheckOffset(struct stat,st_atim,56,3,34679)
CheckMemberSize(struct stat,st_mtim,8,3,34681)
CheckOffset(struct stat,st_mtim,72,3,34681)
CheckMemberSize(struct stat,st_ctim,8,3,34682)
...
CheckMemberSize(struct stat64,st_atim,8,3,34888)
CheckOffset(struct stat64,st_atim,56,3,34888)
CheckMemberSize(struct stat64,st_mtim,8,3,34890)
CheckOffset(struct stat64,st_mtim,72,3,34890)
CheckMemberSize(struct stat64,st_ctim,8,3,34892)
...
CheckMemberSize(struct stat,st_atim,8,9,40097)
CheckOffset(struct stat,st_atim,72,9,40097)
CheckMemberSize(struct stat,st_mtim,8,9,40099)
CheckOffset(struct stat,st_mtim,88,9,40099)
CheckMemberSize(struct stat,st_ctim,8,9,40101)
...
CheckMemberSize(struct stat64,st_atim,8,9,40117)
CheckOffset(struct stat64,st_atim,72,9,40117)
CheckMemberSize(struct stat64,st_mtim,8,9,40119)
CheckOffset(struct stat64,st_mtim,88,9,40119)
CheckMemberSize(struct stat64,st_ctim,8,9,40121)
...
CheckMemberSize(struct stat,st_atim,8,12,40237)
CheckOffset(struct stat,st_atim,56,12,40237)
CheckMemberSize(struct stat,st_mtim,8,12,40239)
CheckOffset(struct stat,st_mtim,72,12,40239)
CheckMemberSize(struct stat,st_ctim,8,12,40241)
...
CheckMemberSize(struct stat64,st_atim,8,12,40254)
CheckOffset(struct stat64,st_atim,56,12,40254)
CheckMemberSize(struct stat64,st_mtim,8,12,40256)
CheckOffset(struct stat64,st_mtim,72,12,40256)
CheckMemberSize(struct stat64,st_ctim,8,12,40258)
...
CheckMemberSize(struct stat,st_atim,4,10,40328)
CheckOffset(struct stat,st_atim,56,10,40328)
CheckMemberSize(struct stat,st_mtim,4,10,40330)
CheckOffset(struct stat,st_mtim,64,10,40330)
CheckMemberSize(struct stat,st_ctim,4,10,40332)
...
CheckMemberSize(struct stat64,st_atim,4,10,40558)
CheckOffset(struct stat64,st_atim,72,10,40558)
CheckMemberSize(struct stat64,st_mtim,4,10,40560)
CheckOffset(struct stat64,st_mtim,80,10,40560)
CheckMemberSize(struct stat64,st_ctim,4,10,40562)
