...
#if __s390x__
CheckTypeSize(struct stat,28, 10550, 12)
CheckMemberSize(struct stat,st_dev,0,12,40228)
CheckOffset(struct stat,st_dev,0,12,40228)
CheckMemberSize(struct stat,st_ino,0,12,40229)
CheckOffset(struct stat,st_ino,0,12,40229)
CheckMemberSize(struct stat,st_nlink,0,12,40230)
CheckOffset(struct stat,st_nlink,0,12,40230)
CheckMemberSize(struct stat,st_mode,0,12,40231)
CheckOffset(struct stat,st_mode,0,12,40231)
CheckMemberSize(struct stat,st_uid,0,12,40232)
CheckOffset(struct stat,st_uid,0,12,40232)
CheckMemberSize(struct stat,st_gid,0,12,40233)
CheckOffset(struct stat,st_gid,0,12,40233)
CheckMemberSize(struct stat,pad0,4,12,40234)
CheckOffset(struct stat,pad0,0,12,40234)
CheckMemberSize(struct stat,st_rdev,0,12,40235)
CheckOffset(struct stat,st_rdev,4,12,40235)
CheckMemberSize(struct stat,st_size,0,12,40236)
CheckOffset(struct stat,st_size,4,12,40236)
CheckMemberSize(struct stat,st_atime,0,12,40237)
CheckOffset(struct stat,st_atime,4,12,40237)
CheckMemberSize(struct stat,__reserved0,8,12,40238)
CheckOffset(struct stat,__reserved0,4,12,40238)
CheckMemberSize(struct stat,st_mtime,0,12,40239)
CheckOffset(struct stat,st_mtime,12,12,40239)
CheckMemberSize(struct stat,__reserved1,8,12,40240)
CheckOffset(struct stat,__reserved1,12,12,40240)
CheckMemberSize(struct stat,st_ctime,0,12,40241)
CheckOffset(struct stat,st_ctime,20,12,40241)
CheckMemberSize(struct stat,__reserved2,8,12,40242)
CheckOffset(struct stat,__reserved2,20,12,40242)
CheckMemberSize(struct stat,st_blksize,0,12,40243)
CheckOffset(struct stat,st_blksize,28,12,40243)
CheckMemberSize(struct stat,st_blocks,0,12,40244)
CheckOffset(struct stat,st_blocks,28,12,40244)
#endif

#if __s390x__
CheckTypeSize(struct stat64,16, 10551, 12)
CheckMemberSize(struct stat64,st_dev,0,12,40245)
CheckOffset(struct stat64,st_dev,0,12,40245)
CheckMemberSize(struct stat64,st_ino,0,12,40246)
CheckOffset(struct stat64,st_ino,0,12,40246)
CheckMemberSize(struct stat64,st_nlink,0,12,40247)
CheckOffset(struct stat64,st_nlink,0,12,40247)
CheckMemberSize(struct stat64,st_mode,0,12,40248)
CheckOffset(struct stat64,st_mode,0,12,40248)
CheckMemberSize(struct stat64,st_uid,0,12,40249)
CheckOffset(struct stat64,st_uid,0,12,40249)
CheckMemberSize(struct stat64,st_gid,0,12,40250)
CheckOffset(struct stat64,st_gid,0,12,40250)
CheckMemberSize(struct stat64,pad0,4,12,40251)
CheckOffset(struct stat64,pad0,0,12,40251)
CheckMemberSize(struct stat64,st_rdev,0,12,40252)
CheckOffset(struct stat64,st_rdev,4,12,40252)
CheckMemberSize(struct stat64,st_size,0,12,40253)
CheckOffset(struct stat64,st_size,4,12,40253)
CheckMemberSize(struct stat64,st_atime,0,12,40254)
CheckOffset(struct stat64,st_atime,4,12,40254)
CheckMemberSize(struct stat64,__reserved0,4,12,40255)
CheckOffset(struct stat64,__reserved0,4,12,40255)
CheckMemberSize(struct stat64,st_mtime,0,12,40256)
CheckOffset(struct stat64,st_mtime,8,12,40256)
CheckMemberSize(struct stat64,__reserved1,4,12,40257)
CheckOffset(struct stat64,__reserved1,8,12,40257)
CheckMemberSize(struct stat64,st_ctime,0,12,40258)
CheckOffset(struct stat64,st_ctime,12,12,40258)
CheckMemberSize(struct stat64,__reserved2,4,12,40259)
CheckOffset(struct stat64,__reserved2,12,12,40259)
CheckMemberSize(struct stat64,st_blksize,0,12,40260)
CheckOffset(struct stat64,st_blksize,16,12,40260)
CheckMemberSize(struct stat64,st_blocks,0,12,40261)
CheckOffset(struct stat64,st_blocks,16,12,40261)
#endif
