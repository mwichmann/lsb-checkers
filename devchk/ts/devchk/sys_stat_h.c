...
CheckMemberSize(struct stat,__pad1,4,10,33633)
CheckOffset(struct stat,__pad1,8,10,33633)
CheckMemberSize(struct stat,st_ino,4,10,33634)
CheckOffset(struct stat,st_ino,12,10,33634)
CheckMemberSize(struct stat,st_mode,4,10,33635)
CheckOffset(struct stat,st_mode,16,10,33635)
CheckMemberSize(struct stat,st_nlink,4,10,33636)
CheckOffset(struct stat,st_nlink,20,10,33636)
CheckMemberSize(struct stat,st_uid,4,10,33637)
CheckOffset(struct stat,st_uid,24,10,33637)
CheckMemberSize(struct stat,st_gid,4,10,33638)
CheckOffset(struct stat,st_gid,28,10,33638)
CheckMemberSize(struct stat,st_rdev,8,10,33639)
CheckOffset(struct stat,st_rdev,32,10,33639)
CheckMemberSize(struct stat,__pad2,4,10,33640)
CheckOffset(struct stat,__pad2,40,10,33640)
CheckMemberSize(struct stat,st_size,4,10,33641)
CheckOffset(struct stat,st_size,44,10,33641)
CheckMemberSize(struct stat,st_blksize,4,10,33642)
CheckOffset(struct stat,st_blksize,48,10,33642)
CheckMemberSize(struct stat,st_blocks,4,10,33643)
CheckOffset(struct stat,st_blocks,52,10,33643)
CheckMemberSize(struct stat,st_atime,4,10,33644)
CheckOffset(struct stat,st_atime,56,10,33644)
CheckMemberSize(struct stat,__unused1,4,10,33645)
CheckOffset(struct stat,__unused1,60,10,33645)
CheckMemberSize(struct stat,st_mtime,4,10,33646)
CheckOffset(struct stat,st_mtime,64,10,33646)
CheckMemberSize(struct stat,__unused2,4,10,33647)
CheckOffset(struct stat,__unused2,68,10,33647)
CheckMemberSize(struct stat,st_ctime,4,10,33648)
CheckOffset(struct stat,st_ctime,72,10,33648)
CheckMemberSize(struct stat,__unused3,4,10,33649)
CheckOffset(struct stat,__unused3,76,10,33649)
CheckMemberSize(struct stat,__unused4,4,10,33650)
CheckOffset(struct stat,__unused4,80,10,33650)
CheckMemberSize(struct stat,__unused5,4,10,33651)
...
CheckMemberSize(struct stat64,__pad1,4,10,33653)
CheckOffset(struct stat64,__pad1,8,10,33653)
CheckMemberSize(struct stat64,__st_ino,4,10,33654)
CheckOffset(struct stat64,__st_ino,12,10,33654)
CheckMemberSize(struct stat64,st_mode,4,10,33655)
CheckOffset(struct stat64,st_mode,16,10,33655)
CheckMemberSize(struct stat64,st_nlink,4,10,33656)
CheckOffset(struct stat64,st_nlink,20,10,33656)
CheckMemberSize(struct stat64,st_uid,4,10,33657)
CheckOffset(struct stat64,st_uid,24,10,33657)
CheckMemberSize(struct stat64,st_gid,4,10,33658)
CheckOffset(struct stat64,st_gid,28,10,33658)
CheckMemberSize(struct stat64,st_rdev,8,10,33659)
CheckOffset(struct stat64,st_rdev,32,10,33659)
CheckMemberSize(struct stat64,__pad2,4,10,33660)
CheckOffset(struct stat64,__pad2,40,10,33660)
CheckMemberSize(struct stat64,st_size,8,10,33661)
CheckOffset(struct stat64,st_size,48,10,33661)
CheckMemberSize(struct stat64,st_blksize,4,10,33662)
CheckOffset(struct stat64,st_blksize,56,10,33662)
CheckMemberSize(struct stat64,st_blocks,8,10,33663)
CheckOffset(struct stat64,st_blocks,64,10,33663)
CheckMemberSize(struct stat64,st_atime,4,10,33664)
CheckOffset(struct stat64,st_atime,72,10,33664)
CheckMemberSize(struct stat64,__unused1,4,10,33665)
CheckOffset(struct stat64,__unused1,76,10,33665)
CheckMemberSize(struct stat64,st_mtime,4,10,33666)
CheckOffset(struct stat64,st_mtime,80,10,33666)
CheckMemberSize(struct stat64,__unused2,4,10,33667)
CheckOffset(struct stat64,__unused2,84,10,33667)
CheckMemberSize(struct stat64,st_ctime,4,10,33668)
CheckOffset(struct stat64,st_ctime,88,10,33668)
CheckMemberSize(struct stat64,__unused3,4,10,33669)
CheckOffset(struct stat64,__unused3,92,10,33669)
CheckMemberSize(struct stat64,st_ino,8,10,33670)
...
CheckMemberSize(struct stat,st_atime,4,10,40328)
CheckOffset(struct stat,st_atime,56,10,40328)
CheckMemberSize(struct stat,__unused1,4,10,40329)
CheckOffset(struct stat,__unused1,60,10,40329)
CheckMemberSize(struct stat,st_mtime,4,10,40330)
CheckOffset(struct stat,st_mtime,64,10,40330)
CheckMemberSize(struct stat,__unused2,4,10,40331)
CheckOffset(struct stat,__unused2,68,10,40331)
CheckMemberSize(struct stat,st_ctime,4,10,40332)
CheckOffset(struct stat,st_ctime,72,10,40332)
CheckMemberSize(struct stat,__unused3,4,10,40333)
CheckOffset(struct stat,__unused3,76,10,40333)
...
#if __x86_64__
CheckTypeSize(struct stat,100, 10805, 11)
CheckMemberSize(struct stat,st_dev,4,11,40514)
CheckOffset(struct stat,st_dev,0,11,40514)
CheckMemberSize(struct stat,st_ino,4,11,40515)
CheckOffset(struct stat,st_ino,0,11,40515)
CheckMemberSize(struct stat,st_nlink,4,11,40516)
CheckOffset(struct stat,st_nlink,0,11,40516)
CheckMemberSize(struct stat,st_mode,4,11,40517)
CheckOffset(struct stat,st_mode,0,11,40517)
CheckMemberSize(struct stat,st_uid,4,11,40518)
CheckOffset(struct stat,st_uid,0,11,40518)
CheckMemberSize(struct stat,st_gid,4,11,40519)
CheckOffset(struct stat,st_gid,0,11,40519)
CheckMemberSize(struct stat,__pad0,4,11,40520)
CheckOffset(struct stat,__pad0,0,11,40520)
CheckMemberSize(struct stat,st_rdev,4,11,40521)
CheckOffset(struct stat,st_rdev,0,11,40521)
CheckMemberSize(struct stat,st_size,4,11,40522)
CheckOffset(struct stat,st_size,0,11,40522)
CheckMemberSize(struct stat,st_blksize,4,11,40523)
CheckOffset(struct stat,st_blksize,0,11,40523)
CheckMemberSize(struct stat,st_blocks,4,11,40524)
CheckOffset(struct stat,st_blocks,0,11,40524)
CheckMemberSize(struct stat,st_atime,4,11,40525)
CheckOffset(struct stat,st_atime,0,11,40525)
CheckMemberSize(struct stat,__unused1,8,11,40526)
CheckOffset(struct stat,__unused1,0,11,40526)
CheckMemberSize(struct stat,st_mtime,4,11,40527)
CheckOffset(struct stat,st_mtime,0,11,40527)
CheckMemberSize(struct stat,__unused2,8,11,40528)
CheckOffset(struct stat,__unused2,0,11,40528)
CheckMemberSize(struct stat,st_ctime,4,11,40529)
CheckOffset(struct stat,st_ctime,0,11,40529)
CheckMemberSize(struct stat,__unused3,8,11,40530)
CheckOffset(struct stat,__unused3,0,11,40530)
CheckMemberSize(struct stat,__unused,24,11,40531)
CheckOffset(struct stat,__unused,0,11,40531)
#endif

#if __x86_64__
CheckTypeSize(struct stat64,100, 10808, 11)
CheckMemberSize(struct stat64,st_dev,4,11,40532)
CheckOffset(struct stat64,st_dev,0,11,40532)
CheckMemberSize(struct stat64,st_ino,4,11,40533)
CheckOffset(struct stat64,st_ino,0,11,40533)
CheckMemberSize(struct stat64,st_nlink,4,11,40534)
CheckOffset(struct stat64,st_nlink,0,11,40534)
CheckMemberSize(struct stat64,st_mode,4,11,40535)
CheckOffset(struct stat64,st_mode,0,11,40535)
CheckMemberSize(struct stat64,st_uid,4,11,40536)
CheckOffset(struct stat64,st_uid,0,11,40536)
CheckMemberSize(struct stat64,st_gid,4,11,40537)
CheckOffset(struct stat64,st_gid,0,11,40537)
CheckMemberSize(struct stat64,__pad0,4,11,40538)
CheckOffset(struct stat64,__pad0,0,11,40538)
CheckMemberSize(struct stat64,st_rdev,4,11,40539)
CheckOffset(struct stat64,st_rdev,0,11,40539)
CheckMemberSize(struct stat64,st_size,4,11,40540)
CheckOffset(struct stat64,st_size,0,11,40540)
CheckMemberSize(struct stat64,st_blksize,4,11,40541)
CheckOffset(struct stat64,st_blksize,0,11,40541)
CheckMemberSize(struct stat64,st_blocks,4,11,40542)
CheckOffset(struct stat64,st_blocks,0,11,40542)
CheckMemberSize(struct stat64,st_atime,4,11,40543)
CheckOffset(struct stat64,st_atime,0,11,40543)
CheckMemberSize(struct stat64,__unused1,4,11,40544)
CheckOffset(struct stat64,__unused1,0,11,40544)
CheckMemberSize(struct stat64,st_mtime,4,11,40545)
CheckOffset(struct stat64,st_mtime,0,11,40545)
CheckMemberSize(struct stat64,__unused2,4,11,40546)
CheckOffset(struct stat64,__unused2,0,11,40546)
CheckMemberSize(struct stat64,st_ctime,4,11,40547)
CheckOffset(struct stat64,st_ctime,0,11,40547)
CheckMemberSize(struct stat64,__unused3,4,11,40548)
CheckOffset(struct stat64,__unused3,0,11,40548)
CheckMemberSize(struct stat64,__unused,4,11,40549)
CheckOffset(struct stat64,__unused,0,11,40549)
#endif

#if __s390__ && !__s390x__
CheckTypeSize(struct stat64,100, 10809, 10)
CheckMemberSize(struct stat64,st_dev,4,10,40550)
CheckOffset(struct stat64,st_dev,0,10,40550)
CheckMemberSize(struct stat64,__pad1,4,10,40566)
CheckOffset(struct stat64,__pad1,0,10,40566)
CheckMemberSize(struct stat64,__st_ino,4,10,40551)
CheckOffset(struct stat64,__st_ino,0,10,40551)
CheckMemberSize(struct stat64,st_mode,4,10,40552)
CheckOffset(struct stat64,st_mode,0,10,40552)
CheckMemberSize(struct stat64,st_nlink,4,10,40553)
CheckOffset(struct stat64,st_nlink,0,10,40553)
CheckMemberSize(struct stat64,st_uid,4,10,40554)
CheckOffset(struct stat64,st_uid,0,10,40554)
CheckMemberSize(struct stat64,st_gid,4,10,40555)
CheckOffset(struct stat64,st_gid,0,10,40555)
CheckMemberSize(struct stat64,st_rdev,4,10,40556)
CheckOffset(struct stat64,st_rdev,0,10,40556)
CheckMemberSize(struct stat64,__pad2,4,10,40567)
CheckOffset(struct stat64,__pad2,0,10,40567)
CheckMemberSize(struct stat64,st_size,4,10,40557)
CheckOffset(struct stat64,st_size,0,10,40557)
CheckMemberSize(struct stat64,st_blksize,4,10,40564)
CheckOffset(struct stat64,st_blksize,0,10,40564)
CheckMemberSize(struct stat64,st_blocks,4,10,40565)
CheckOffset(struct stat64,st_blocks,0,10,40565)
CheckMemberSize(struct stat64,st_atime,4,10,40558)
CheckOffset(struct stat64,st_atime,0,10,40558)
CheckMemberSize(struct stat64,__unused1,4,10,40559)
CheckOffset(struct stat64,__unused1,0,10,40559)
CheckMemberSize(struct stat64,st_mtime,4,10,40560)
CheckOffset(struct stat64,st_mtime,0,10,40560)
CheckMemberSize(struct stat64,__unused2,4,10,40561)
CheckOffset(struct stat64,__unused2,0,10,40561)
CheckMemberSize(struct stat64,st_ctime,4,10,40562)
CheckOffset(struct stat64,st_ctime,0,10,40562)
CheckMemberSize(struct stat64,__unused3,4,10,40563)
CheckOffset(struct stat64,__unused3,0,10,40563)
CheckMemberSize(struct stat64,st_ino,4,10,40568)
CheckOffset(struct stat64,st_ino,0,10,40568)
#endif
