...
CheckMemberSize(struct stat,st_atime,8,11,40525)
CheckOffset(struct stat,st_atime,72,11,40525)
CheckMemberSize(struct stat,st_mtime,8,11,40527)
CheckOffset(struct stat,st_mtime,88,11,40527)
CheckMemberSize(struct stat,st_ctime,8,11,40529)
CheckOffset(struct stat,st_ctime,104,11,40529)
...
CheckMemberSize(struct stat64,st_atime,8,11,40543)
CheckOffset(struct stat64,st_atime,72,11,40543)
CheckMemberSize(struct stat64,st_mtime,8,11,40545)
CheckOffset(struct stat64,st_mtime,88,11,40545)
CheckMemberSize(struct stat64,st_ctime,8,11,40547)
CheckOffset(struct stat64,st_ctime,104,11,40547)
