...
#if __s390x__
CheckTypeSize(struct stat,120, 10550, 12)
...
#if __s390x__
CheckTypeSize(struct stat64,120, 10551, 12)
...
CheckMemberSize(struct stat64,__reserved0,4,12,40255)
...
CheckMemberSize(struct stat64,__reserved1,4,12,40257)
...
CheckMemberSize(struct stat64,__reserved2,4,12,40259)
...
CheckOffset(struct stat64,st_atime,72,10,40558)
CheckMemberSize(struct stat64,__unused1,4,10,40559)
CheckOffset(struct stat64,__unused1,76,10,40559)
CheckMemberSize(struct stat64,st_mtime,4,10,40560)
CheckOffset(struct stat64,st_mtime,80,10,40560)
CheckMemberSize(struct stat64,__unused2,4,10,40561)
CheckOffset(struct stat64,__unused2,84,10,40561)
CheckMemberSize(struct stat64,st_ctime,4,10,40562)
CheckOffset(struct stat64,st_ctime,88,10,40562)
CheckMemberSize(struct stat64,__unused3,4,10,40563)
CheckOffset(struct stat64,__unused3,92,10,40563)
