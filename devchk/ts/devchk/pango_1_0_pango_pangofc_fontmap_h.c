...
#elif 1
CheckTypeSize(PangoFcFontMap,0, 12604, 1);
#endif
...
#elif 1
CheckTypeSize(PangoFcFontMap *,0, 12605, 1);
#endif
...
#elif 1
CheckTypeSize(PangoFcDecoderFindFunc,0, 12607, 1);
#endif
...
#elif 1
CheckTypeSize(PangoFcFontMapClass,0, 12609, 1);
#endif
