...
CheckTypeSize(struct FT_Module_Class_,0, 16753, 6, 3.2, NULL, 0, NULL)
Msg("Missing member data for FT_Module_Class_ on PPC32\n");
CheckOffset(struct FT_Module_Class_,module_flags,0,6,53974)
CheckOffset(struct FT_Module_Class_,module_size,0,6,53975)
CheckOffset(struct FT_Module_Class_,module_name,0,6,53976)
CheckOffset(struct FT_Module_Class_,module_version,0,6,53977)
CheckOffset(struct FT_Module_Class_,module_requires,0,6,53978)
CheckOffset(struct FT_Module_Class_,module_interface,0,6,53979)
CheckOffset(struct FT_Module_Class_,module_init,0,6,53981)
CheckOffset(struct FT_Module_Class_,module_done,0,6,53983)
CheckOffset(struct FT_Module_Class_,get_interface,0,6,53986)
#elif defined __powerpc64__
CheckTypeSize(struct FT_Module_Class_,0, 16753, 9, 3.2, NULL, 0, NULL)
Msg("Missing member data for FT_Module_Class_ on PPC64\n");
CheckOffset(struct FT_Module_Class_,module_flags,0,9,53974)
CheckOffset(struct FT_Module_Class_,module_size,0,9,53975)
CheckOffset(struct FT_Module_Class_,module_name,0,9,53976)
CheckOffset(struct FT_Module_Class_,module_version,0,9,53977)
CheckOffset(struct FT_Module_Class_,module_requires,0,9,53978)
CheckOffset(struct FT_Module_Class_,module_interface,0,9,53979)
CheckOffset(struct FT_Module_Class_,module_init,0,9,53981)
CheckOffset(struct FT_Module_Class_,module_done,0,9,53983)
CheckOffset(struct FT_Module_Class_,get_interface,0,9,53986)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_Module_Constructor,0, 16763, 6, 3.2, NULL, 16762, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_Module_Constructor,0, 16763, 9, 3.2, NULL, 16762, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_Module_Destructor,0, 16765, 6, 3.2, NULL, 16764, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_Module_Destructor,0, 16765, 9, 3.2, NULL, 16764, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_Module_Interface,0, 16767, 6, 3.2, NULL, 16766, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_Module_Interface,0, 16767, 9, 3.2, NULL, 16766, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_Module_Requester,0, 16769, 6, 3.2, NULL, 16768, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_Module_Requester,0, 16769, 9, 3.2, NULL, 16768, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_Module_Class,0, 16770, 6, 3.2, NULL, 16753, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_Module_Class,0, 16770, 9, 3.2, NULL, 16753, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_DebugHook_Func,0, 16868, 6, 3.2, NULL, 6988, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_DebugHook_Func,0, 16868, 9, 3.2, NULL, 6988, NULL)
#else
