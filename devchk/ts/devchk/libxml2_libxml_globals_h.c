...
#elif 1
CheckTypeSize(xmlOutputBufferCreateFilenameFunc,0, 14917, 1);
#endif
...
#elif 1
CheckTypeSize(xmlOutputBufferCreateFilenameFunc *,0, 14918, 1);
#endif
...
#elif 1
CheckTypeSize(xmlRegisterNodeFunc,0, 14920, 1);
#endif
...
#elif 1
CheckTypeSize(xmlParserInputBufferCreateFilenameFunc,0, 14922, 1);
#endif
...
#elif 1
CheckTypeSize(xmlParserInputBufferCreateFilenameFunc *,0, 14923, 1);
#endif
...
#elif 1
CheckTypeSize(struct _xmlSAXHandlerV1,0, 14924, 1);
Msg("Missing member data for _xmlSAXHandlerV1 on All\n");
CheckOffset(struct _xmlSAXHandlerV1,internalSubset,0,1,49091);
CheckOffset(struct _xmlSAXHandlerV1,isStandalone,0,1,49092);
CheckOffset(struct _xmlSAXHandlerV1,hasInternalSubset,0,1,49093);
CheckOffset(struct _xmlSAXHandlerV1,hasExternalSubset,0,1,49094);
CheckOffset(struct _xmlSAXHandlerV1,resolveEntity,0,1,49095);
CheckOffset(struct _xmlSAXHandlerV1,getEntity,0,1,49096);
CheckOffset(struct _xmlSAXHandlerV1,entityDecl,0,1,49097);
CheckOffset(struct _xmlSAXHandlerV1,notationDecl,0,1,49098);
CheckOffset(struct _xmlSAXHandlerV1,attributeDecl,0,1,49099);
CheckOffset(struct _xmlSAXHandlerV1,elementDecl,0,1,49100);
CheckOffset(struct _xmlSAXHandlerV1,unparsedEntityDecl,0,1,49101);
CheckOffset(struct _xmlSAXHandlerV1,setDocumentLocator,0,1,49102);
CheckOffset(struct _xmlSAXHandlerV1,startDocument,0,1,49103);
CheckOffset(struct _xmlSAXHandlerV1,endDocument,0,1,49104);
CheckOffset(struct _xmlSAXHandlerV1,startElement,0,1,49105);
CheckOffset(struct _xmlSAXHandlerV1,endElement,0,1,49106);
CheckOffset(struct _xmlSAXHandlerV1,reference,0,1,49107);
CheckOffset(struct _xmlSAXHandlerV1,characters,0,1,49108);
CheckOffset(struct _xmlSAXHandlerV1,ignorableWhitespace,0,1,49109);
CheckOffset(struct _xmlSAXHandlerV1,processingInstruction,0,1,49110);
CheckOffset(struct _xmlSAXHandlerV1,comment,0,1,49111);
CheckOffset(struct _xmlSAXHandlerV1,warning,0,1,49112);
CheckOffset(struct _xmlSAXHandlerV1,error,0,1,49113);
CheckOffset(struct _xmlSAXHandlerV1,fatalError,0,1,49114);
CheckOffset(struct _xmlSAXHandlerV1,getParameterEntity,0,1,49115);
CheckOffset(struct _xmlSAXHandlerV1,cdataBlock,0,1,49116);
CheckOffset(struct _xmlSAXHandlerV1,externalSubset,0,1,49117);
CheckOffset(struct _xmlSAXHandlerV1,initialized,0,1,49118);
#endif
...
#elif 1
CheckTypeSize(xmlSAXHandlerV1,0, 14925, 1);
#endif
...
#elif 1
CheckTypeSize(xmlSAXHandlerV1 *,0, 14926, 1);
#endif
...
#elif 1
CheckTypeSize(xmlDeregisterNodeFunc,0, 14927, 1);
#endif
...
#elif 1
CheckTypeSize(xmlDeregisterNodeFunc *,0, 14928, 1);
#endif
...
#elif 1
CheckTypeSize(xmlRegisterNodeFunc *,0, 14929, 1);
#endif
...
#elif 1
CheckTypeSize(xmlBufferAllocationScheme *,0, 14930, 1);
#endif
...
#elif 1
CheckTypeSize(xmlStructuredErrorFunc *,0, 14931, 1);
#endif
...
#elif 1
CheckTypeSize(xmlGlobalState,0, 14933, 1);
#endif
...
#elif 1
CheckTypeSize(xmlGlobalState *,0, 14934, 1);
#endif
...
#elif 1
CheckTypeSize(xmlGlobalStatePtr,0, 14935, 1);
#endif
