...
#if defined __s390x__
CheckTypeSize(struct _xmlSAXHandlerV1,224, 14924, 12, , NULL, 0, NULL)
...
#elif defined __x86_64__
CheckTypeSize(struct _xmlSAXHandlerV1,224, 14924, 11, , NULL, 0, NULL)
...
#elif defined __s390__ && !defined __s390x__
CheckTypeSize(struct _xmlSAXHandlerV1,112, 14924, 10, , NULL, 0, NULL)
...
#elif defined __powerpc64__
CheckTypeSize(struct _xmlSAXHandlerV1,224, 14924, 9, , NULL, 0, NULL)
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(struct _xmlSAXHandlerV1,112, 14924, 6, , NULL, 0, NULL)
...
#elif defined __ia64__
CheckTypeSize(struct _xmlSAXHandlerV1,224, 14924, 3, , NULL, 0, NULL)
...
#elif defined __i386__
CheckTypeSize(struct _xmlSAXHandlerV1,112, 14924, 2, , NULL, 0, NULL)
...
#elif 1
CheckTypeSize(struct _xmlSAXHandlerV1,0, 14924, 1, , NULL, 0, NULL)
...
xmlMallocFunc xmlMallocAtomic_db ;
CheckGlobalVar(xmlMallocAtomic_db, xmlMallocAtomic);
...
xmlStrdupFunc xmlMemStrdup_db ;
CheckGlobalVar(xmlMemStrdup_db, xmlMemStrdup);
...
xmlReallocFunc xmlRealloc_db ;
CheckGlobalVar(xmlRealloc_db, xmlRealloc);
...
xmlMallocFunc xmlMalloc_db ;
CheckGlobalVar(xmlMalloc_db, xmlMalloc);
...
xmlFreeFunc xmlFree_db ;
CheckGlobalVar(xmlFree_db, xmlFree);
