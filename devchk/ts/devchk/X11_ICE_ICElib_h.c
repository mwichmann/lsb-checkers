...
extern int IceRegisterForProtocolReply_db(char *, char *, char *, int, IcePaVersionRec *, int, const char * *, IcePaAuthProc *, IceHostBasedAuthProc, IceProtocolSetupProc, IceProtocolActivateProc, IceIOErrorProc);
CheckInterfacedef(IceRegisterForProtocolReply,IceRegisterForProtocolReply_db);
extern int IceRegisterForProtocolSetup_db(char *, char *, char *, int, IcePoVersionRec *, int, const char * *, IcePoAuthProc *, IceIOErrorProc);
