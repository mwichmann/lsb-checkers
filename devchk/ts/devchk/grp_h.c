...
#elif 1
CheckTypeSize(struct group,0, 6894, 1);
Msg("Missing member data for group on All\n");
CheckOffset(struct group,gr_name,0,1,29792);
CheckOffset(struct group,gr_passwd,0,1,29793);
CheckOffset(struct group,gr_gid,0,1,29794);
CheckOffset(struct group,gr_mem,0,1,29795);
#endif
