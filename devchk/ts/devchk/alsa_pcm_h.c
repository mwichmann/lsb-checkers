...
extern int snd_pcm_sw_params_set_xrun_mode_db(snd_pcm_t *, snd_pcm_sw_params_t *, snd_pcm_xrun_t);
CheckInterfacedef(snd_pcm_sw_params_set_xrun_mode,snd_pcm_sw_params_set_xrun_mode_db);
