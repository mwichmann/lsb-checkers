...
cnt++;
	...
	CompareConstant(GL_CURRENT_RASTER_SECONDARY_COLOR,0x845F,13934,architecture,1.2,NULL)
#else
...
cnt++;
	...
	CompareConstant(GL_PIXEL_PACK_BUFFER,0x88EB,13935,architecture,1.2,NULL)
#else
...
cnt++;
	...
	CompareConstant(GL_PIXEL_UNPACK_BUFFER,0x88EC,13936,architecture,1.2,NULL)
#else
...
cnt++;
	...
	CompareConstant(GL_PIXEL_PACK_BUFFER_BINDING,0x88ED,13937,architecture,1.2,NULL)
#else
...
cnt++;
	...
	CompareConstant(GL_PIXEL_UNPACK_BUFFER_BINDING,0x88EF,13938,architecture,1.2,NULL)
#else
...
cnt++;
	...
	CompareConstant(GL_FLOAT_MAT2x3,0x8B65,13939,architecture,1.2,NULL)
#else
...
cnt++;
	...
	CompareConstant(GL_FLOAT_MAT2x4,0x8B66,13940,architecture,1.2,NULL)
#else
...
cnt++;
	...
	CompareConstant(GL_FLOAT_MAT3x2,0x8B67,13941,architecture,1.2,NULL)
#else
...
cnt++;
	...
	CompareConstant(GL_FLOAT_MAT3x4,0x8B68,13942,architecture,1.2,NULL)
#else
...
cnt++;
	...
	CompareConstant(GL_FLOAT_MAT4x2,0x8B69,13943,architecture,1.2,NULL)
#else
...
cnt++;
	...
	CompareConstant(GL_FLOAT_MAT4x3,0x8B6A,13944,architecture,1.2,NULL)
#else
...
#if _LSB_DEFAULT_ARCH
#ifdef GL_SRGB
	CompareConstant(GL_SRGB,0x8C40,13945,architecture,1.2,NULL)
#else
...
#if _LSB_DEFAULT_ARCH
#ifdef GL_SRGB8
	CompareConstant(GL_SRGB8,0x8C41,13946,architecture,1.2,NULL)
#else
...
#if _LSB_DEFAULT_ARCH
#ifdef GL_SRGB_ALPHA
	CompareConstant(GL_SRGB_ALPHA,0x8C42,13947,architecture,1.2,NULL)
#else
...
cnt++;
	...
	CompareConstant(GL_SRGB8_ALPHA8,0x8C43,13948,architecture,1.2,NULL)
#else
...
cnt++;
	...
	CompareConstant(GL_SLUMINANCE_ALPHA,0x8C44,13949,architecture,1.2,NULL)
#else
...
cnt++;
	...
	CompareConstant(GL_SLUMINANCE8_ALPHA8,0x8C45,13950,architecture,1.2,NULL)
#else
...
#if _LSB_DEFAULT_ARCH
#ifdef GL_SLUMINANCE
	CompareConstant(GL_SLUMINANCE,0x8C46,13951,architecture,1.2,NULL)
#else
...
cnt++;
	...
	CompareConstant(GL_SLUMINANCE8,0x8C47,13952,architecture,1.2,NULL)
#else
...
cnt++;
	...
	CompareConstant(GL_COMPRESSED_SRGB,0x8C48,13953,architecture,1.2,NULL)
#else
...
cnt++;
	...
	CompareConstant(GL_COMPRESSED_SRGB_ALPHA,0x8C49,13954,architecture,1.2,NULL)
#else
...
cnt++;
	...
	CompareConstant(GL_COMPRESSED_SLUMINANCE,0x8C4A,13955,architecture,1.2,NULL)
#else
...
cnt++;
	...
	CompareConstant(GL_COMPRESSED_SLUMINANCE_ALPHA,0x8C4B,13956,architecture,1.2,NULL)
#else
...
cnt++;
	...
	CompareConstant(GL_DEPTH_STENCIL_EXT,0x84F9,15130,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_DEPTH_STENCIL_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_UNSIGNED_INT_24_8_EXT,0x84FA,15131,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_UNSIGNED_INT_24_8_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_DEPTH24_STENCIL8_EXT,0x88F0,15132,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_DEPTH24_STENCIL8_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_TEXTURE_STENCIL_SIZE_EXT,0x88F1,15133,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_TEXTURE_STENCIL_SIZE_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_STENCIL_TAG_BITS_EXT,0x88F2,15134,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_STENCIL_TAG_BITS_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_STENCIL_CLEAR_TAG_VALUE_EXT,0x88F3,15135,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_STENCIL_CLEAR_TAG_VALUE_EXT\n");
cnt++;
#endif
...
#if _LSB_DEFAULT_ARCH
#ifdef GL_SRGB_EXT
	CompareConstant(GL_SRGB_EXT,0x8C40,15136,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_SRGB_EXT\n");
cnt++;
#endif
...
#if _LSB_DEFAULT_ARCH
#ifdef GL_SRGB8_EXT
	CompareConstant(GL_SRGB8_EXT,0x8C41,15137,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_SRGB8_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_SRGB_ALPHA_EXT,0x8C42,15138,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_SRGB_ALPHA_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_SRGB8_ALPHA8_EXT,0x8C43,15139,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_SRGB8_ALPHA8_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_SLUMINANCE_ALPHA_EXT,0x8C44,15140,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_SLUMINANCE_ALPHA_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_SLUMINANCE8_ALPHA8_EXT,0x8C45,15141,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_SLUMINANCE8_ALPHA8_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_SLUMINANCE_EXT,0x8C46,15142,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_SLUMINANCE_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_SLUMINANCE8_EXT,0x8C47,15143,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_SLUMINANCE8_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_COMPRESSED_SRGB_EXT,0x8C48,15144,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_COMPRESSED_SRGB_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_COMPRESSED_SRGB_ALPHA_EXT,0x8C49,15145,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_COMPRESSED_SRGB_ALPHA_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_COMPRESSED_SLUMINANCE_EXT,0x8C4A,15146,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_COMPRESSED_SLUMINANCE_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_COMPRESSED_SLUMINANCE_ALPHA_EXT,0x8C4B,15147,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_COMPRESSED_SLUMINANCE_ALPHA_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_COMPRESSED_SRGB_S3TC_DXT1_EXT,0x8C4C,15148,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_COMPRESSED_SRGB_S3TC_DXT1_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT,0x8C4D,15149,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT,0x8C4E,15150,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT,0x8C4F,15151,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_READ_FRAMEBUFFER_EXT,0x8CA8,15152,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_READ_FRAMEBUFFER_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_DRAW_FRAMEBUFFER_EXT,0x8CA9,15153,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_DRAW_FRAMEBUFFER_EXT\n");
cnt++;
#endif
...
/* No test for GL_READ_FRAMEBUFFER_BINDING_EXT */
	...
	CompareConstant(GL_DRAW_FRAMEBUFFER_BINDING_EXT,0x8CAA,15155,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_DRAW_FRAMEBUFFER_BINDING_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_RENDERBUFFER_SAMPLES_EXT,0x8CAB,15156,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_RENDERBUFFER_SAMPLES_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE_EXT,0x8D56,15157,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_MAX_SAMPLES_EXT,0x8D57,15158,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_MAX_SAMPLES_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_TIME_ELAPSED_EXT,0x88BF,15159,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_TIME_ELAPSED_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_LINES_ADJACENCY_EXT,0x000A,15160,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_LINES_ADJACENCY_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_LINE_STRIP_ADJACENCY_EXT,0x000B,15161,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_LINE_STRIP_ADJACENCY_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_TRIANGLES_ADJACENCY_EXT,0x000C,15162,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_TRIANGLES_ADJACENCY_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_TRIANGLE_STRIP_ADJACENCY_EXT,0x000D,15163,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_TRIANGLE_STRIP_ADJACENCY_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_GEOMETRY_VERTICES_OUT_EXT,0x8DDA,15164,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_GEOMETRY_VERTICES_OUT_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_GEOMETRY_INPUT_TYPE_EXT,0x8DDB,15165,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_GEOMETRY_INPUT_TYPE_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_GEOMETRY_OUTPUT_TYPE_EXT,0x8DDC,15166,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_GEOMETRY_OUTPUT_TYPE_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_MAX_GEOMETRY_TEXTURE_IMAGE_UNITS_EXT,0x8C29,15167,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_MAX_GEOMETRY_TEXTURE_IMAGE_UNITS_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_FRAMEBUFFER_ATTACHMENT_LAYERED_EXT,0x8DA7,15168,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_FRAMEBUFFER_ATTACHMENT_LAYERED_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS_EXT,0x8DA8,15169,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_FRAMEBUFFER_INCOMPLETE_LAYER_COUNT_EXT,0x8DA9,15170,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_FRAMEBUFFER_INCOMPLETE_LAYER_COUNT_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_LAYER_EXT,0x8CD4,15171,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_LAYER_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_PROGRAM_POINT_SIZE_EXT,0x8642,15172,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_PROGRAM_POINT_SIZE_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_GEOMETRY_SHADER_EXT,0x8DD9,15173,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_GEOMETRY_SHADER_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_MAX_GEOMETRY_VARYING_COMPONENTS_EXT,0x8DDD,15174,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_MAX_GEOMETRY_VARYING_COMPONENTS_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_MAX_VERTEX_VARYING_COMPONENTS_EXT,0x8DDE,15175,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_MAX_VERTEX_VARYING_COMPONENTS_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_MAX_VARYING_COMPONENTS_EXT,0x8B4B,15176,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_MAX_VARYING_COMPONENTS_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_MAX_GEOMETRY_UNIFORM_COMPONENTS_EXT,0x8DDF,15177,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_MAX_GEOMETRY_UNIFORM_COMPONENTS_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_MAX_GEOMETRY_OUTPUT_VERTICES_EXT,0x8DE0,15178,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_MAX_GEOMETRY_OUTPUT_VERTICES_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_MAX_GEOMETRY_TOTAL_OUTPUT_COMPONENTS_EXT,0x8DE1,15179,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_MAX_GEOMETRY_TOTAL_OUTPUT_COMPONENTS_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_SAMPLER_1D_ARRAY_EXT,0x8DC0,15180,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_SAMPLER_1D_ARRAY_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_SAMPLER_2D_ARRAY_EXT,0x8DC1,15181,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_SAMPLER_2D_ARRAY_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_SAMPLER_BUFFER_EXT,0x8DC2,15182,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_SAMPLER_BUFFER_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_SAMPLER_1D_ARRAY_SHADOW_EXT,0x8DC3,15183,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_SAMPLER_1D_ARRAY_SHADOW_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_SAMPLER_2D_ARRAY_SHADOW_EXT,0x8DC4,15184,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_SAMPLER_2D_ARRAY_SHADOW_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_SAMPLER_CUBE_SHADOW_EXT,0x8DC5,15185,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_SAMPLER_CUBE_SHADOW_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_UNSIGNED_INT_VEC2_EXT,0x8DC6,15186,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_UNSIGNED_INT_VEC2_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_UNSIGNED_INT_VEC3_EXT,0x8DC7,15187,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_UNSIGNED_INT_VEC3_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_UNSIGNED_INT_VEC4_EXT,0x8DC8,15188,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_UNSIGNED_INT_VEC4_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_INT_SAMPLER_1D_EXT,0x8DC9,15189,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_INT_SAMPLER_1D_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_INT_SAMPLER_2D_EXT,0x8DCA,15190,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_INT_SAMPLER_2D_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_INT_SAMPLER_3D_EXT,0x8DCB,15191,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_INT_SAMPLER_3D_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_INT_SAMPLER_CUBE_EXT,0x8DCC,15192,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_INT_SAMPLER_CUBE_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_INT_SAMPLER_2D_RECT_EXT,0x8DCD,15193,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_INT_SAMPLER_2D_RECT_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_INT_SAMPLER_1D_ARRAY_EXT,0x8DCE,15194,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_INT_SAMPLER_1D_ARRAY_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_INT_SAMPLER_2D_ARRAY_EXT,0x8DCF,15195,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_INT_SAMPLER_2D_ARRAY_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_INT_SAMPLER_BUFFER_EXT,0x8DD0,15196,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_INT_SAMPLER_BUFFER_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_UNSIGNED_INT_SAMPLER_1D_EXT,0x8DD1,15197,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_UNSIGNED_INT_SAMPLER_1D_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_UNSIGNED_INT_SAMPLER_2D_EXT,0x8DD2,15198,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_UNSIGNED_INT_SAMPLER_2D_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_UNSIGNED_INT_SAMPLER_3D_EXT,0x8DD3,15199,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_UNSIGNED_INT_SAMPLER_3D_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_UNSIGNED_INT_SAMPLER_CUBE_EXT,0x8DD4,15200,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_UNSIGNED_INT_SAMPLER_CUBE_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_UNSIGNED_INT_SAMPLER_2D_RECT_EXT,0x8DD5,15201,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_UNSIGNED_INT_SAMPLER_2D_RECT_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_UNSIGNED_INT_SAMPLER_1D_ARRAY_EXT,0x8DD6,15202,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_UNSIGNED_INT_SAMPLER_1D_ARRAY_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_UNSIGNED_INT_SAMPLER_2D_ARRAY_EXT,0x8DD7,15203,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_UNSIGNED_INT_SAMPLER_2D_ARRAY_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_UNSIGNED_INT_SAMPLER_BUFFER_EXT,0x8DD8,15204,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_UNSIGNED_INT_SAMPLER_BUFFER_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_R11F_G11F_B10F_EXT,0x8C3A,15205,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_R11F_G11F_B10F_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_UNSIGNED_INT_10F_11F_11F_REV_EXT,0x8C3B,15206,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_UNSIGNED_INT_10F_11F_11F_REV_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_RGBA_SIGNED_COMPONENTS_EXT,0x8C3C,15207,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_RGBA_SIGNED_COMPONENTS_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_TEXTURE_1D_ARRAY_EXT,0x8C18,15208,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_TEXTURE_1D_ARRAY_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_PROXY_TEXTURE_1D_ARRAY_EXT,0x8C19,15209,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_PROXY_TEXTURE_1D_ARRAY_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_TEXTURE_2D_ARRAY_EXT,0x8C1A,15210,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_TEXTURE_2D_ARRAY_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_PROXY_TEXTURE_2D_ARRAY_EXT,0x8C1B,15211,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_PROXY_TEXTURE_2D_ARRAY_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_TEXTURE_BINDING_1D_ARRAY_EXT,0x8C1C,15212,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_TEXTURE_BINDING_1D_ARRAY_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_TEXTURE_BINDING_2D_ARRAY_EXT,0x8C1D,15213,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_TEXTURE_BINDING_2D_ARRAY_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_MAX_ARRAY_TEXTURE_LAYERS_EXT,0x88FF,15214,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_MAX_ARRAY_TEXTURE_LAYERS_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_COMPARE_REF_DEPTH_TO_TEXTURE_EXT,0x884E,15215,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_COMPARE_REF_DEPTH_TO_TEXTURE_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_TEXTURE_BUFFER_EXT,0x8C2A,15216,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_TEXTURE_BUFFER_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_MAX_TEXTURE_BUFFER_SIZE_EXT,0x8C2B,15217,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_MAX_TEXTURE_BUFFER_SIZE_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_TEXTURE_BINDING_BUFFER_EXT,0x8C2C,15218,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_TEXTURE_BINDING_BUFFER_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_TEXTURE_BUFFER_DATA_STORE_BINDING_EXT,0x8C2D,15219,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_TEXTURE_BUFFER_DATA_STORE_BINDING_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_TEXTURE_BUFFER_FORMAT_EXT,0x8C2E,15220,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_TEXTURE_BUFFER_FORMAT_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_COMPRESSED_LUMINANCE_LATC1_EXT,0x8C70,15221,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_COMPRESSED_LUMINANCE_LATC1_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_COMPRESSED_SIGNED_LUMINANCE_LATC1_EXT,0x8C71,15222,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_COMPRESSED_SIGNED_LUMINANCE_LATC1_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_COMPRESSED_LUMINANCE_ALPHA_LATC2_EXT,0x8C72,15223,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_COMPRESSED_LUMINANCE_ALPHA_LATC2_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_COMPRESSED_SIGNED_LUMINANCE_ALPHA_LATC2_EXT,0x8C73,15224,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_COMPRESSED_SIGNED_LUMINANCE_ALPHA_LATC2_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_COMPRESSED_RED_RGTC1_EXT,0x8DBB,15225,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_COMPRESSED_RED_RGTC1_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_COMPRESSED_SIGNED_RED_RGTC1_EXT,0x8DBC,15226,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_COMPRESSED_SIGNED_RED_RGTC1_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_COMPRESSED_RED_GREEN_RGTC2_EXT,0x8DBD,15227,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_COMPRESSED_RED_GREEN_RGTC2_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT,0x8DBE,15228,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_RGB9_E5_EXT,0x8C3D,15229,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_RGB9_E5_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_UNSIGNED_INT_5_9_9_9_REV_EXT,0x8C3E,15230,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_UNSIGNED_INT_5_9_9_9_REV_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_TEXTURE_SHARED_SIZE_EXT,0x8C3F,15231,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_TEXTURE_SHARED_SIZE_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_FRAMEBUFFER_SRGB_EXT,0x8DB9,15232,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_FRAMEBUFFER_SRGB_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_FRAMEBUFFER_SRGB_CAPABLE_EXT,0x8DBA,15233,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_FRAMEBUFFER_SRGB_CAPABLE_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_MAX_VERTEX_BINDABLE_UNIFORMS_EXT,0x8DE2,15234,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_MAX_VERTEX_BINDABLE_UNIFORMS_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_MAX_FRAGMENT_BINDABLE_UNIFORMS_EXT,0x8DE3,15235,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_MAX_FRAGMENT_BINDABLE_UNIFORMS_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_MAX_GEOMETRY_BINDABLE_UNIFORMS_EXT,0x8DE4,15236,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_MAX_GEOMETRY_BINDABLE_UNIFORMS_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_MAX_BINDABLE_UNIFORM_SIZE_EXT,0x8DED,15237,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_MAX_BINDABLE_UNIFORM_SIZE_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_UNIFORM_BUFFER_EXT,0x8DEE,15238,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_UNIFORM_BUFFER_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_UNIFORM_BUFFER_BINDING_EXT,0x8DEF,15239,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_UNIFORM_BUFFER_BINDING_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_RGBA32UI_EXT,0x8D70,15240,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_RGBA32UI_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_RGB32UI_EXT,0x8D71,15241,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_RGB32UI_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_ALPHA32UI_EXT,0x8D72,15242,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_ALPHA32UI_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_INTENSITY32UI_EXT,0x8D73,15243,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_INTENSITY32UI_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_LUMINANCE32UI_EXT,0x8D74,15244,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_LUMINANCE32UI_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_LUMINANCE_ALPHA32UI_EXT,0x8D75,15245,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_LUMINANCE_ALPHA32UI_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_RGBA16UI_EXT,0x8D76,15246,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_RGBA16UI_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_RGB16UI_EXT,0x8D77,15247,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_RGB16UI_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_ALPHA16UI_EXT,0x8D78,15248,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_ALPHA16UI_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_INTENSITY16UI_EXT,0x8D79,15249,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_INTENSITY16UI_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_LUMINANCE16UI_EXT,0x8D7A,15250,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_LUMINANCE16UI_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_LUMINANCE_ALPHA16UI_EXT,0x8D7B,15251,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_LUMINANCE_ALPHA16UI_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_RGBA8UI_EXT,0x8D7C,15252,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_RGBA8UI_EXT\n");
cnt++;
#endif
...
#if _LSB_DEFAULT_ARCH
#ifdef GL_RGB8UI_EXT
	CompareConstant(GL_RGB8UI_EXT,0x8D7D,15253,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_RGB8UI_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_ALPHA8UI_EXT,0x8D7E,15254,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_ALPHA8UI_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_INTENSITY8UI_EXT,0x8D7F,15255,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_INTENSITY8UI_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_LUMINANCE8UI_EXT,0x8D80,15256,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_LUMINANCE8UI_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_LUMINANCE_ALPHA8UI_EXT,0x8D81,15257,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_LUMINANCE_ALPHA8UI_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_RGBA32I_EXT,0x8D82,15258,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_RGBA32I_EXT\n");
cnt++;
#endif
...
#if _LSB_DEFAULT_ARCH
#ifdef GL_RGB32I_EXT
	CompareConstant(GL_RGB32I_EXT,0x8D83,15259,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_RGB32I_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_ALPHA32I_EXT,0x8D84,15260,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_ALPHA32I_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_INTENSITY32I_EXT,0x8D85,15261,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_INTENSITY32I_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_LUMINANCE32I_EXT,0x8D86,15262,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_LUMINANCE32I_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_LUMINANCE_ALPHA32I_EXT,0x8D87,15263,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_LUMINANCE_ALPHA32I_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_RGBA16I_EXT,0x8D88,15264,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_RGBA16I_EXT\n");
cnt++;
#endif
...
#if _LSB_DEFAULT_ARCH
#ifdef GL_RGB16I_EXT
	CompareConstant(GL_RGB16I_EXT,0x8D89,15265,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_RGB16I_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_ALPHA16I_EXT,0x8D8A,15266,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_ALPHA16I_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_INTENSITY16I_EXT,0x8D8B,15267,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_INTENSITY16I_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_LUMINANCE16I_EXT,0x8D8C,15268,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_LUMINANCE16I_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_LUMINANCE_ALPHA16I_EXT,0x8D8D,15269,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_LUMINANCE_ALPHA16I_EXT\n");
cnt++;
#endif
...
#if _LSB_DEFAULT_ARCH
#ifdef GL_RGBA8I_EXT
	CompareConstant(GL_RGBA8I_EXT,0x8D8E,15270,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_RGBA8I_EXT\n");
cnt++;
#endif
...
#if _LSB_DEFAULT_ARCH
#ifdef GL_RGB8I_EXT
	CompareConstant(GL_RGB8I_EXT,0x8D8F,15271,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_RGB8I_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_ALPHA8I_EXT,0x8D90,15272,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_ALPHA8I_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_INTENSITY8I_EXT,0x8D91,15273,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_INTENSITY8I_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_LUMINANCE8I_EXT,0x8D92,15274,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_LUMINANCE8I_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_LUMINANCE_ALPHA8I_EXT,0x8D93,15275,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_LUMINANCE_ALPHA8I_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_RED_INTEGER_EXT,0x8D94,15276,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_RED_INTEGER_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_GREEN_INTEGER_EXT,0x8D95,15277,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_GREEN_INTEGER_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_BLUE_INTEGER_EXT,0x8D96,15278,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_BLUE_INTEGER_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_ALPHA_INTEGER_EXT,0x8D97,15279,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_ALPHA_INTEGER_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_RGB_INTEGER_EXT,0x8D98,15280,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_RGB_INTEGER_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_RGBA_INTEGER_EXT,0x8D99,15281,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_RGBA_INTEGER_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_BGR_INTEGER_EXT,0x8D9A,15282,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_BGR_INTEGER_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_BGRA_INTEGER_EXT,0x8D9B,15283,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_BGRA_INTEGER_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_LUMINANCE_INTEGER_EXT,0x8D9C,15284,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_LUMINANCE_INTEGER_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_LUMINANCE_ALPHA_INTEGER_EXT,0x8D9D,15285,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_LUMINANCE_ALPHA_INTEGER_EXT\n");
cnt++;
#endif
	...
	CompareConstant(GL_RGBA_INTEGER_MODE_EXT,0x8D9E,15286,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_RGBA_INTEGER_MODE_EXT\n");
cnt++;
#endif
...
cnt++;
	...
	CompareConstant(GL_VERSION_2_1,1,15291,architecture,1.2,NULL)
#else
...
cnt++;
	...
	CompareConstant(GL_EXT_packed_depth_stencil,1,15429,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_EXT_packed_depth_stencil\n");
cnt++;
#endif
	...
	CompareConstant(GL_EXT_stencil_clear_tag,1,15430,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_EXT_stencil_clear_tag\n");
cnt++;
#endif
	...
	CompareConstant(GL_EXT_texture_sRGB,1,15431,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_EXT_texture_sRGB\n");
cnt++;
#endif
	...
	CompareConstant(GL_EXT_framebuffer_blit,1,15432,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_EXT_framebuffer_blit\n");
cnt++;
#endif
	...
	CompareConstant(GL_EXT_framebuffer_multisample,1,15433,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_EXT_framebuffer_multisample\n");
cnt++;
#endif
	...
	CompareConstant(GL_EXT_timer_query,1,15434,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_EXT_timer_query\n");
cnt++;
#endif
	...
	CompareConstant(GL_EXT_gpu_program_parameters,1,15435,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_EXT_gpu_program_parameters\n");
cnt++;
#endif
	...
	CompareConstant(GL_EXT_geometry_shader4,1,15436,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_EXT_geometry_shader4\n");
cnt++;
#endif
	...
	CompareConstant(GL_EXT_gpu_shader4,1,15437,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_EXT_gpu_shader4\n");
cnt++;
#endif
	...
	CompareConstant(GL_EXT_draw_instanced,1,15438,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_EXT_draw_instanced\n");
cnt++;
#endif
	...
	CompareConstant(GL_EXT_packed_float,1,15439,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_EXT_packed_float\n");
cnt++;
#endif
	...
	CompareConstant(GL_EXT_texture_array,1,15440,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_EXT_texture_array\n");
cnt++;
#endif
	...
	CompareConstant(GL_EXT_texture_buffer_object,1,15441,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_EXT_texture_buffer_object\n");
cnt++;
#endif
	...
	CompareConstant(GL_EXT_texture_compression_latc,1,15442,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_EXT_texture_compression_latc\n");
cnt++;
#endif
	...
	CompareConstant(GL_EXT_texture_compression_rgtc,1,15443,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_EXT_texture_compression_rgtc\n");
cnt++;
#endif
	...
	CompareConstant(GL_EXT_texture_shared_exponent,1,15444,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_EXT_texture_shared_exponent\n");
cnt++;
#endif
	...
	CompareConstant(GL_EXT_framebuffer_sRGB,1,15445,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_EXT_framebuffer_sRGB\n");
cnt++;
#endif
	...
	CompareConstant(GL_EXT_draw_buffers2,1,15446,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_EXT_draw_buffers2\n");
cnt++;
#endif
	...
	CompareConstant(GL_EXT_bindable_uniform,1,15447,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_EXT_bindable_uniform\n");
cnt++;
#endif
	...
	CompareConstant(GL_EXT_texture_integer,1,15448,architecture,1.2,NULL)
#else
Msg( "Error: Constant not found: GL_EXT_texture_integer\n");
cnt++;
#endif
...
Msg("REPLACE INTO ArchType VALUES (%d,%d,%d,'""2.0""',NULL,9027,NULL);\n",architecture,31682,0);
#endif
