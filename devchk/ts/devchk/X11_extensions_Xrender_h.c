...
#elif defined __s390__ && !defined __s390x__
CheckTypeSize(struct _XFilters,0, 16652, 10, 1.2, NULL, 0, NULL)
...
#elif defined __i386__
CheckTypeSize(struct _XFilters,0, 16652, 2, 1.2, NULL, 0, NULL)
...
#elif defined __s390__ && !defined __s390x__
CheckTypeSize(struct _XAnimCursor,0, 16660, 10, 1.2, NULL, 0, NULL)
CheckMemberSize(struct _XAnimCursor,delay,4,10,53883)
CheckOffset(struct _XAnimCursor,delay,4,10,53883)
#elif defined __i386__
CheckTypeSize(struct _XAnimCursor,0, 16660, 2, 1.2, NULL, 0, NULL)
...
#elif defined __s390__ && !defined __s390x__
CheckTypeSize(struct _XGlyphElt32,0, 16671, 10, 1.2, NULL, 0, NULL)
...
#elif defined __i386__
CheckTypeSize(struct _XGlyphElt32,0, 16671, 2, 1.2, NULL, 0, NULL)
...
#elif defined __s390__ && !defined __s390x__
CheckTypeSize(struct _XGlyphElt8,0, 16675, 10, 1.2, NULL, 0, NULL)
...
#elif defined __i386__
CheckTypeSize(struct _XGlyphElt8,0, 16675, 2, 1.2, NULL, 0, NULL)
...
#elif defined __s390__ && !defined __s390x__
CheckTypeSize(struct _XRenderPictureAttributes,0, 16697, 10, 1.2, NULL, 0, NULL)
...
#elif defined __i386__
CheckTypeSize(struct _XRenderPictureAttributes,0, 16697, 2, 1.2, NULL, 0, NULL)
...
#elif defined __s390__ && !defined __s390x__
CheckTypeSize(struct _XIndexValue,0, 16707, 10, 1.2, NULL, 0, NULL)
...
#elif defined __i386__
CheckTypeSize(struct _XIndexValue,0, 16707, 2, 1.2, NULL, 0, NULL)
...
#elif defined __s390__ && !defined __s390x__
CheckTypeSize(struct _XGlyphElt16,0, 16710, 10, 1.2, NULL, 0, NULL)
...
#elif defined __i386__
CheckTypeSize(struct _XGlyphElt16,0, 16710, 2, 1.2, NULL, 0, NULL)
