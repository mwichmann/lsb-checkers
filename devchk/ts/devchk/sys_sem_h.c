...
#elif 1
CheckTypeSize(struct sembuf,0, 6982, 1);
Msg("Missing member data for sembuf on All\n");
CheckOffset(struct sembuf,sem_num,0,1,30118);
CheckOffset(struct sembuf,sem_op,0,1,30119);
CheckOffset(struct sembuf,sem_flg,0,1,30120);
#endif
