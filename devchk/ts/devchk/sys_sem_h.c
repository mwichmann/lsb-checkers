...
#if defined __i386__
CheckTypeSize(struct sembuf,6, 6982, 2, 1.2, NULL, 0, NULL)
...
CheckTypeSize(struct sembuf,6, 6982, 3, 1.3, NULL, 0, NULL)
...
CheckTypeSize(struct sembuf,6, 6982, 6, 1.2, NULL, 0, NULL)
...
CheckTypeSize(struct sembuf,6, 6982, 10, 1.3, NULL, 0, NULL)
...
CheckTypeSize(struct sembuf,6, 6982, 12, 1.3, NULL, 0, NULL)
...
CheckTypeSize(struct sembuf,6, 6982, 11, 2.0, NULL, 0, NULL)
...
CheckTypeSize(struct sembuf,6, 6982, 9, 2.0, NULL, 0, NULL)
...
#if defined __ia64__
CheckTypeSize(struct semid_ds,88, 10211, 3, 2.0, NULL, 0, NULL)
...
CheckTypeSize(struct semid_ds,64, 10211, 2, 2.0, NULL, 0, NULL)
...
#elif defined __s390__ && !defined __s390x__
CheckTypeSize(struct semid_ds,64, 10211, 10, 2.0, NULL, 0, NULL)
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(struct semid_ds,80, 10211, 6, 2.0, NULL, 0, NULL)
...
#elif defined __powerpc64__
CheckTypeSize(struct semid_ds,88, 10211, 9, 2.0, NULL, 0, NULL)
...
#elif defined __s390x__
CheckTypeSize(struct semid_ds,88, 10211, 12, 2.0, NULL, 0, NULL)
...
#elif defined __x86_64__
CheckTypeSize(struct semid_ds,104, 10211, 11, 2.0, NULL, 0, NULL)
