...
extern int snd_rawmidi_info_db(snd_rawmidi_t *, snd_rawmidi_info_t *);
CheckInterfacedef(snd_rawmidi_info,snd_rawmidi_info_db);
extern void snd_rawmidi_info_copy_db(snd_rawmidi_info_t *, const snd_rawmidi_info_t *);
CheckInterfacedef(snd_rawmidi_info_copy,snd_rawmidi_info_copy_db);
extern void snd_rawmidi_info_free_db(snd_rawmidi_info_t *);
CheckInterfacedef(snd_rawmidi_info_free,snd_rawmidi_info_free_db);
extern int snd_rawmidi_info_get_card_db(const snd_rawmidi_info_t *);
CheckInterfacedef(snd_rawmidi_info_get_card,snd_rawmidi_info_get_card_db);
extern unsigned int snd_rawmidi_info_get_device_db(const snd_rawmidi_info_t *);
CheckInterfacedef(snd_rawmidi_info_get_device,snd_rawmidi_info_get_device_db);
extern unsigned int snd_rawmidi_info_get_flags_db(const snd_rawmidi_info_t *);
CheckInterfacedef(snd_rawmidi_info_get_flags,snd_rawmidi_info_get_flags_db);
...
extern snd_rawmidi_stream_t snd_rawmidi_info_get_stream_db(const snd_rawmidi_info_t *);
CheckInterfacedef(snd_rawmidi_info_get_stream,snd_rawmidi_info_get_stream_db);
extern unsigned int snd_rawmidi_info_get_subdevice_db(const snd_rawmidi_info_t *);
CheckInterfacedef(snd_rawmidi_info_get_subdevice,snd_rawmidi_info_get_subdevice_db);
...
extern unsigned int snd_rawmidi_info_get_subdevices_avail_db(const snd_rawmidi_info_t *);
CheckInterfacedef(snd_rawmidi_info_get_subdevices_avail,snd_rawmidi_info_get_subdevices_avail_db);
