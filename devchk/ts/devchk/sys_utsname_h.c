...
Msg("Missing member data for utsname on IA64\n");
CheckOffset(struct utsname,sysname,0,3,30177)
CheckOffset(struct utsname,nodename,0,3,30178)
CheckOffset(struct utsname,release,0,3,30179)
CheckOffset(struct utsname,version,0,3,30180)
CheckOffset(struct utsname,machine,0,3,30181)
CheckOffset(struct utsname,domainname,0,3,34411)
#elif __powerpc__
...
Msg("Missing member data for utsname on S390\n");
CheckOffset(struct utsname,sysname,0,10,30177)
CheckOffset(struct utsname,nodename,0,10,30178)
CheckOffset(struct utsname,release,0,10,30179)
CheckOffset(struct utsname,version,0,10,30180)
CheckOffset(struct utsname,machine,0,10,30181)
CheckOffset(struct utsname,domainname,0,10,34411)
#else
