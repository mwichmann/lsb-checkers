...
#elif 1
CheckTypeSize(struct passwd,0, 6938, 1);
Msg("Missing member data for passwd on All\n");
CheckOffset(struct passwd,pw_name,0,1,30041);
CheckOffset(struct passwd,pw_passwd,0,1,30042);
CheckOffset(struct passwd,pw_uid,0,1,30043);
CheckOffset(struct passwd,pw_gid,0,1,30044);
CheckOffset(struct passwd,pw_gecos,0,1,30045);
CheckOffset(struct passwd,pw_dir,0,1,30046);
CheckOffset(struct passwd,pw_shell,0,1,30047);
#endif
