...
CheckMemberSize(struct passwd,pw_passwd,0,6,30042)
CheckOffset(struct passwd,pw_passwd,4,6,30042)
CheckMemberSize(struct passwd,pw_uid,0,6,30043)
CheckOffset(struct passwd,pw_uid,8,6,30043)
CheckMemberSize(struct passwd,pw_gid,0,6,30044)
CheckOffset(struct passwd,pw_gid,12,6,30044)
CheckMemberSize(struct passwd,pw_gecos,0,6,30045)
CheckOffset(struct passwd,pw_gecos,16,6,30045)
CheckMemberSize(struct passwd,pw_dir,0,6,30046)
CheckOffset(struct passwd,pw_dir,20,6,30046)
CheckMemberSize(struct passwd,pw_shell,0,6,30047)
...
CheckMemberSize(struct passwd,pw_passwd,0,9,30042)
CheckOffset(struct passwd,pw_passwd,8,9,30042)
CheckMemberSize(struct passwd,pw_uid,0,9,30043)
CheckOffset(struct passwd,pw_uid,16,9,30043)
CheckMemberSize(struct passwd,pw_gid,0,9,30044)
CheckOffset(struct passwd,pw_gid,20,9,30044)
CheckMemberSize(struct passwd,pw_gecos,0,9,30045)
CheckOffset(struct passwd,pw_gecos,24,9,30045)
CheckMemberSize(struct passwd,pw_dir,0,9,30046)
CheckOffset(struct passwd,pw_dir,32,9,30046)
CheckMemberSize(struct passwd,pw_shell,0,9,30047)
