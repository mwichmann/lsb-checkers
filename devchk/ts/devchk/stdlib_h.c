...
extern unsigned short * seed48_db(unsigned short[3]);
...
CheckInterfacedef(lcong48_r,lcong48_r_db);
extern int nrand48_r_db(unsigned short[3], struct drand48_data *, long int *);
...
extern int seed48_r_db(unsigned short[3], struct drand48_data *);
...
extern size_t __mbstowcs_chk_db(wchar_t *, const char *, size_t, size_t);
CheckInterfacedef(__mbstowcs_chk,__mbstowcs_chk_db);
extern char * __realpath_chk_db(const char *, char *, size_t);
CheckInterfacedef(__realpath_chk,__realpath_chk_db);
extern size_t __wcstombs_chk_db(char *, const wchar_t *, size_t, size_t);
CheckInterfacedef(__wcstombs_chk,__wcstombs_chk_db);
