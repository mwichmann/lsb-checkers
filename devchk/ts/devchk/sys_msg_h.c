...
CheckMemberSize(struct msqid_ds,msg_perm,4,6,34742)
CheckOffset(struct msqid_ds,msg_perm,0,6,34742)
CheckMemberSize(struct msqid_ds,msg_stime,0,6,34743)
CheckOffset(struct msqid_ds,msg_stime,52,6,34743)
CheckMemberSize(struct msqid_ds,__unused1,0,6,34746)
CheckOffset(struct msqid_ds,__unused1,48,6,34746)
CheckMemberSize(struct msqid_ds,msg_rtime,0,6,34744)
CheckOffset(struct msqid_ds,msg_rtime,60,6,34744)
CheckMemberSize(struct msqid_ds,__unused2,0,6,34747)
CheckOffset(struct msqid_ds,__unused2,56,6,34747)
CheckMemberSize(struct msqid_ds,msg_ctime,0,6,34745)
CheckOffset(struct msqid_ds,msg_ctime,68,6,34745)
CheckMemberSize(struct msqid_ds,__unused3,0,6,34748)
CheckOffset(struct msqid_ds,__unused3,64,6,34748)
CheckMemberSize(struct msqid_ds,__msg_cbytes,0,6,34749)
CheckOffset(struct msqid_ds,__msg_cbytes,72,6,34749)
CheckMemberSize(struct msqid_ds,msg_qnum,0,6,34750)
CheckOffset(struct msqid_ds,msg_qnum,76,6,34750)
CheckMemberSize(struct msqid_ds,msg_qbytes,0,6,34751)
CheckOffset(struct msqid_ds,msg_qbytes,80,6,34751)
CheckMemberSize(struct msqid_ds,msg_lspid,0,6,34752)
CheckOffset(struct msqid_ds,msg_lspid,84,6,34752)
CheckMemberSize(struct msqid_ds,msg_lrpid,0,6,34753)
