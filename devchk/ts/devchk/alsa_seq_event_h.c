...
CheckEnum("SND_SEQ_EVENT_RESULT",SND_SEQ_EVENT_RESULT,1,219261)
CheckEnum("SND_SEQ_EVENT_NOTE",SND_SEQ_EVENT_NOTE,5,219262)
CheckEnum("SND_SEQ_EVENT_NOTEON",SND_SEQ_EVENT_NOTEON,6,219263)
CheckEnum("SND_SEQ_EVENT_NOTEOFF",SND_SEQ_EVENT_NOTEOFF,7,219264)
CheckEnum("SND_SEQ_EVENT_KEYPRESS",SND_SEQ_EVENT_KEYPRESS,8,219265)
CheckEnum("SND_SEQ_EVENT_CONTROLLER",SND_SEQ_EVENT_CONTROLLER,10,219266)
CheckEnum("SND_SEQ_EVENT_PGMCHANGE",SND_SEQ_EVENT_PGMCHANGE,11,219267)
CheckEnum("SND_SEQ_EVENT_CHANPRESS",SND_SEQ_EVENT_CHANPRESS,12,219268)
CheckEnum("SND_SEQ_EVENT_PITCHBEND",SND_SEQ_EVENT_PITCHBEND,13,219269)
CheckEnum("SND_SEQ_EVENT_CONTROL14",SND_SEQ_EVENT_CONTROL14,14,219270)
CheckEnum("SND_SEQ_EVENT_NONREGPARAM",SND_SEQ_EVENT_NONREGPARAM,15,219271)
CheckEnum("SND_SEQ_EVENT_REGPARAM",SND_SEQ_EVENT_REGPARAM,16,219272)
CheckEnum("SND_SEQ_EVENT_SONGPOS",SND_SEQ_EVENT_SONGPOS,20,219273)
CheckEnum("SND_SEQ_EVENT_SONGSEL",SND_SEQ_EVENT_SONGSEL,21,219274)
CheckEnum("SND_SEQ_EVENT_QFRAME",SND_SEQ_EVENT_QFRAME,22,219275)
CheckEnum("SND_SEQ_EVENT_TIMESIGN",SND_SEQ_EVENT_TIMESIGN,23,219276)
CheckEnum("SND_SEQ_EVENT_KEYSIGN",SND_SEQ_EVENT_KEYSIGN,24,219277)
CheckEnum("SND_SEQ_EVENT_START",SND_SEQ_EVENT_START,30,219278)
CheckEnum("SND_SEQ_EVENT_CONTINUE",SND_SEQ_EVENT_CONTINUE,31,219279)
CheckEnum("SND_SEQ_EVENT_STOP",SND_SEQ_EVENT_STOP,32,219280)
CheckEnum("SND_SEQ_EVENT_SETPOS_TICK",SND_SEQ_EVENT_SETPOS_TICK,33,219281)
CheckEnum("SND_SEQ_EVENT_SETPOS_TIME",SND_SEQ_EVENT_SETPOS_TIME,34,219282)
CheckEnum("SND_SEQ_EVENT_TEMPO",SND_SEQ_EVENT_TEMPO,35,219283)
CheckEnum("SND_SEQ_EVENT_CLOCK",SND_SEQ_EVENT_CLOCK,36,219284)
CheckEnum("SND_SEQ_EVENT_TICK",SND_SEQ_EVENT_TICK,37,219285)
CheckEnum("SND_SEQ_EVENT_QUEUE_SKEW",SND_SEQ_EVENT_QUEUE_SKEW,38,219286)
CheckEnum("SND_SEQ_EVENT_SYNC_POS",SND_SEQ_EVENT_SYNC_POS,39,219287)
CheckEnum("SND_SEQ_EVENT_TUNE_REQUEST",SND_SEQ_EVENT_TUNE_REQUEST,40,219288)
CheckEnum("SND_SEQ_EVENT_RESET",SND_SEQ_EVENT_RESET,41,219289)
CheckEnum("SND_SEQ_EVENT_SENSING",SND_SEQ_EVENT_SENSING,42,219290)
CheckEnum("SND_SEQ_EVENT_ECHO",SND_SEQ_EVENT_ECHO,50,219291)
CheckEnum("SND_SEQ_EVENT_OSS",SND_SEQ_EVENT_OSS,51,219292)
CheckEnum("SND_SEQ_EVENT_CLIENT_START",SND_SEQ_EVENT_CLIENT_START,60,219293)
CheckEnum("SND_SEQ_EVENT_CLIENT_EXIT",SND_SEQ_EVENT_CLIENT_EXIT,61,219294)
CheckEnum("SND_SEQ_EVENT_CLIENT_CHANGE",SND_SEQ_EVENT_CLIENT_CHANGE,62,219295)
CheckEnum("SND_SEQ_EVENT_PORT_START",SND_SEQ_EVENT_PORT_START,63,219296)
CheckEnum("SND_SEQ_EVENT_PORT_EXIT",SND_SEQ_EVENT_PORT_EXIT,64,219297)
CheckEnum("SND_SEQ_EVENT_PORT_CHANGE",SND_SEQ_EVENT_PORT_CHANGE,65,219298)
CheckEnum("SND_SEQ_EVENT_PORT_SUBSCRIBED",SND_SEQ_EVENT_PORT_SUBSCRIBED,66,219299)
CheckEnum("SND_SEQ_EVENT_PORT_UNSUBSCRIBED",SND_SEQ_EVENT_PORT_UNSUBSCRIBED,67,219300)
CheckEnum("SND_SEQ_EVENT_USR0",SND_SEQ_EVENT_USR0,90,219301)
CheckEnum("SND_SEQ_EVENT_USR1",SND_SEQ_EVENT_USR1,91,219302)
CheckEnum("SND_SEQ_EVENT_USR2",SND_SEQ_EVENT_USR2,92,219303)
CheckEnum("SND_SEQ_EVENT_USR3",SND_SEQ_EVENT_USR3,93,219304)
CheckEnum("SND_SEQ_EVENT_USR4",SND_SEQ_EVENT_USR4,94,219305)
CheckEnum("SND_SEQ_EVENT_USR5",SND_SEQ_EVENT_USR5,95,219306)
CheckEnum("SND_SEQ_EVENT_USR6",SND_SEQ_EVENT_USR6,96,219307)
CheckEnum("SND_SEQ_EVENT_USR7",SND_SEQ_EVENT_USR7,97,219308)
CheckEnum("SND_SEQ_EVENT_USR8",SND_SEQ_EVENT_USR8,98,219309)
CheckEnum("SND_SEQ_EVENT_USR9",SND_SEQ_EVENT_USR9,99,219310)
CheckEnum("SND_SEQ_EVENT_SYSEX",SND_SEQ_EVENT_SYSEX,130,219311)
CheckEnum("SND_SEQ_EVENT_BOUNCE",SND_SEQ_EVENT_BOUNCE,131,219312)
CheckEnum("SND_SEQ_EVENT_USR_VAR0",SND_SEQ_EVENT_USR_VAR0,135,219313)
CheckEnum("SND_SEQ_EVENT_USR_VAR1",SND_SEQ_EVENT_USR_VAR1,136,219314)
CheckEnum("SND_SEQ_EVENT_USR_VAR2",SND_SEQ_EVENT_USR_VAR2,137,219315)
CheckEnum("SND_SEQ_EVENT_USR_VAR3",SND_SEQ_EVENT_USR_VAR3,138,219316)
CheckEnum("SND_SEQ_EVENT_USR_VAR4",SND_SEQ_EVENT_USR_VAR4,139,219317)
CheckEnum("SND_SEQ_EVENT_NONE",SND_SEQ_EVENT_NONE,255,219318)
#endif
