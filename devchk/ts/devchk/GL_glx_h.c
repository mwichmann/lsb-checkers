...
#if 1
CheckTypeSize(GLXEvent,0, 8170, 1, 1.0, NULL, 8169, NULL)
#endif
...
#if 1
CheckTypeSize(GLXPbufferClobberEvent,0, 8719, 1, 1.0, NULL, 8167, NULL)
#endif
...
#if 1
CheckTypeSize(GLXFBConfigID,0, 8722, 1, 1.0, NULL, 8171, NULL)
#endif

#if 1
CheckTypeSize(__GLXextFuncPtr,0, 31687, 1, 1.0, NULL, 8726, NULL)
#endif
