...
#elif __s390x__
CheckTypeSize(struct sockaddr_un,0, 9152, 12)
Msg("Missing member data for sockaddr_un on S390X\n");
CheckOffset(struct sockaddr_un,sun_family,0,12,34485)
CheckOffset(struct sockaddr_un,sun_path,0,12,34486)
#else
