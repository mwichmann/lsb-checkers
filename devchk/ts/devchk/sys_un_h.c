...
#elif __powerpc64__
CheckTypeSize(struct sockaddr_un,0, 9152, 9)
Msg("Missing member data for sockaddr_un on PPC64\n");
CheckOffset(struct sockaddr_un,sun_family,0,9,34485)
CheckOffset(struct sockaddr_un,sun_path,0,9,34486)
#else
