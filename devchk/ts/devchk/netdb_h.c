...
#if _LSB_DEFAULT_ARCH
#ifdef AI_ALL
	CompareConstant(AI_ALL,0x0010,11902,architecture,3.2,NULL)
#else
...
#if _LSB_DEFAULT_ARCH
#ifdef AI_ADDRCONFIG
	CompareConstant(AI_ADDRCONFIG,0x0020,11903,architecture,3.2,NULL)
#else
...
cnt++;
	...
	CompareConstant(AI_NUMERICSERV,0x0400,11904,architecture,3.2,NULL)
#else
