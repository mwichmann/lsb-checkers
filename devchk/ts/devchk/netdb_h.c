...
CheckMemberSize(struct servent,s_aliases,0,3,33734)
CheckOffset(struct servent,s_aliases,8,3,33734)
CheckMemberSize(struct servent,s_port,0,3,33735)
CheckOffset(struct servent,s_port,16,3,33735)
CheckMemberSize(struct servent,s_proto,0,3,33736)
CheckOffset(struct servent,s_proto,24,3,33736)
#elif __powerpc__ && !__powerpc64__
CheckTypeSize(struct servent,16, 10134, 6)
CheckMemberSize(struct servent,s_aliases,0,6,33734)
CheckOffset(struct servent,s_aliases,4,6,33734)
CheckMemberSize(struct servent,s_port,0,6,33735)
CheckOffset(struct servent,s_port,8,6,33735)
CheckMemberSize(struct servent,s_proto,0,6,33736)
...
CheckMemberSize(struct servent,s_port,0,10,33735)
CheckOffset(struct servent,s_port,8,10,33735)
CheckMemberSize(struct servent,s_proto,0,10,33736)
CheckOffset(struct servent,s_proto,12,10,33736)
#elif __powerpc64__
CheckTypeSize(struct servent,32, 10134, 9)
CheckMemberSize(struct servent,s_aliases,0,9,33734)
CheckOffset(struct servent,s_aliases,8,9,33734)
CheckMemberSize(struct servent,s_port,0,9,33735)
CheckOffset(struct servent,s_port,16,9,33735)
CheckMemberSize(struct servent,s_proto,0,9,33736)
...
CheckMemberSize(struct hostent,h_aliases,0,3,33738)
CheckOffset(struct hostent,h_aliases,8,3,33738)
CheckMemberSize(struct hostent,h_addrtype,0,3,33739)
CheckOffset(struct hostent,h_addrtype,16,3,33739)
CheckMemberSize(struct hostent,h_length,0,3,33740)
CheckOffset(struct hostent,h_length,20,3,33740)
CheckMemberSize(struct hostent,h_addr_list,0,3,33741)
CheckOffset(struct hostent,h_addr_list,24,3,33741)
#elif __powerpc__ && !__powerpc64__
CheckTypeSize(struct hostent,20, 10136, 6)
CheckMemberSize(struct hostent,h_aliases,0,6,33738)
CheckOffset(struct hostent,h_aliases,4,6,33738)
CheckMemberSize(struct hostent,h_addrtype,0,6,33739)
CheckOffset(struct hostent,h_addrtype,8,6,33739)
CheckMemberSize(struct hostent,h_length,0,6,33740)
CheckOffset(struct hostent,h_length,12,6,33740)
CheckMemberSize(struct hostent,h_addr_list,0,6,33741)
...
CheckMemberSize(struct hostent,h_addrtype,0,10,33739)
CheckOffset(struct hostent,h_addrtype,8,10,33739)
CheckMemberSize(struct hostent,h_length,0,10,33740)
CheckOffset(struct hostent,h_length,12,10,33740)
CheckMemberSize(struct hostent,h_addr_list,0,10,33741)
CheckOffset(struct hostent,h_addr_list,16,10,33741)
#elif __powerpc64__
CheckTypeSize(struct hostent,32, 10136, 9)
CheckMemberSize(struct hostent,h_aliases,0,9,33738)
CheckOffset(struct hostent,h_aliases,8,9,33738)
CheckMemberSize(struct hostent,h_addrtype,0,9,33739)
CheckOffset(struct hostent,h_addrtype,16,9,33739)
CheckMemberSize(struct hostent,h_length,0,9,33740)
CheckOffset(struct hostent,h_length,20,9,33740)
CheckMemberSize(struct hostent,h_addr_list,0,9,33741)
...
CheckMemberSize(struct protoent,p_aliases,0,3,33743)
CheckOffset(struct protoent,p_aliases,8,3,33743)
CheckMemberSize(struct protoent,p_proto,0,3,33744)
...
CheckMemberSize(struct netent,n_aliases,0,3,33746)
CheckOffset(struct netent,n_aliases,8,3,33746)
CheckMemberSize(struct netent,n_addrtype,0,3,33747)
CheckOffset(struct netent,n_addrtype,16,3,33747)
CheckMemberSize(struct netent,n_net,0,3,33748)
...
CheckMemberSize(struct addrinfo,ai_family,0,3,33695)
CheckOffset(struct addrinfo,ai_family,4,3,33695)
CheckMemberSize(struct addrinfo,ai_socktype,0,3,33696)
CheckOffset(struct addrinfo,ai_socktype,8,3,33696)
CheckMemberSize(struct addrinfo,ai_protocol,0,3,33697)
CheckOffset(struct addrinfo,ai_protocol,12,3,33697)
CheckMemberSize(struct addrinfo,ai_addrlen,0,3,33698)
CheckOffset(struct addrinfo,ai_addrlen,16,3,33698)
CheckMemberSize(struct addrinfo,ai_addr,0,3,33699)
CheckOffset(struct addrinfo,ai_addr,24,3,33699)
CheckMemberSize(struct addrinfo,ai_canonname,0,3,33700)
CheckOffset(struct addrinfo,ai_canonname,32,3,33700)
CheckMemberSize(struct addrinfo,ai_next,0,3,33701)
...
CheckMemberSize(struct addrinfo,ai_socktype,0,10,33696)
CheckOffset(struct addrinfo,ai_socktype,8,10,33696)
CheckMemberSize(struct addrinfo,ai_protocol,0,10,33697)
CheckOffset(struct addrinfo,ai_protocol,12,10,33697)
CheckMemberSize(struct addrinfo,ai_addrlen,0,10,33698)
CheckOffset(struct addrinfo,ai_addrlen,16,10,33698)
CheckMemberSize(struct addrinfo,ai_addr,0,10,33699)
CheckOffset(struct addrinfo,ai_addr,20,10,33699)
CheckMemberSize(struct addrinfo,ai_canonname,0,10,33700)
CheckOffset(struct addrinfo,ai_canonname,24,10,33700)
CheckMemberSize(struct addrinfo,ai_next,0,10,33701)
CheckOffset(struct addrinfo,ai_next,28,10,33701)
#elif __powerpc__ && !__powerpc64__
CheckTypeSize(struct addrinfo,32, 10125, 6)
CheckMemberSize(struct addrinfo,ai_family,0,6,33695)
CheckOffset(struct addrinfo,ai_family,4,6,33695)
CheckMemberSize(struct addrinfo,ai_socktype,0,6,33696)
CheckOffset(struct addrinfo,ai_socktype,8,6,33696)
CheckMemberSize(struct addrinfo,ai_protocol,0,6,33697)
CheckOffset(struct addrinfo,ai_protocol,12,6,33697)
CheckMemberSize(struct addrinfo,ai_addrlen,0,6,33698)
CheckOffset(struct addrinfo,ai_addrlen,16,6,33698)
CheckMemberSize(struct addrinfo,ai_addr,0,6,33699)
CheckOffset(struct addrinfo,ai_addr,20,6,33699)
CheckMemberSize(struct addrinfo,ai_canonname,0,6,33700)
CheckOffset(struct addrinfo,ai_canonname,24,6,33700)
CheckMemberSize(struct addrinfo,ai_next,0,6,33701)
CheckOffset(struct addrinfo,ai_next,28,6,33701)
#elif __powerpc64__
CheckTypeSize(struct addrinfo,48, 10125, 9)
CheckMemberSize(struct addrinfo,ai_family,0,9,33695)
CheckOffset(struct addrinfo,ai_family,4,9,33695)
CheckMemberSize(struct addrinfo,ai_socktype,0,9,33696)
CheckOffset(struct addrinfo,ai_socktype,8,9,33696)
CheckMemberSize(struct addrinfo,ai_protocol,0,9,33697)
CheckOffset(struct addrinfo,ai_protocol,12,9,33697)
CheckMemberSize(struct addrinfo,ai_addrlen,0,9,33698)
CheckOffset(struct addrinfo,ai_addrlen,16,9,33698)
CheckMemberSize(struct addrinfo,ai_addr,0,9,33699)
CheckOffset(struct addrinfo,ai_addr,24,9,33699)
CheckMemberSize(struct addrinfo,ai_canonname,0,9,33700)
CheckOffset(struct addrinfo,ai_canonname,32,9,33700)
CheckMemberSize(struct addrinfo,ai_next,0,9,33701)
