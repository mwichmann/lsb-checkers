...
CheckTypeSize(struct FT_Glyph_Class_,0, 16848, 6, 3.2, NULL, 0, NULL)
Msg("Missing member data for FT_Glyph_Class_ on PPC32\n");
CheckOffset(struct FT_Glyph_Class_,glyph_size,0,6,54126)
CheckOffset(struct FT_Glyph_Class_,glyph_format,0,6,54127)
CheckOffset(struct FT_Glyph_Class_,glyph_init,0,6,54134)
CheckOffset(struct FT_Glyph_Class_,glyph_done,0,6,54136)
CheckOffset(struct FT_Glyph_Class_,glyph_copy,0,6,54139)
CheckOffset(struct FT_Glyph_Class_,glyph_transform,0,6,54143)
CheckOffset(struct FT_Glyph_Class_,glyph_bbox,0,6,54146)
CheckOffset(struct FT_Glyph_Class_,glyph_prepare,0,6,54149)
#elif defined __powerpc64__
CheckTypeSize(struct FT_Glyph_Class_,0, 16848, 9, 3.2, NULL, 0, NULL)
Msg("Missing member data for FT_Glyph_Class_ on PPC64\n");
CheckOffset(struct FT_Glyph_Class_,glyph_size,0,9,54126)
CheckOffset(struct FT_Glyph_Class_,glyph_format,0,9,54127)
CheckOffset(struct FT_Glyph_Class_,glyph_init,0,9,54134)
CheckOffset(struct FT_Glyph_Class_,glyph_done,0,9,54136)
CheckOffset(struct FT_Glyph_Class_,glyph_copy,0,9,54139)
CheckOffset(struct FT_Glyph_Class_,glyph_transform,0,9,54143)
CheckOffset(struct FT_Glyph_Class_,glyph_bbox,0,9,54146)
CheckOffset(struct FT_Glyph_Class_,glyph_prepare,0,9,54149)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(struct FT_GlyphRec_,0, 16849, 6, 3.2, NULL, 0, NULL)
Msg("Missing member data for FT_GlyphRec_ on PPC32\n");
CheckOffset(struct FT_GlyphRec_,library,0,6,54128)
CheckOffset(struct FT_GlyphRec_,clazz,0,6,54129)
CheckOffset(struct FT_GlyphRec_,format,0,6,54130)
CheckOffset(struct FT_GlyphRec_,advance,0,6,54131)
#elif defined __powerpc64__
CheckTypeSize(struct FT_GlyphRec_,0, 16849, 9, 3.2, NULL, 0, NULL)
Msg("Missing member data for FT_GlyphRec_ on PPC64\n");
CheckOffset(struct FT_GlyphRec_,library,0,9,54128)
CheckOffset(struct FT_GlyphRec_,clazz,0,9,54129)
CheckOffset(struct FT_GlyphRec_,format,0,9,54130)
CheckOffset(struct FT_GlyphRec_,advance,0,9,54131)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_Glyph_Class,0, 16850, 6, 3.2, NULL, 16848, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_Glyph_Class,0, 16850, 9, 3.2, NULL, 16848, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_Glyph,0, 16854, 6, 3.2, NULL, 16853, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_Glyph,0, 16854, 9, 3.2, NULL, 16853, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_Glyph_InitFunc,0, 16856, 6, 3.2, NULL, 16855, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_Glyph_InitFunc,0, 16856, 9, 3.2, NULL, 16855, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_Glyph_DoneFunc,0, 16858, 6, 3.2, NULL, 16857, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_Glyph_DoneFunc,0, 16858, 9, 3.2, NULL, 16857, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_Glyph_CopyFunc,0, 16860, 6, 3.2, NULL, 16859, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_Glyph_CopyFunc,0, 16860, 9, 3.2, NULL, 16859, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_Glyph_TransformFunc,0, 16862, 6, 3.2, NULL, 16861, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_Glyph_TransformFunc,0, 16862, 9, 3.2, NULL, 16861, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_Glyph_GetBBoxFunc,0, 16864, 6, 3.2, NULL, 16863, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_Glyph_GetBBoxFunc,0, 16864, 9, 3.2, NULL, 16863, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_Glyph_PrepareFunc,0, 16865, 6, 3.2, NULL, 16855, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_Glyph_PrepareFunc,0, 16865, 9, 3.2, NULL, 16855, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(struct FT_OutlineGlyphRec_,0, 22172, 6, 3.2, NULL, 0, NULL)
Msg("Missing member data for FT_OutlineGlyphRec_ on PPC32\n");
CheckOffset(struct FT_OutlineGlyphRec_,root,0,6,65063)
CheckOffset(struct FT_OutlineGlyphRec_,outline,0,6,65064)
#elif defined __powerpc64__
CheckTypeSize(struct FT_OutlineGlyphRec_,0, 22172, 9, 3.2, NULL, 0, NULL)
Msg("Missing member data for FT_OutlineGlyphRec_ on PPC64\n");
CheckOffset(struct FT_OutlineGlyphRec_,root,0,9,65063)
CheckOffset(struct FT_OutlineGlyphRec_,outline,0,9,65064)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_OutlineGlyph,0, 22174, 6, 3.2, NULL, 22173, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_OutlineGlyph,0, 22174, 9, 3.2, NULL, 22173, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_GlyphRec,0, 22175, 6, 3.2, NULL, 16849, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_GlyphRec,0, 22175, 9, 3.2, NULL, 16849, NULL)
#else
