...
#elif 1
CheckTypeSize(rlim_t,0, 10210, 1);
#endif
...
#elif 1
CheckTypeSize(rlim64_t,0, 10273, 1);
#endif
...
#elif 1
CheckTypeSize(struct rlimit,0, 9120, 1);
Msg("Missing member data for rlimit on All\n");
CheckOffset(struct rlimit,rlim_cur,0,1,34262);
CheckOffset(struct rlimit,rlim_max,0,1,34263);
#endif
...
#elif 1
CheckTypeSize(struct rlimit64,0, 9122, 1);
Msg("Missing member data for rlimit64 on All\n");
CheckOffset(struct rlimit64,rlim_cur,0,1,34266);
CheckOffset(struct rlimit64,rlim_max,0,1,34267);
#endif
...
#elif 1
CheckTypeSize(struct rusage,0, 9125, 1);
Msg("Missing member data for rusage on All\n");
CheckOffset(struct rusage,ru_utime,0,1,34246);
CheckOffset(struct rusage,ru_stime,0,1,34247);
CheckOffset(struct rusage,ru_maxrss,0,1,34248);
CheckOffset(struct rusage,ru_ixrss,0,1,34249);
CheckOffset(struct rusage,ru_idrss,0,1,34250);
CheckOffset(struct rusage,ru_isrss,0,1,34251);
CheckOffset(struct rusage,ru_minflt,0,1,34252);
CheckOffset(struct rusage,ru_majflt,0,1,34253);
CheckOffset(struct rusage,ru_nswap,0,1,34254);
CheckOffset(struct rusage,ru_inblock,0,1,34255);
CheckOffset(struct rusage,ru_oublock,0,1,34256);
CheckOffset(struct rusage,ru_msgsnd,0,1,34257);
CheckOffset(struct rusage,ru_msgrcv,0,1,34258);
CheckOffset(struct rusage,ru_nsignals,0,1,34259);
CheckOffset(struct rusage,ru_nvcsw,0,1,34260);
CheckOffset(struct rusage,ru_nivcsw,0,1,34261);
#endif
