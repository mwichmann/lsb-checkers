...
CheckMemberSize(struct rlimit,rlim_max,0,9,34263)
...
CheckMemberSize(struct rlimit64,rlim_max,0,9,34267)
...
CheckMemberSize(struct rusage,ru_stime,0,9,34247)
CheckOffset(struct rusage,ru_stime,16,9,34247)
CheckMemberSize(struct rusage,ru_maxrss,0,9,34248)
CheckOffset(struct rusage,ru_maxrss,32,9,34248)
CheckMemberSize(struct rusage,ru_ixrss,0,9,34249)
CheckOffset(struct rusage,ru_ixrss,40,9,34249)
CheckMemberSize(struct rusage,ru_idrss,0,9,34250)
CheckOffset(struct rusage,ru_idrss,48,9,34250)
CheckMemberSize(struct rusage,ru_isrss,0,9,34251)
CheckOffset(struct rusage,ru_isrss,56,9,34251)
CheckMemberSize(struct rusage,ru_minflt,0,9,34252)
CheckOffset(struct rusage,ru_minflt,64,9,34252)
CheckMemberSize(struct rusage,ru_majflt,0,9,34253)
CheckOffset(struct rusage,ru_majflt,72,9,34253)
CheckMemberSize(struct rusage,ru_nswap,0,9,34254)
CheckOffset(struct rusage,ru_nswap,80,9,34254)
CheckMemberSize(struct rusage,ru_inblock,0,9,34255)
CheckOffset(struct rusage,ru_inblock,88,9,34255)
CheckMemberSize(struct rusage,ru_oublock,0,9,34256)
CheckOffset(struct rusage,ru_oublock,96,9,34256)
CheckMemberSize(struct rusage,ru_msgsnd,0,9,34257)
CheckOffset(struct rusage,ru_msgsnd,104,9,34257)
CheckMemberSize(struct rusage,ru_msgrcv,0,9,34258)
CheckOffset(struct rusage,ru_msgrcv,112,9,34258)
CheckMemberSize(struct rusage,ru_nsignals,0,9,34259)
CheckOffset(struct rusage,ru_nsignals,120,9,34259)
CheckMemberSize(struct rusage,ru_nvcsw,0,9,34260)
CheckOffset(struct rusage,ru_nvcsw,128,9,34260)
CheckMemberSize(struct rusage,ru_nivcsw,0,9,34261)
