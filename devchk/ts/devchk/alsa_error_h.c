...
CheckTypeSize(snd_lib_error_handler_t,0, 27459, 10, 3.2, NULL, 25000, NULL)
#elif defined __s390x__
CheckTypeSize(snd_lib_error_handler_t,0, 27459, 12, 3.2, NULL, 25000, NULL)
#elif defined __i386__
CheckTypeSize(snd_lib_error_handler_t,0, 27459, 2, 3.2, NULL, 25000, NULL)
#elif defined __ia64__
CheckTypeSize(snd_lib_error_handler_t,0, 27459, 3, 3.2, NULL, 25000, NULL)
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(snd_lib_error_handler_t,0, 27459, 6, 3.2, NULL, 25000, NULL)
#elif defined __powerpc64__
CheckTypeSize(snd_lib_error_handler_t,0, 27459, 9, 3.2, NULL, 25000, NULL)
#else
