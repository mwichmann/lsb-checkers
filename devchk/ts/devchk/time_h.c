...
CheckMemberSize(struct tm,tm_hour,0,10,33514)
CheckOffset(struct tm,tm_hour,8,10,33514)
CheckMemberSize(struct tm,tm_mday,0,10,33515)
CheckOffset(struct tm,tm_mday,12,10,33515)
CheckMemberSize(struct tm,tm_mon,0,10,33516)
CheckOffset(struct tm,tm_mon,16,10,33516)
CheckMemberSize(struct tm,tm_year,0,10,33517)
CheckOffset(struct tm,tm_year,20,10,33517)
CheckMemberSize(struct tm,tm_wday,0,10,33518)
CheckOffset(struct tm,tm_wday,24,10,33518)
CheckMemberSize(struct tm,tm_yday,0,10,33519)
CheckOffset(struct tm,tm_yday,28,10,33519)
CheckMemberSize(struct tm,tm_isdst,0,10,33520)
CheckOffset(struct tm,tm_isdst,32,10,33520)
CheckMemberSize(struct tm,tm_gmtoff,0,10,33521)
CheckOffset(struct tm,tm_gmtoff,36,10,33521)
CheckMemberSize(struct tm,tm_zone,0,10,33522)
CheckOffset(struct tm,tm_zone,40,10,33522)
#elif __powerpc64__
CheckTypeSize(struct tm,56, 7019, 9)
CheckMemberSize(struct tm,tm_min,0,9,33513)
CheckOffset(struct tm,tm_min,4,9,33513)
CheckMemberSize(struct tm,tm_hour,0,9,33514)
CheckOffset(struct tm,tm_hour,8,9,33514)
CheckMemberSize(struct tm,tm_mday,0,9,33515)
CheckOffset(struct tm,tm_mday,12,9,33515)
CheckMemberSize(struct tm,tm_mon,0,9,33516)
CheckOffset(struct tm,tm_mon,16,9,33516)
CheckMemberSize(struct tm,tm_year,0,9,33517)
CheckOffset(struct tm,tm_year,20,9,33517)
CheckMemberSize(struct tm,tm_wday,0,9,33518)
CheckOffset(struct tm,tm_wday,24,9,33518)
CheckMemberSize(struct tm,tm_yday,0,9,33519)
CheckOffset(struct tm,tm_yday,28,9,33519)
CheckMemberSize(struct tm,tm_isdst,0,9,33520)
CheckOffset(struct tm,tm_isdst,32,9,33520)
CheckMemberSize(struct tm,tm_gmtoff,0,9,33521)
CheckOffset(struct tm,tm_gmtoff,40,9,33521)
CheckMemberSize(struct tm,tm_zone,0,9,33522)
...
CheckMemberSize(struct itimerspec,it_value,0,9,33509)
