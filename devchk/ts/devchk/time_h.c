...
#elif 1
CheckTypeSize(struct tm,0, 7019, 1);
Msg("Missing member data for tm on All\n");
CheckOffset(struct tm,tm_sec,0,1,33512);
CheckOffset(struct tm,tm_min,0,1,33513);
CheckOffset(struct tm,tm_hour,0,1,33514);
CheckOffset(struct tm,tm_mday,0,1,33515);
CheckOffset(struct tm,tm_mon,0,1,33516);
CheckOffset(struct tm,tm_year,0,1,33517);
CheckOffset(struct tm,tm_wday,0,1,33518);
CheckOffset(struct tm,tm_yday,0,1,33519);
CheckOffset(struct tm,tm_isdst,0,1,33520);
CheckOffset(struct tm,tm_gmtoff,0,1,33521);
CheckOffset(struct tm,tm_zone,0,1,33522);
#endif
...
#elif 1
CheckTypeSize(struct itimerspec,0, 10101, 1);
Msg("Missing member data for itimerspec on All\n");
CheckOffset(struct itimerspec,it_interval,0,1,33508);
CheckOffset(struct itimerspec,it_value,0,1,33509);
#endif
...
#elif 1
CheckTypeSize(timer_t *,0, 11061, 1);
#endif
...
#elif 1
CheckTypeSize(struct itimerspec *,0, 11062, 1);
#endif
