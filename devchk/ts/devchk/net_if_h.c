...
#elif 1
CheckTypeSize(struct ifaddr,0, 10286, 1);
Msg("Missing member data for ifaddr on All\n");
CheckOffset(struct ifaddr,ifa_addr,0,1,34463);
CheckOffset(struct ifaddr,ifa_ifu,0,1,34466);
CheckOffset(struct ifaddr,ifa_ifp,0,1,34496);
CheckOffset(struct ifaddr,ifa_next,0,1,34497);
#endif
...
#elif 1
CheckTypeSize(struct ifreq,0, 10290, 1);
Msg("Missing member data for ifreq on All\n");
CheckOffset(struct ifreq,ifr_ifrn,0,1,34471);
CheckOffset(struct ifreq,ifr_ifru,0,1,34483);
#endif
...
#elif 1
CheckTypeSize(struct ifconf,0, 10288, 1);
Msg("Missing member data for ifconf on All\n");
CheckOffset(struct ifconf,ifc_len,0,1,34467);
CheckOffset(struct ifconf,ifc_ifcu,0,1,34469);
#endif
...
#elif 1
CheckTypeSize(struct if_nameindex,0, 11015, 1);
Msg("Missing member data for if_nameindex on All\n");
CheckOffset(struct if_nameindex,if_index,0,1,40846);
CheckOffset(struct if_nameindex,if_name,0,1,40847);
#endif
