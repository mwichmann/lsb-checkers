...
tcnt+=gtk_2_0_gtk_gtkenums_h();
tcnt+=gtk_2_0_gtk_gtkprintoperationpreview_h();
tcnt+=gtk_2_0_gtk_gtkrecentfilter_h();
tcnt+=gtk_2_0_gtk_gtkrecentmanager_h();
tcnt+=gtk_2_0_gtk_gtkstatusicon_h();
tcnt+=gtk_2_0_gtk_gtktextbufferrichtext_h();
tcnt+=gtk_unix_print_2_0_gtk_gtkpagesetupunixdialog_h();
tcnt+=gtk_unix_print_2_0_gtk_gtkprinter_h();
tcnt+=gtk_unix_print_2_0_gtk_gtkprintjob_h();
tcnt+=gtk_unix_print_2_0_gtk_gtkprintunixdialog_h();
tcnt+=gtk_unix_print_2_0_gtk_gtkunixprint_h();
tcnt+=iconv_h();
tcnt+=inttypes_h();
tcnt+=jerror_h();
tcnt+=jpeglib_h();
