...
CheckOffset(struct flock,l_type,0,6,34302)
CheckOffset(struct flock,l_whence,0,6,34303)
CheckOffset(struct flock,l_start,0,6,34304)
CheckOffset(struct flock,l_len,0,6,34305)
CheckOffset(struct flock,l_pid,0,6,34306)
#elif __s390__
CheckTypeSize(struct flock,16, 10217, 10)
Msg("Missing member data for flock on S390\n");
CheckOffset(struct flock,l_type,0,10,34302)
CheckOffset(struct flock,l_whence,0,10,34303)
CheckOffset(struct flock,l_start,0,10,34304)
CheckOffset(struct flock,l_len,0,10,34305)
CheckOffset(struct flock,l_pid,0,10,34306)
#else
...
CheckOffset(struct flock64,l_type,0,6,34307)
CheckOffset(struct flock64,l_whence,0,6,34308)
CheckOffset(struct flock64,l_start,0,6,34309)
CheckOffset(struct flock64,l_len,0,6,34310)
CheckOffset(struct flock64,l_pid,0,6,34311)
#elif __s390__
CheckTypeSize(struct flock64,32, 10218, 10)
Msg("Missing member data for flock64 on S390\n");
CheckOffset(struct flock64,l_type,0,10,34307)
CheckOffset(struct flock64,l_whence,0,10,34308)
CheckOffset(struct flock64,l_start,0,10,34309)
CheckOffset(struct flock64,l_len,0,10,34310)
CheckOffset(struct flock64,l_pid,0,10,34311)
#else
