...
CheckMemberSize(struct flock,l_whence,0,3,34303)
CheckOffset(struct flock,l_whence,2,3,34303)
CheckMemberSize(struct flock,l_start,0,3,34304)
CheckOffset(struct flock,l_start,8,3,34304)
CheckMemberSize(struct flock,l_len,0,3,34305)
CheckOffset(struct flock,l_len,16,3,34305)
CheckMemberSize(struct flock,l_pid,0,3,34306)
CheckOffset(struct flock,l_pid,24,3,34306)
#elif __powerpc__ && !__powerpc64__
CheckTypeSize(struct flock,16, 10217, 6)
CheckMemberSize(struct flock,l_whence,0,6,34303)
CheckOffset(struct flock,l_whence,2,6,34303)
CheckMemberSize(struct flock,l_start,0,6,34304)
CheckOffset(struct flock,l_start,4,6,34304)
CheckMemberSize(struct flock,l_len,0,6,34305)
CheckOffset(struct flock,l_len,8,6,34305)
CheckMemberSize(struct flock,l_pid,0,6,34306)
...
CheckMemberSize(struct flock,l_start,0,10,34304)
CheckOffset(struct flock,l_start,4,10,34304)
CheckMemberSize(struct flock,l_len,0,10,34305)
CheckOffset(struct flock,l_len,8,10,34305)
CheckMemberSize(struct flock,l_pid,0,10,34306)
CheckOffset(struct flock,l_pid,12,10,34306)
#elif __powerpc64__
CheckTypeSize(struct flock,32, 10217, 9)
CheckMemberSize(struct flock,l_whence,0,9,34303)
CheckOffset(struct flock,l_whence,2,9,34303)
CheckMemberSize(struct flock,l_start,0,9,34304)
CheckOffset(struct flock,l_start,8,9,34304)
CheckMemberSize(struct flock,l_len,0,9,34305)
CheckOffset(struct flock,l_len,16,9,34305)
CheckMemberSize(struct flock,l_pid,0,9,34306)
...
CheckMemberSize(struct flock64,l_whence,0,3,34308)
CheckOffset(struct flock64,l_whence,2,3,34308)
CheckMemberSize(struct flock64,l_start,0,3,34309)
CheckOffset(struct flock64,l_start,8,3,34309)
CheckMemberSize(struct flock64,l_len,0,3,34310)
CheckOffset(struct flock64,l_len,16,3,34310)
CheckMemberSize(struct flock64,l_pid,0,3,34311)
CheckOffset(struct flock64,l_pid,24,3,34311)
#elif __powerpc__ && !__powerpc64__
CheckTypeSize(struct flock64,32, 10218, 6)
CheckMemberSize(struct flock64,l_whence,0,6,34308)
CheckOffset(struct flock64,l_whence,2,6,34308)
CheckMemberSize(struct flock64,l_start,0,6,34309)
CheckOffset(struct flock64,l_start,8,6,34309)
CheckMemberSize(struct flock64,l_len,0,6,34310)
CheckOffset(struct flock64,l_len,16,6,34310)
CheckMemberSize(struct flock64,l_pid,0,6,34311)
...
CheckMemberSize(struct flock64,l_start,0,10,34309)
CheckOffset(struct flock64,l_start,8,10,34309)
CheckMemberSize(struct flock64,l_len,0,10,34310)
CheckOffset(struct flock64,l_len,16,10,34310)
CheckMemberSize(struct flock64,l_pid,0,10,34311)
CheckOffset(struct flock64,l_pid,24,10,34311)
#elif __powerpc64__
CheckTypeSize(struct flock64,32, 10218, 9)
CheckMemberSize(struct flock64,l_whence,0,9,34308)
CheckOffset(struct flock64,l_whence,2,9,34308)
CheckMemberSize(struct flock64,l_start,0,9,34309)
CheckOffset(struct flock64,l_start,8,9,34309)
CheckMemberSize(struct flock64,l_len,0,9,34310)
CheckOffset(struct flock64,l_len,16,9,34310)
CheckMemberSize(struct flock64,l_pid,0,9,34311)
