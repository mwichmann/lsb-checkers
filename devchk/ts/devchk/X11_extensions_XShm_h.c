...
CheckTypeSize(ShmSeg,4, 9388, 10, 1.2, NULL, 9, NULL)
#elif defined __i386__
CheckTypeSize(ShmSeg,4, 9388, 2, 1.2, NULL, 9, NULL)
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(ShmSeg,4, 9388, 6, 1.2, NULL, 9, NULL)
#elif defined __x86_64__
CheckTypeSize(ShmSeg,8, 9388, 11, 1.2, NULL, 9, NULL)
#elif defined __s390x__
CheckTypeSize(ShmSeg,8, 9388, 12, 1.2, NULL, 9, NULL)
#elif defined __ia64__
CheckTypeSize(ShmSeg,8, 9388, 3, 1.2, NULL, 9, NULL)
#elif defined __powerpc64__
CheckTypeSize(ShmSeg,8, 9388, 9, 1.2, NULL, 9, NULL)
#else
...
#if defined __s390__ && !defined __s390x__
CheckTypeSize(XShmCompletionEvent,36, 9390, 10, 1.2, NULL, 9389, NULL)
#elif defined __i386__
...
#elif defined __x86_64__
CheckTypeSize(XShmCompletionEvent,64, 9390, 11, 1.2, NULL, 9389, NULL)
#elif defined __s390x__
CheckTypeSize(XShmCompletionEvent,64, 9390, 12, 1.2, NULL, 9389, NULL)
#elif defined __ia64__
CheckTypeSize(XShmCompletionEvent,64, 9390, 3, 1.2, NULL, 9389, NULL)
#elif defined __powerpc64__
CheckTypeSize(XShmCompletionEvent,64, 9390, 9, 1.2, NULL, 9389, NULL)
#else
...
#if defined __s390__ && !defined __s390x__
CheckTypeSize(XShmSegmentInfo,16, 9392, 10, 1.2, NULL, 9391, NULL)
#elif defined __i386__
CheckTypeSize(XShmSegmentInfo,16, 9392, 2, 1.2, NULL, 9391, NULL)
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(XShmSegmentInfo,16, 9392, 6, 1.2, NULL, 9391, NULL)
#elif defined __x86_64__
CheckTypeSize(XShmSegmentInfo,32, 9392, 11, 1.2, NULL, 9391, NULL)
#elif defined __s390x__
CheckTypeSize(XShmSegmentInfo,32, 9392, 12, 1.2, NULL, 9391, NULL)
#elif defined __ia64__
CheckTypeSize(XShmSegmentInfo,32, 9392, 3, 1.2, NULL, 9391, NULL)
#elif defined __powerpc64__
CheckTypeSize(XShmSegmentInfo,32, 9392, 9, 1.2, NULL, 9391, NULL)
#else
