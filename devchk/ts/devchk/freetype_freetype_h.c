...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_Face (11168)\n");
%d,%d,%d,'""3.2""',NULL,11167,NULL);\n",architecture,11168,0);
#endif
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_Module (16761)\n");
%d,%d,%d,'""3.2""',NULL,16760,NULL);\n",architecture,16761,0);
#endif
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_Library (16773)\n");
%d,%d,%d,'""3.2""',NULL,16772,NULL);\n",architecture,16773,0);
#endif
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_Renderer (16782)\n");
%d,%d,%d,'""3.2""',NULL,16781,NULL);\n",architecture,16782,0);
#endif
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_GlyphSlotRec_ (16783)\n");
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_GlyphSlot (16785)\n");
%d,%d,%d,'""3.2""',NULL,16784,NULL);\n",architecture,16785,0);
#endif
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_Glyph_Metrics_ (16786)\n");
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_Glyph_Metrics (16787)\n");
%d,%d,%d,'""3.2""',NULL,16786,NULL);\n",architecture,16787,0);
#endif
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_SubGlyph (16793)\n");
%d,%d,%d,'""3.2""',NULL,16792,NULL);\n",architecture,16793,0);
#endif
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_Slot_Internal (16802)\n");
%d,%d,%d,'""3.2""',NULL,16801,NULL);\n",architecture,16802,0);
#endif
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_CharMapRec_ (16887)\n");
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_CharMap (16891)\n");
%d,%d,%d,'""3.2""',NULL,16890,NULL);\n",architecture,16891,0);
#endif
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_F26Dot6 (16897)\n");
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_Parameter_ (16912)\n");
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_Parameter (16913)\n");
%d,%d,%d,'""3.2""',NULL,16912,NULL);\n",architecture,16913,0);
#endif
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_Open_Args (16915)\n");
%d,%d,%d,'""3.2""',NULL,16901,NULL);\n",architecture,16915,0);
#endif
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_SizeRec_ (16951)\n");
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_Size_Metrics (16953)\n");
%d,%d,%d,'""3.2""',NULL,16952,NULL);\n",architecture,16953,0);
#endif
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_Size_Internal (16956)\n");
%d,%d,%d,'""3.2""',NULL,16955,NULL);\n",architecture,16956,0);
#endif
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_Size (16958)\n");
%d,%d,%d,'""3.2""',NULL,16957,NULL);\n",architecture,16958,0);
#endif
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_Bitmap_Size_ (22157)\n");
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_Bitmap_Size (22158)\n");
%d,%d,%d,'""3.2""',NULL,22157,NULL);\n",architecture,22158,0);
#endif
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_Face_Internal (22162)\n");
%d,%d,%d,'""3.2""',NULL,22161,NULL);\n",architecture,22162,0);
#endif
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_Driver (22165)\n");
%d,%d,%d,'""3.2""',NULL,22164,NULL);\n",architecture,22165,0);
#endif
...
#else
Msg("REPLACE INTO ArchType VALUES (Msg("Find size of FT_FaceRec (22166)\n");
%d,%d,%d,'""3.2""',NULL,11166,NULL);\n",architecture,22166,0);
#endif
