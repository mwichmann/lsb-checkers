...
CheckInterfacedef(__mbsnrtowcs_chk,__mbsnrtowcs_chk_db);
extern size_t __mbsrtowcs_chk_db(wchar_t *, const char * *, size_t, mbstate_t *, size_t);
CheckInterfacedef(__mbsrtowcs_chk,__mbsrtowcs_chk_db);
extern int __swprintf_chk_db(wchar_t *, size_t, int, size_t, const wchar_t *, ...);
CheckInterfacedef(__swprintf_chk,__swprintf_chk_db);
extern int __vfwprintf_chk_db(FILE *, int, const wchar_t *, va_list);
CheckInterfacedef(__vfwprintf_chk,__vfwprintf_chk_db);
extern int __vswprintf_chk_db(wchar_t *, size_t, int, size_t, const wchar_t *, va_list);
CheckInterfacedef(__vswprintf_chk,__vswprintf_chk_db);
extern int __vwprintf_chk_db(int, const wchar_t *, va_list);
CheckInterfacedef(__vwprintf_chk,__vwprintf_chk_db);
extern wchar_t * __wcpcpy_chk_db(wchar_t *, const wchar_t *, size_t);
CheckInterfacedef(__wcpcpy_chk,__wcpcpy_chk_db);
extern wchar_t * __wcpncpy_chk_db(wchar_t *, const wchar_t *, size_t, size_t);
CheckInterfacedef(__wcpncpy_chk,__wcpncpy_chk_db);
extern size_t __wcrtomb_chk_db(char *, wchar_t, mbstate_t *, size_t);
CheckInterfacedef(__wcrtomb_chk,__wcrtomb_chk_db);
...
extern wchar_t * __wcsncat_chk_db(wchar_t *, const wchar_t *, size_t, size_t);
CheckInterfacedef(__wcsncat_chk,__wcsncat_chk_db);
extern wchar_t * __wcsncpy_chk_db(wchar_t *, const wchar_t *, size_t, size_t);
CheckInterfacedef(__wcsncpy_chk,__wcsncpy_chk_db);
extern size_t __wcsnrtombs_chk_db(char *, const wchar_t * *, size_t, size_t, mbstate_t *, size_t);
CheckInterfacedef(__wcsnrtombs_chk,__wcsnrtombs_chk_db);
extern size_t __wcsrtombs_chk_db(char *, const wchar_t * *, size_t, mbstate_t *, size_t);
CheckInterfacedef(__wcsrtombs_chk,__wcsrtombs_chk_db);
extern wchar_t * __wmemcpy_chk_db(wchar_t *, const wchar_t *, size_t, size_t);
CheckInterfacedef(__wmemcpy_chk,__wmemcpy_chk_db);
extern wchar_t * __wmemmove_chk_db(wchar_t *, const wchar_t *, size_t, size_t);
CheckInterfacedef(__wmemmove_chk,__wmemmove_chk_db);
extern wchar_t * __wmempcpy_chk_db(wchar_t *, const wchar_t *, size_t, size_t);
CheckInterfacedef(__wmempcpy_chk,__wmempcpy_chk_db);
extern wchar_t * __wmemset_chk_db(wchar_t *, wchar_t, size_t, size_t);
CheckInterfacedef(__wmemset_chk,__wmemset_chk_db);
extern int __wprintf_chk_db(int, const wchar_t *, ...);
...
return;
#else
Msg("%d tests passed out of %d tests in wchar.h\n\n",pcnt,cnt);
return cnt;
#endif
