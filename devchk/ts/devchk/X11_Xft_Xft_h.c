...
CheckTypeSize(struct _XftColor,0, 12556, 3, 1.2, NULL, 0, NULL)
Msg("Missing member data for _XftColor on IA64\n");
CheckOffset(struct _XftColor,pixel,0,3,63991)
CheckOffset(struct _XftColor,color,0,3,63992)
#else
...
#elif defined __ia64__
CheckTypeSize(struct _XftFont,0, 12572, 3, 1.2, NULL, 0, NULL)
Msg("Missing member data for _XftFont on IA64\n");
CheckOffset(struct _XftFont,ascent,0,3,63993)
CheckOffset(struct _XftFont,descent,0,3,63994)
CheckOffset(struct _XftFont,height,0,3,63995)
CheckOffset(struct _XftFont,max_advance_width,0,3,63996)
CheckOffset(struct _XftFont,charset,0,3,63997)
CheckOffset(struct _XftFont,pattern,0,3,63998)
#else
...
#elif defined __ia64__
CheckTypeSize(struct _XftGlyphSpec,0, 12575, 3, 1.2, NULL, 0, NULL)
Msg("Missing member data for _XftGlyphSpec on IA64\n");
CheckOffset(struct _XftGlyphSpec,glyph,0,3,63999)
CheckOffset(struct _XftGlyphSpec,x,0,3,64000)
CheckOffset(struct _XftGlyphSpec,y,0,3,64001)
#else
