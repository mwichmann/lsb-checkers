...
CheckTypeSize(XftColor,0, 12557, 6, 3.2, NULL, 12556, NULL)
#elif defined __powerpc64__
CheckTypeSize(XftColor,0, 12557, 9, 3.2, NULL, 12556, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(XftFont,0, 12573, 6, 3.2, NULL, 12572, NULL)
#elif defined __powerpc64__
CheckTypeSize(XftFont,0, 12573, 9, 3.2, NULL, 12572, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(XftGlyphSpec,0, 12576, 6, 3.2, NULL, 12575, NULL)
#elif defined __powerpc64__
CheckTypeSize(XftGlyphSpec,0, 12576, 9, 3.2, NULL, 12575, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(XftCharSpec,0, 16995, 6, 3.2, NULL, 16994, NULL)
#elif defined __powerpc64__
CheckTypeSize(XftCharSpec,0, 16995, 9, 3.2, NULL, 16994, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(XftCharFontSpec,0, 17009, 6, 3.2, NULL, 17008, NULL)
#elif defined __powerpc64__
CheckTypeSize(XftCharFontSpec,0, 17009, 9, 3.2, NULL, 17008, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(XftGlyphFontSpec,0, 17017, 6, 3.2, NULL, 17016, NULL)
#elif defined __powerpc64__
CheckTypeSize(XftGlyphFontSpec,0, 17017, 9, 3.2, NULL, 17016, NULL)
#else
