...
CheckTypeSize(XftColor,0, 12557, 3, 3.2, NULL, 12556, NULL)
#else
...
#elif defined __ia64__
CheckTypeSize(XftFont,0, 12573, 3, 3.2, NULL, 12572, NULL)
#else
...
#elif defined __ia64__
CheckTypeSize(XftGlyphSpec,0, 12576, 3, 3.2, NULL, 12575, NULL)
#else
...
#elif defined __ia64__
CheckTypeSize(XftCharSpec,0, 16995, 3, 3.2, NULL, 16994, NULL)
#else
...
#elif defined __ia64__
CheckTypeSize(XftCharFontSpec,0, 17009, 3, 3.2, NULL, 17008, NULL)
#else
...
#elif defined __ia64__
CheckTypeSize(XftGlyphFontSpec,0, 17017, 3, 3.2, NULL, 17016, NULL)
#else
