...
CheckMemberSize(struct sigaction,sa_flags,0,6,34717)
CheckOffset(struct sigaction,sa_flags,132,6,34717)
CheckMemberSize(struct sigaction,sa_restorer,0,6,34718)
CheckOffset(struct sigaction,sa_restorer,136,6,34718)
CheckMemberSize(struct sigaction,sa_mask,0,6,34719)
CheckOffset(struct sigaction,sa_mask,4,6,34719)
#elif __powerpc64__
CheckTypeSize(struct sigaction,152, 10402, 9)
CheckMemberSize(struct sigaction,sa_flags,0,9,34717)
CheckOffset(struct sigaction,sa_flags,136,9,34717)
CheckMemberSize(struct sigaction,sa_restorer,0,9,34718)
CheckOffset(struct sigaction,sa_restorer,144,9,34718)
CheckMemberSize(struct sigaction,sa_mask,0,9,34719)
CheckOffset(struct sigaction,sa_mask,8,9,34719)
#elif __i386__
CheckTypeSize(struct sigaction,0, 10402, 2)
CheckMemberSize(struct sigaction,sa_flags,4,2,34717)
CheckOffset(struct sigaction,sa_flags,132,2,34717)
CheckMemberSize(struct sigaction,sa_restorer,4,2,34718)
CheckOffset(struct sigaction,sa_restorer,136,2,34718)
CheckMemberSize(struct sigaction,sa_mask,128,2,34719)
CheckOffset(struct sigaction,sa_mask,4,2,34719)
#elif __ia64__
CheckTypeSize(struct sigaction,0, 10402, 3)
Msg("Missing member data for sigaction on IA64\n");
CheckOffset(struct sigaction,__sigaction_handler,0,3,34716)
CheckOffset(struct sigaction,sa_flags,0,3,34717)
CheckOffset(struct sigaction,sa_restorer,0,3,34718)
CheckOffset(struct sigaction,sa_mask,0,3,34719)
#else
