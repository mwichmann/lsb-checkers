...
CheckTypeSize(struct FT_ListRec_,0, 16720, 6, 3.2, NULL, 0, NULL)
Msg("Missing member data for FT_ListRec_ on PPC32\n");
CheckOffset(struct FT_ListRec_,head,0,6,53939)
CheckOffset(struct FT_ListRec_,tail,0,6,53940)
#elif defined __powerpc64__
CheckTypeSize(struct FT_ListRec_,0, 16720, 9, 3.2, NULL, 0, NULL)
Msg("Missing member data for FT_ListRec_ on PPC64\n");
CheckOffset(struct FT_ListRec_,head,0,9,53939)
CheckOffset(struct FT_ListRec_,tail,0,9,53940)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(struct FT_ListNodeRec_,0, 16721, 6, 3.2, NULL, 0, NULL)
Msg("Missing member data for FT_ListNodeRec_ on PPC32\n");
CheckOffset(struct FT_ListNodeRec_,prev,0,6,53936)
CheckOffset(struct FT_ListNodeRec_,next,0,6,53937)
CheckOffset(struct FT_ListNodeRec_,data,0,6,53938)
#elif defined __powerpc64__
CheckTypeSize(struct FT_ListNodeRec_,0, 16721, 9, 3.2, NULL, 0, NULL)
Msg("Missing member data for FT_ListNodeRec_ on PPC64\n");
CheckOffset(struct FT_ListNodeRec_,prev,0,9,53936)
CheckOffset(struct FT_ListNodeRec_,next,0,9,53937)
CheckOffset(struct FT_ListNodeRec_,data,0,9,53938)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_ListNode,0, 16723, 6, 3.2, NULL, 16722, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_ListNode,0, 16723, 9, 3.2, NULL, 16722, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_List,0, 16725, 6, 3.2, NULL, 16724, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_List,0, 16725, 9, 3.2, NULL, 16724, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(struct FT_Generic_,0, 16748, 6, 3.2, NULL, 0, NULL)
Msg("Missing member data for FT_Generic_ on PPC32\n");
CheckOffset(struct FT_Generic_,data,0,6,53967)
CheckOffset(struct FT_Generic_,finalizer,0,6,53968)
#elif defined __powerpc64__
CheckTypeSize(struct FT_Generic_,0, 16748, 9, 3.2, NULL, 0, NULL)
Msg("Missing member data for FT_Generic_ on PPC64\n");
CheckOffset(struct FT_Generic_,data,0,9,53967)
CheckOffset(struct FT_Generic_,finalizer,0,9,53968)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_Generic_Finalizer,0, 16749, 6, 3.2, NULL, 6988, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_Generic_Finalizer,0, 16749, 9, 3.2, NULL, 6988, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_Generic,0, 16750, 6, 3.2, NULL, 16748, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_Generic,0, 16750, 9, 3.2, NULL, 16748, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_ULong,0, 16754, 6, 3.2, NULL, 11186, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_ULong,0, 16754, 9, 3.2, NULL, 11186, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_Long,0, 16755, 6, 3.2, NULL, 8, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_Long,0, 16755, 9, 3.2, NULL, 8, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_Fixed,0, 16759, 6, 3.2, NULL, 8, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_Fixed,0, 16759, 9, 3.2, NULL, 8, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_Pointer,0, 16766, 6, 3.2, NULL, 40, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_Pointer,0, 16766, 9, 3.2, NULL, 40, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_ListRec,0, 16775, 6, 3.2, NULL, 16720, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_ListRec,0, 16775, 9, 3.2, NULL, 16720, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(struct FT_Matrix_,0, 16790, 6, 3.2, NULL, 0, NULL)
Msg("Missing member data for FT_Matrix_ on PPC32\n");
CheckOffset(struct FT_Matrix_,xx,0,6,54028)
CheckOffset(struct FT_Matrix_,xy,0,6,54029)
CheckOffset(struct FT_Matrix_,yx,0,6,54030)
CheckOffset(struct FT_Matrix_,yy,0,6,54031)
#elif defined __powerpc64__
CheckTypeSize(struct FT_Matrix_,0, 16790, 9, 3.2, NULL, 0, NULL)
Msg("Missing member data for FT_Matrix_ on PPC64\n");
CheckOffset(struct FT_Matrix_,xx,0,9,54028)
CheckOffset(struct FT_Matrix_,xy,0,9,54029)
CheckOffset(struct FT_Matrix_,yx,0,9,54030)
CheckOffset(struct FT_Matrix_,yy,0,9,54031)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_Matrix,0, 16791, 6, 3.2, NULL, 16790, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_Matrix,0, 16791, 9, 3.2, NULL, 16790, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_Bytes,0, 16978, 6, 3.2, NULL, 16896, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_Bytes,0, 16978, 9, 3.2, NULL, 16896, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(FT_ListNodeRec,0, 22171, 6, 3.2, NULL, 16721, NULL)
#elif defined __powerpc64__
CheckTypeSize(FT_ListNodeRec,0, 22171, 9, 3.2, NULL, 16721, NULL)
#else
