...
#elif __powerpc64__
CheckTypeSize(pthread_key_t,0, 9059, 9)
#else
Msg("REPLACE INTO ArchType VALUES (%d,%d,%d);\n",architecture,9059,0);
...
#elif __powerpc64__
CheckTypeSize(pthread_once_t,0, 9062, 9)
#else
Msg("REPLACE INTO ArchType VALUES (%d,%d,%d);\n",architecture,9062,0);
...
#elif __powerpc64__
CheckTypeSize(pthread_t,0, 9040, 9)
#else
Msg("REPLACE INTO ArchType VALUES (%d,%d,%d);\n",architecture,9040,0);
...
#elif __powerpc64__
CheckTypeSize(struct _pthread_fastlock,0, 10105, 9)
Msg("Missing member data for _pthread_fastlock on PPC64\n");
CheckOffset(struct _pthread_fastlock,__status,0,9,33602)
CheckOffset(struct _pthread_fastlock,__spinlock,0,9,34427)
#else
...
#elif __powerpc64__
CheckTypeSize(pthread_mutex_t,0, 9047, 9)
#else
Msg("REPLACE INTO ArchType VALUES (%d,%d,%d);\n",architecture,9047,0);
...
#elif __powerpc64__
CheckTypeSize(pthread_mutexattr_t,0, 9049, 9)
#else
Msg("REPLACE INTO ArchType VALUES (%d,%d,%d);\n",architecture,9049,0);
...
#elif __powerpc64__
CheckTypeSize(pthread_attr_t,0, 9042, 9)
#else
Msg("REPLACE INTO ArchType VALUES (%d,%d,%d);\n",architecture,9042,0);
...
#elif __powerpc64__
CheckTypeSize(pthread_cond_t,0, 9051, 9)
#else
Msg("REPLACE INTO ArchType VALUES (%d,%d,%d);\n",architecture,9051,0);
...
#elif __powerpc64__
CheckTypeSize(pthread_condattr_t,0, 9053, 9)
#else
Msg("REPLACE INTO ArchType VALUES (%d,%d,%d);\n",architecture,9053,0);
...
#elif __powerpc64__
CheckTypeSize(_pthread_descr,0, 9087, 9)
#else
Msg("REPLACE INTO ArchType VALUES (%d,%d,%d);\n",architecture,9087,0);
...
#elif __powerpc64__
CheckTypeSize(pthread_rwlock_t,0, 9055, 9)
#else
Msg("REPLACE INTO ArchType VALUES (%d,%d,%d);\n",architecture,9055,0);
...
#elif __powerpc64__
CheckTypeSize(pthread_rwlockattr_t,0, 9057, 9)
#else
Msg("REPLACE INTO ArchType VALUES (%d,%d,%d);\n",architecture,9057,0);
