...
#if 1
CheckTypeSize(struct _XtransConnInfo *,0, 100201, 1, 1.2, NULL, 100200, NULL)
#endif
...
#if 1
CheckTypeSize(_IcePoProtocol *,0, 100205, 1, 1.2, NULL, 100204, NULL)
#endif
...
#if 1
CheckTypeSize(_IcePaProtocol *,0, 100211, 1, 1.2, NULL, 100210, NULL)
#endif
...
#if 1
CheckTypeSize(_IceProtocol *,0, 100214, 1, 1.2, NULL, 100213, NULL)
#endif
...
#if 1
CheckTypeSize(_IceProcessMsgInfo *,0, 100218, 1, 1.2, NULL, 100217, NULL)
#endif
...
#if 1
CheckTypeSize(_IceSavedReplyWait *,0, 100221, 1, 1.2, NULL, 100220, NULL)
#endif
...
#if 1
CheckTypeSize(_IcePingWait *,0, 100225, 1, 1.2, NULL, 100224, NULL)
#endif
...
#if 1
CheckTypeSize(_IceConnectToYouInfo *,0, 100228, 1, 1.2, NULL, 100227, NULL)
#endif
...
#if 1
CheckTypeSize(_IceProtoSetupToYouInfo *,0, 100231, 1, 1.2, NULL, 100230, NULL)
#endif
...
#if 1
CheckTypeSize(_IceConnectToMeInfo *,0, 100234, 1, 1.2, NULL, 100233, NULL)
#endif
...
#if 1
CheckTypeSize(_IceProtoSetupToMeInfo *,0, 100237, 1, 1.2, NULL, 100236, NULL)
#endif
...
#if 1
CheckTypeSize(struct _IceConn *,0, 100239, 1, 1.2, NULL, 100238, NULL)
#endif
