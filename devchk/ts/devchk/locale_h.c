...
#elif __s390x__
CheckTypeSize(struct lconv,0, 6919, 12)
Msg("Missing member data for lconv on S390X\n");
CheckOffset(struct lconv,decimal_point,0,12,29980)
CheckOffset(struct lconv,thousands_sep,0,12,29981)
CheckOffset(struct lconv,grouping,0,12,29982)
CheckOffset(struct lconv,int_curr_symbol,0,12,29983)
CheckOffset(struct lconv,currency_symbol,0,12,29984)
CheckOffset(struct lconv,mon_decimal_point,0,12,29985)
CheckOffset(struct lconv,mon_thousands_sep,0,12,29986)
CheckOffset(struct lconv,mon_grouping,0,12,29987)
CheckOffset(struct lconv,positive_sign,0,12,29988)
CheckOffset(struct lconv,negative_sign,0,12,29989)
CheckOffset(struct lconv,int_frac_digits,0,12,29990)
CheckOffset(struct lconv,frac_digits,0,12,29991)
CheckOffset(struct lconv,p_cs_precedes,0,12,29992)
CheckOffset(struct lconv,p_sep_by_space,0,12,29993)
CheckOffset(struct lconv,n_cs_precedes,0,12,29994)
CheckOffset(struct lconv,n_sep_by_space,0,12,29995)
CheckOffset(struct lconv,p_sign_posn,0,12,29996)
CheckOffset(struct lconv,n_sign_posn,0,12,29997)
CheckOffset(struct lconv,int_p_cs_precedes,0,12,34431)
CheckOffset(struct lconv,int_p_sep_by_space,0,12,34432)
CheckOffset(struct lconv,int_n_cs_precedes,0,12,34433)
CheckOffset(struct lconv,int_n_sep_by_space,0,12,34434)
CheckOffset(struct lconv,int_p_sign_posn,0,12,34435)
CheckOffset(struct lconv,int_n_sign_posn,0,12,34436)
#else
