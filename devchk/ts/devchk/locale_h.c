...
#elif __powerpc64__
CheckTypeSize(struct lconv,0, 6919, 9)
Msg("Missing member data for lconv on PPC64\n");
CheckOffset(struct lconv,decimal_point,0,9,29980)
CheckOffset(struct lconv,thousands_sep,0,9,29981)
CheckOffset(struct lconv,grouping,0,9,29982)
CheckOffset(struct lconv,int_curr_symbol,0,9,29983)
CheckOffset(struct lconv,currency_symbol,0,9,29984)
CheckOffset(struct lconv,mon_decimal_point,0,9,29985)
CheckOffset(struct lconv,mon_thousands_sep,0,9,29986)
CheckOffset(struct lconv,mon_grouping,0,9,29987)
CheckOffset(struct lconv,positive_sign,0,9,29988)
CheckOffset(struct lconv,negative_sign,0,9,29989)
CheckOffset(struct lconv,int_frac_digits,0,9,29990)
CheckOffset(struct lconv,frac_digits,0,9,29991)
CheckOffset(struct lconv,p_cs_precedes,0,9,29992)
CheckOffset(struct lconv,p_sep_by_space,0,9,29993)
CheckOffset(struct lconv,n_cs_precedes,0,9,29994)
CheckOffset(struct lconv,n_sep_by_space,0,9,29995)
CheckOffset(struct lconv,p_sign_posn,0,9,29996)
CheckOffset(struct lconv,n_sign_posn,0,9,29997)
CheckOffset(struct lconv,int_p_cs_precedes,0,9,34431)
CheckOffset(struct lconv,int_p_sep_by_space,0,9,34432)
CheckOffset(struct lconv,int_n_cs_precedes,0,9,34433)
CheckOffset(struct lconv,int_n_sep_by_space,0,9,34434)
CheckOffset(struct lconv,int_p_sign_posn,0,9,34435)
CheckOffset(struct lconv,int_n_sign_posn,0,9,34436)
#else
