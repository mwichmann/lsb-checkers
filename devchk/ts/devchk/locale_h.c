...
CheckMemberSize(struct lconv,thousands_sep,0,3,29981)
CheckOffset(struct lconv,thousands_sep,8,3,29981)
CheckMemberSize(struct lconv,grouping,0,3,29982)
CheckOffset(struct lconv,grouping,16,3,29982)
CheckMemberSize(struct lconv,int_curr_symbol,0,3,29983)
CheckOffset(struct lconv,int_curr_symbol,24,3,29983)
CheckMemberSize(struct lconv,currency_symbol,0,3,29984)
CheckOffset(struct lconv,currency_symbol,32,3,29984)
CheckMemberSize(struct lconv,mon_decimal_point,0,3,29985)
CheckOffset(struct lconv,mon_decimal_point,40,3,29985)
CheckMemberSize(struct lconv,mon_thousands_sep,0,3,29986)
CheckOffset(struct lconv,mon_thousands_sep,48,3,29986)
CheckMemberSize(struct lconv,mon_grouping,0,3,29987)
CheckOffset(struct lconv,mon_grouping,56,3,29987)
CheckMemberSize(struct lconv,positive_sign,0,3,29988)
CheckOffset(struct lconv,positive_sign,64,3,29988)
CheckMemberSize(struct lconv,negative_sign,0,3,29989)
CheckOffset(struct lconv,negative_sign,72,3,29989)
CheckMemberSize(struct lconv,int_frac_digits,0,3,29990)
CheckOffset(struct lconv,int_frac_digits,80,3,29990)
CheckMemberSize(struct lconv,frac_digits,0,3,29991)
CheckOffset(struct lconv,frac_digits,81,3,29991)
CheckMemberSize(struct lconv,p_cs_precedes,0,3,29992)
CheckOffset(struct lconv,p_cs_precedes,82,3,29992)
CheckMemberSize(struct lconv,p_sep_by_space,0,3,29993)
CheckOffset(struct lconv,p_sep_by_space,83,3,29993)
CheckMemberSize(struct lconv,n_cs_precedes,0,3,29994)
CheckOffset(struct lconv,n_cs_precedes,84,3,29994)
CheckMemberSize(struct lconv,n_sep_by_space,0,3,29995)
CheckOffset(struct lconv,n_sep_by_space,85,3,29995)
CheckMemberSize(struct lconv,p_sign_posn,0,3,29996)
CheckOffset(struct lconv,p_sign_posn,86,3,29996)
CheckMemberSize(struct lconv,n_sign_posn,0,3,29997)
CheckOffset(struct lconv,n_sign_posn,87,3,29997)
CheckMemberSize(struct lconv,int_p_cs_precedes,0,3,34431)
CheckOffset(struct lconv,int_p_cs_precedes,88,3,34431)
CheckMemberSize(struct lconv,int_p_sep_by_space,0,3,34432)
CheckOffset(struct lconv,int_p_sep_by_space,89,3,34432)
CheckMemberSize(struct lconv,int_n_cs_precedes,0,3,34433)
CheckOffset(struct lconv,int_n_cs_precedes,90,3,34433)
CheckMemberSize(struct lconv,int_n_sep_by_space,0,3,34434)
CheckOffset(struct lconv,int_n_sep_by_space,91,3,34434)
CheckMemberSize(struct lconv,int_p_sign_posn,0,3,34435)
CheckOffset(struct lconv,int_p_sign_posn,92,3,34435)
CheckMemberSize(struct lconv,int_n_sign_posn,0,3,34436)
...
CheckMemberSize(struct lconv,grouping,0,10,29982)
CheckOffset(struct lconv,grouping,8,10,29982)
CheckMemberSize(struct lconv,int_curr_symbol,0,10,29983)
CheckOffset(struct lconv,int_curr_symbol,12,10,29983)
CheckMemberSize(struct lconv,currency_symbol,0,10,29984)
CheckOffset(struct lconv,currency_symbol,16,10,29984)
CheckMemberSize(struct lconv,mon_decimal_point,0,10,29985)
CheckOffset(struct lconv,mon_decimal_point,20,10,29985)
CheckMemberSize(struct lconv,mon_thousands_sep,0,10,29986)
CheckOffset(struct lconv,mon_thousands_sep,24,10,29986)
CheckMemberSize(struct lconv,mon_grouping,0,10,29987)
CheckOffset(struct lconv,mon_grouping,28,10,29987)
CheckMemberSize(struct lconv,positive_sign,0,10,29988)
CheckOffset(struct lconv,positive_sign,32,10,29988)
CheckMemberSize(struct lconv,negative_sign,0,10,29989)
CheckOffset(struct lconv,negative_sign,36,10,29989)
CheckMemberSize(struct lconv,int_frac_digits,0,10,29990)
CheckOffset(struct lconv,int_frac_digits,40,10,29990)
CheckMemberSize(struct lconv,frac_digits,0,10,29991)
CheckOffset(struct lconv,frac_digits,41,10,29991)
CheckMemberSize(struct lconv,p_cs_precedes,0,10,29992)
CheckOffset(struct lconv,p_cs_precedes,42,10,29992)
CheckMemberSize(struct lconv,p_sep_by_space,0,10,29993)
CheckOffset(struct lconv,p_sep_by_space,43,10,29993)
CheckMemberSize(struct lconv,n_cs_precedes,0,10,29994)
CheckOffset(struct lconv,n_cs_precedes,44,10,29994)
CheckMemberSize(struct lconv,n_sep_by_space,0,10,29995)
CheckOffset(struct lconv,n_sep_by_space,45,10,29995)
CheckMemberSize(struct lconv,p_sign_posn,0,10,29996)
CheckOffset(struct lconv,p_sign_posn,46,10,29996)
CheckMemberSize(struct lconv,n_sign_posn,0,10,29997)
CheckOffset(struct lconv,n_sign_posn,47,10,29997)
CheckMemberSize(struct lconv,int_p_cs_precedes,0,10,34431)
CheckOffset(struct lconv,int_p_cs_precedes,48,10,34431)
CheckMemberSize(struct lconv,int_p_sep_by_space,0,10,34432)
CheckOffset(struct lconv,int_p_sep_by_space,49,10,34432)
CheckMemberSize(struct lconv,int_n_cs_precedes,0,10,34433)
CheckOffset(struct lconv,int_n_cs_precedes,50,10,34433)
CheckMemberSize(struct lconv,int_n_sep_by_space,0,10,34434)
CheckOffset(struct lconv,int_n_sep_by_space,51,10,34434)
CheckMemberSize(struct lconv,int_p_sign_posn,0,10,34435)
CheckOffset(struct lconv,int_p_sign_posn,52,10,34435)
CheckMemberSize(struct lconv,int_n_sign_posn,0,10,34436)
CheckOffset(struct lconv,int_n_sign_posn,53,10,34436)
#elif __powerpc64__
CheckTypeSize(struct lconv,96, 6919, 9)
CheckMemberSize(struct lconv,thousands_sep,0,9,29981)
CheckOffset(struct lconv,thousands_sep,8,9,29981)
CheckMemberSize(struct lconv,grouping,0,9,29982)
CheckOffset(struct lconv,grouping,16,9,29982)
CheckMemberSize(struct lconv,int_curr_symbol,0,9,29983)
CheckOffset(struct lconv,int_curr_symbol,24,9,29983)
CheckMemberSize(struct lconv,currency_symbol,0,9,29984)
CheckOffset(struct lconv,currency_symbol,32,9,29984)
CheckMemberSize(struct lconv,mon_decimal_point,0,9,29985)
CheckOffset(struct lconv,mon_decimal_point,40,9,29985)
CheckMemberSize(struct lconv,mon_thousands_sep,0,9,29986)
CheckOffset(struct lconv,mon_thousands_sep,48,9,29986)
CheckMemberSize(struct lconv,mon_grouping,0,9,29987)
CheckOffset(struct lconv,mon_grouping,56,9,29987)
CheckMemberSize(struct lconv,positive_sign,0,9,29988)
CheckOffset(struct lconv,positive_sign,64,9,29988)
CheckMemberSize(struct lconv,negative_sign,0,9,29989)
CheckOffset(struct lconv,negative_sign,72,9,29989)
CheckMemberSize(struct lconv,int_frac_digits,0,9,29990)
CheckOffset(struct lconv,int_frac_digits,80,9,29990)
CheckMemberSize(struct lconv,frac_digits,0,9,29991)
CheckOffset(struct lconv,frac_digits,81,9,29991)
CheckMemberSize(struct lconv,p_cs_precedes,0,9,29992)
CheckOffset(struct lconv,p_cs_precedes,82,9,29992)
CheckMemberSize(struct lconv,p_sep_by_space,0,9,29993)
CheckOffset(struct lconv,p_sep_by_space,83,9,29993)
CheckMemberSize(struct lconv,n_cs_precedes,0,9,29994)
CheckOffset(struct lconv,n_cs_precedes,84,9,29994)
CheckMemberSize(struct lconv,n_sep_by_space,0,9,29995)
CheckOffset(struct lconv,n_sep_by_space,85,9,29995)
CheckMemberSize(struct lconv,p_sign_posn,0,9,29996)
CheckOffset(struct lconv,p_sign_posn,86,9,29996)
CheckMemberSize(struct lconv,n_sign_posn,0,9,29997)
CheckOffset(struct lconv,n_sign_posn,87,9,29997)
CheckMemberSize(struct lconv,int_p_cs_precedes,0,9,34431)
CheckOffset(struct lconv,int_p_cs_precedes,88,9,34431)
CheckMemberSize(struct lconv,int_p_sep_by_space,0,9,34432)
CheckOffset(struct lconv,int_p_sep_by_space,89,9,34432)
CheckMemberSize(struct lconv,int_n_cs_precedes,0,9,34433)
CheckOffset(struct lconv,int_n_cs_precedes,90,9,34433)
CheckMemberSize(struct lconv,int_n_sep_by_space,0,9,34434)
CheckOffset(struct lconv,int_n_sep_by_space,91,9,34434)
CheckMemberSize(struct lconv,int_p_sign_posn,0,9,34435)
CheckOffset(struct lconv,int_p_sign_posn,92,9,34435)
CheckMemberSize(struct lconv,int_n_sign_posn,0,9,34436)
