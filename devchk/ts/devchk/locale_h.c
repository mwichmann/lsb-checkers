...
CheckOffset(struct __locale_struct,__names,0,2,40652)
#elif __powerpc__ && !__powerpc64__
...
CheckOffset(struct __locale_struct,__names,0,6,40652)
#elif __ia64__
CheckTypeSize(struct __locale_struct,232, 10531, 3)
CheckMemberSize(struct __locale_struct,__locales,52,3,40181)
...
CheckMemberSize(struct __locale_struct,__names,52,3,40652)
CheckOffset(struct __locale_struct,__names,0,3,40652)
#elif __s390x__
CheckTypeSize(struct __locale_struct,232, 10531, 12)
CheckMemberSize(struct __locale_struct,__locales,52,12,40181)
...
CheckMemberSize(struct __locale_struct,__names,52,12,40652)
CheckOffset(struct __locale_struct,__names,0,12,40652)
#elif __s390__ && !__s390x__
CheckTypeSize(struct __locale_struct,64, 10531, 10)
...
CheckOffset(struct __locale_struct,__names,0,10,40652)
#elif __x86_64__
CheckTypeSize(struct __locale_struct,232, 10531, 11)
CheckMemberSize(struct __locale_struct,__locales,52,11,40181)
...
CheckMemberSize(struct __locale_struct,__names,52,11,40652)
CheckOffset(struct __locale_struct,__names,0,11,40652)
#elif __powerpc64__
CheckTypeSize(struct __locale_struct,128, 10531, 9)
CheckMemberSize(struct __locale_struct,__locales,52,9,40181)
...
CheckMemberSize(struct __locale_struct,__names,52,9,40652)
CheckOffset(struct __locale_struct,__names,0,9,40652)
#else
