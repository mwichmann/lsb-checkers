...
#elif 1
CheckTypeSize(struct lconv,0, 6919, 1);
Msg("Missing member data for lconv on All\n");
CheckOffset(struct lconv,decimal_point,0,1,29980);
CheckOffset(struct lconv,thousands_sep,0,1,29981);
CheckOffset(struct lconv,grouping,0,1,29982);
CheckOffset(struct lconv,int_curr_symbol,0,1,29983);
CheckOffset(struct lconv,currency_symbol,0,1,29984);
CheckOffset(struct lconv,mon_decimal_point,0,1,29985);
CheckOffset(struct lconv,mon_thousands_sep,0,1,29986);
CheckOffset(struct lconv,mon_grouping,0,1,29987);
CheckOffset(struct lconv,positive_sign,0,1,29988);
CheckOffset(struct lconv,negative_sign,0,1,29989);
CheckOffset(struct lconv,int_frac_digits,0,1,29990);
CheckOffset(struct lconv,frac_digits,0,1,29991);
CheckOffset(struct lconv,p_cs_precedes,0,1,29992);
CheckOffset(struct lconv,p_sep_by_space,0,1,29993);
CheckOffset(struct lconv,n_cs_precedes,0,1,29994);
CheckOffset(struct lconv,n_sep_by_space,0,1,29995);
CheckOffset(struct lconv,p_sign_posn,0,1,29996);
CheckOffset(struct lconv,n_sign_posn,0,1,29997);
CheckOffset(struct lconv,int_p_cs_precedes,0,1,34431);
CheckOffset(struct lconv,int_p_sep_by_space,0,1,34432);
CheckOffset(struct lconv,int_n_cs_precedes,0,1,34433);
CheckOffset(struct lconv,int_n_sep_by_space,0,1,34434);
CheckOffset(struct lconv,int_p_sign_posn,0,1,34435);
CheckOffset(struct lconv,int_n_sign_posn,0,1,34436);
#endif
...
#elif 1
CheckTypeSize(struct __locale_struct,0, 10531, 1);
Msg("Missing member data for __locale_struct on All\n");
CheckOffset(struct __locale_struct,__locales,0,1,40181);
CheckOffset(struct __locale_struct,__ctype_b,0,1,40182);
CheckOffset(struct __locale_struct,__ctype_tolower,0,1,40183);
CheckOffset(struct __locale_struct,__ctype_toupper,0,1,40184);
CheckOffset(struct __locale_struct,__names,0,1,40652);
#endif
...
#elif 1
CheckTypeSize(struct __locale_struct *,0, 10532, 1);
#endif
...
#elif 1
CheckTypeSize(__locale_t,0, 10533, 1);
#endif
...
#elif 1
CheckTypeSize(locale_t,0, 10534, 1);
#endif
