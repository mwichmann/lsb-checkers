...
extern  SmcCloseConnection_db(SmcConn, int, char * *);
...
extern  SmcOpenConnection_db(char *, SmPointer, int, int, long unsigned int, SmcCallbacks *, char *, char * *, int, char *);
...
extern  SmcSetErrorHandler_db(SmcErrorHandler);
...
extern  SmsSetErrorHandler_db(SmsErrorHandler);
