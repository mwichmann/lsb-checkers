...
#elif 1
CheckTypeSize(struct rpc_err,0, 9917, 1);
Msg("Missing member data for rpc_err on All\n");
CheckOffset(struct rpc_err,re_status,0,1,32093);
CheckOffset(struct rpc_err,ru,0,1,32102);
#endif
...
#elif 1
CheckTypeSize(struct clnt_ops,0, 9922, 1);
Msg("Missing member data for clnt_ops on All\n");
CheckOffset(struct clnt_ops,cl_call,0,1,32104);
CheckOffset(struct clnt_ops,cl_abort,0,1,32105);
CheckOffset(struct clnt_ops,cl_geterr,0,1,32106);
CheckOffset(struct clnt_ops,cl_freeres,0,1,32107);
CheckOffset(struct clnt_ops,cl_destroy,0,1,32108);
CheckOffset(struct clnt_ops,cl_control,0,1,32109);
#endif
...
#elif 1
CheckTypeSize(struct CLIENT,0, 9921, 1);
Msg("Missing member data for CLIENT on All\n");
CheckOffset(struct CLIENT,cl_auth,0,1,32103);
CheckOffset(struct CLIENT,cl_ops,0,1,32110);
CheckOffset(struct CLIENT,cl_private,0,1,32111);
#endif
...
#elif 1
CheckTypeSize(CLIENT,0, 10389, 1);
#endif

#if __no_sym__
CheckTypeSize(struct clnt_ops *,0, 10429, );
#endif
