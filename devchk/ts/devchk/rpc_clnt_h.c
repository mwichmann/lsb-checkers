...
CheckMemberSize(struct rpc_err,ru,0,6,32102)
...
CheckMemberSize(struct clnt_ops,cl_abort,0,6,32105)
CheckOffset(struct clnt_ops,cl_abort,4,6,32105)
CheckMemberSize(struct clnt_ops,cl_geterr,0,6,32106)
CheckOffset(struct clnt_ops,cl_geterr,8,6,32106)
CheckMemberSize(struct clnt_ops,cl_freeres,0,6,32107)
CheckOffset(struct clnt_ops,cl_freeres,12,6,32107)
CheckMemberSize(struct clnt_ops,cl_destroy,0,6,32108)
CheckOffset(struct clnt_ops,cl_destroy,16,6,32108)
CheckMemberSize(struct clnt_ops,cl_control,0,6,32109)
...
CheckMemberSize(struct CLIENT,cl_ops,0,6,32110)
CheckOffset(struct CLIENT,cl_ops,4,6,32110)
CheckMemberSize(struct CLIENT,cl_private,0,6,32111)
