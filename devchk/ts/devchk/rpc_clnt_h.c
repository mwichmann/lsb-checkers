...
#if __i386__
CheckEnum("RPC_SUCCESS",RPC_SUCCESS,0);
CheckEnum("RPC_CANTENCODEARGS",RPC_CANTENCODEARGS,1);
CheckEnum("RPC_CANTDECODERES",RPC_CANTDECODERES,2);
CheckEnum("RPC_CANTSEND",RPC_CANTSEND,3);
CheckEnum("RPC_CANTRECV",RPC_CANTRECV,4);
CheckEnum("RPC_TIMEDOUT",RPC_TIMEDOUT,5);
CheckEnum("RPC_VERSMISMATCH",RPC_VERSMISMATCH,6);
CheckEnum("RPC_AUTHERROR",RPC_AUTHERROR,7);
CheckEnum("RPC_PROGUNAVAIL",RPC_PROGUNAVAIL,8);
CheckEnum("RPC_PROGVERSMISMATCH",RPC_PROGVERSMISMATCH,9);
CheckEnum("RPC_PROCUNAVAIL",RPC_PROCUNAVAIL,10);
CheckEnum("RPC_CANTDECODEARGS",RPC_CANTDECODEARGS,11);
CheckEnum("RPC_SYSTEMERROR",RPC_SYSTEMERROR,12);
CheckEnum("RPC_NOBROADCAST",RPC_NOBROADCAST,21);
CheckEnum("RPC_UNKNOWNHOST",RPC_UNKNOWNHOST,13);
CheckEnum("RPC_UNKNOWNPROTO",RPC_UNKNOWNPROTO,17);
CheckEnum("RPC_UNKNOWNADDR",RPC_UNKNOWNADDR,19);
CheckEnum("RPC_RPCBFAILURE",RPC_RPCBFAILURE,14);
CheckEnum("RPC_PROGNOTREGISTERED",RPC_PROGNOTREGISTERED,15);
CheckEnum("RPC_N2AXLATEFAILURE",RPC_N2AXLATEFAILURE,22);
CheckEnum("RPC_FAILED",RPC_FAILED,16);
CheckEnum("RPC_INTR",RPC_INTR,18);
CheckEnum("RPC_TLIERROR",RPC_TLIERROR,20);
CheckEnum("RPC_UDERROR",RPC_UDERROR,23);
CheckEnum("RPC_INPROGRESS",RPC_INPROGRESS,24);
CheckEnum("RPC_STALERACHANDLE",RPC_STALERACHANDLE,25);
