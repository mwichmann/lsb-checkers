...
#elif 1
CheckTypeSize(imaxdiv_t,0, 6898, 1);
#endif
...
#elif 1
CheckTypeSize(uint8_t,0, 9270, 1);
#endif
...
#elif 1
CheckTypeSize(uint16_t,0, 9271, 1);
#endif
...
#elif 1
CheckTypeSize(uint32_t,0, 9272, 1);
#endif
...
#if __no_sym__
CheckTypeSize(uintptr_t,0, 10510, );
#endif
