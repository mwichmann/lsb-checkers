...
#elif 1
CheckTypeSize(htmlStatus,0, 15003, 1);
#endif
...
#elif 1
CheckTypeSize(struct _htmlElemDesc,0, 15004, 1);
Msg("Missing member data for _htmlElemDesc on All\n");
CheckOffset(struct _htmlElemDesc,name,0,1,49929);
CheckOffset(struct _htmlElemDesc,startTag,0,1,49930);
CheckOffset(struct _htmlElemDesc,endTag,0,1,49931);
CheckOffset(struct _htmlElemDesc,saveEndTag,0,1,49932);
CheckOffset(struct _htmlElemDesc,empty,0,1,49933);
CheckOffset(struct _htmlElemDesc,depr,0,1,49934);
CheckOffset(struct _htmlElemDesc,dtd,0,1,49935);
CheckOffset(struct _htmlElemDesc,isinline,0,1,49936);
CheckOffset(struct _htmlElemDesc,desc,0,1,49937);
CheckOffset(struct _htmlElemDesc,subelts,0,1,49938);
CheckOffset(struct _htmlElemDesc,defaultsubelt,0,1,49939);
CheckOffset(struct _htmlElemDesc,attrs_opt,0,1,49940);
CheckOffset(struct _htmlElemDesc,attrs_depr,0,1,49941);
CheckOffset(struct _htmlElemDesc,attrs_req,0,1,49942);
#endif
...
#elif 1
CheckTypeSize(htmlElemDesc,0, 15005, 1);
#endif
...
#elif 1
CheckTypeSize(const htmlElemDesc,0, 15006, 1);
#endif
...
#elif 1
CheckTypeSize(htmlDocPtr,0, 15008, 1);
#endif
...
#elif 1
CheckTypeSize(htmlSAXHandlerPtr,0, 15009, 1);
#endif
...
#elif 1
CheckTypeSize(htmlParserCtxtPtr,0, 15010, 1);
#endif
...
#elif 1
CheckTypeSize(struct _htmlEntityDesc,0, 15011, 1);
Msg("Missing member data for _htmlEntityDesc on All\n");
CheckOffset(struct _htmlEntityDesc,value,0,1,49943);
CheckOffset(struct _htmlEntityDesc,name,0,1,49944);
CheckOffset(struct _htmlEntityDesc,desc,0,1,49945);
#endif
...
#elif 1
CheckTypeSize(htmlEntityDesc,0, 15012, 1);
#endif
...
#elif 1
CheckTypeSize(const htmlEntityDesc,0, 15013, 1);
#endif
...
#elif 1
CheckTypeSize(htmlNodePtr,0, 15015, 1);
#endif
...
#elif 1
CheckTypeSize(htmlParserOption,0, 15110, 1);
#endif
...
#elif 1
CheckTypeSize(htmlParserInputPtr,0, 15111, 1);
#endif
...
#elif 1
CheckTypeSize(htmlElemDesc *,0, 15112, 1);
#endif
...
#elif 1
CheckTypeSize(htmlElemDescPtr,0, 15113, 1);
#endif
...
#elif 1
CheckTypeSize(htmlEntityDesc *,0, 15114, 1);
#endif
...
#elif 1
CheckTypeSize(htmlEntityDescPtr,0, 15115, 1);
#endif
...
#elif 1
CheckTypeSize(htmlParserInput,0, 15116, 1);
#endif
