...
#else
Msg( "No definition for HUGE_VALL (5139, longdouble) in db for this architecture\n");
#ifdef HUGE_VALL
#endif
#endif
#if _LSB_DEFAULT_ARCH
...
/* No test for isnan(x) */
#else
Msg( "No definition for isnan(x) (5186, macro) in db for this architecture\n");
#ifdef isnan(x)
#endif
#endif
#if defined __powerpc64__
...
/* No test for isinf(x) */
#else
Msg( "No definition for isinf(x) (5187, macro) in db for this architecture\n");
#ifdef isinf(x)
#endif
#endif
#if defined __powerpc64__
...
/* No test for isfinite(x) */
#else
Msg( "No definition for isfinite(x) (5247, macro) in db for this architecture\n");
#ifdef isfinite(x)
#endif
#endif
#if defined __powerpc64__
...
/* No test for fpclassify(x) */
#else
Msg( "No definition for fpclassify(x) (5248, macro) in db for this architecture\n");
#ifdef fpclassify(x)
#endif
#endif
#if _LSB_DEFAULT_ARCH
...
/* No test for signbit(x) */
#else
Msg( "No definition for signbit(x) (5250, macro) in db for this architecture\n");
#ifdef signbit(x)
#endif
#endif
#if _LSB_DEFAULT_ARCH
