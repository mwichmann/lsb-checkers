...
Msg("Missing member data for re_pattern_buffer on S390\n");
CheckOffset(struct re_pattern_buffer,buffer,0,10,30066)
CheckOffset(struct re_pattern_buffer,allocated,0,10,30067)
CheckOffset(struct re_pattern_buffer,used,0,10,30068)
CheckOffset(struct re_pattern_buffer,syntax,0,10,30069)
CheckOffset(struct re_pattern_buffer,fastmap,0,10,30070)
CheckOffset(struct re_pattern_buffer,translate,0,10,30071)
CheckOffset(struct re_pattern_buffer,re_nsub,0,10,30072)
#else
Msg("REPLACE INTO ArchType VALUES (%d,%d,%d);\n",architecture,6944,0);
