...
CheckOffset(struct statfs,f_type,0,11,63856)
CheckOffset(struct statfs,f_bsize,0,11,63863)
CheckOffset(struct statfs,f_blocks,0,11,63870)
CheckOffset(struct statfs,f_bfree,0,11,63877)
CheckOffset(struct statfs,f_bavail,0,11,63884)
CheckOffset(struct statfs,f_files,0,11,63891)
CheckOffset(struct statfs,f_ffree,0,11,63898)
CheckOffset(struct statfs,f_fsid,0,11,63905)
CheckOffset(struct statfs,f_namelen,0,11,63912)
CheckOffset(struct statfs,f_spare,0,11,63919)
...
CheckOffset(struct statfs64,f_type,0,11,63926)
CheckOffset(struct statfs64,f_bsize,0,11,63933)
CheckOffset(struct statfs64,f_blocks,0,11,63940)
CheckOffset(struct statfs64,f_bfree,0,11,63947)
CheckOffset(struct statfs64,f_bavail,0,11,63954)
CheckOffset(struct statfs64,f_files,0,11,63961)
CheckOffset(struct statfs64,f_ffree,0,11,63968)
CheckOffset(struct statfs64,f_fsid,0,11,63975)
CheckOffset(struct statfs64,f_namelen,0,11,63982)
CheckOffset(struct statfs64,f_spare,0,11,63989)
#elif defined __s390x__
