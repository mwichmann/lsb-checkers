...
CheckMemberSize(struct SVCXPRT,xp_port,0,6,32226)
CheckOffset(struct SVCXPRT,xp_port,4,6,32226)
CheckMemberSize(struct SVCXPRT,xp_ops,0,6,32245)
CheckOffset(struct SVCXPRT,xp_ops,8,6,32245)
CheckMemberSize(struct SVCXPRT,xp_addrlen,0,6,32246)
CheckOffset(struct SVCXPRT,xp_addrlen,12,6,32246)
CheckMemberSize(struct SVCXPRT,xp_raddr,0,6,32247)
CheckOffset(struct SVCXPRT,xp_raddr,16,6,32247)
CheckMemberSize(struct SVCXPRT,xp_verf,0,6,32248)
CheckOffset(struct SVCXPRT,xp_verf,32,6,32248)
CheckMemberSize(struct SVCXPRT,xp_p1,0,6,32249)
CheckOffset(struct SVCXPRT,xp_p1,44,6,32249)
CheckMemberSize(struct SVCXPRT,xp_p2,0,6,32250)
CheckOffset(struct SVCXPRT,xp_p2,48,6,32250)
CheckMemberSize(struct SVCXPRT,xp_pad,0,6,32251)
CheckOffset(struct SVCXPRT,xp_pad,52,6,32251)
#elif __powerpc64__
CheckTypeSize(struct SVCXPRT,336, 9980, 9)
CheckMemberSize(struct SVCXPRT,xp_port,0,9,32226)
CheckOffset(struct SVCXPRT,xp_port,4,9,32226)
CheckMemberSize(struct SVCXPRT,xp_ops,0,9,32245)
CheckOffset(struct SVCXPRT,xp_ops,8,9,32245)
CheckMemberSize(struct SVCXPRT,xp_addrlen,0,9,32246)
CheckOffset(struct SVCXPRT,xp_addrlen,16,9,32246)
CheckMemberSize(struct SVCXPRT,xp_raddr,0,9,32247)
CheckOffset(struct SVCXPRT,xp_raddr,20,9,32247)
CheckMemberSize(struct SVCXPRT,xp_verf,0,9,32248)
CheckOffset(struct SVCXPRT,xp_verf,40,9,32248)
CheckMemberSize(struct SVCXPRT,xp_p1,0,9,32249)
CheckOffset(struct SVCXPRT,xp_p1,64,9,32249)
CheckMemberSize(struct SVCXPRT,xp_p2,0,9,32250)
CheckOffset(struct SVCXPRT,xp_p2,72,9,32250)
CheckMemberSize(struct SVCXPRT,xp_pad,0,9,32251)
