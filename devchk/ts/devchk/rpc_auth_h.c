...
CheckMemberSize(struct opaque_auth,oa_base,0,9,32027)
CheckOffset(struct opaque_auth,oa_base,8,9,32027)
CheckMemberSize(struct opaque_auth,oa_length,0,9,32028)
...
CheckMemberSize(struct AUTH,ah_key,0,10,32031)
CheckOffset(struct AUTH,ah_key,24,10,32031)
CheckMemberSize(struct AUTH,ah_ops,0,10,32037)
CheckOffset(struct AUTH,ah_ops,32,10,32037)
CheckMemberSize(struct AUTH,ah_private,0,10,32038)
...
CheckMemberSize(struct AUTH,ah_verf,0,6,32030)
CheckOffset(struct AUTH,ah_verf,12,6,32030)
CheckMemberSize(struct AUTH,ah_key,0,6,32031)
CheckOffset(struct AUTH,ah_key,24,6,32031)
CheckMemberSize(struct AUTH,ah_ops,0,6,32037)
CheckOffset(struct AUTH,ah_ops,32,6,32037)
CheckMemberSize(struct AUTH,ah_private,0,6,32038)
CheckOffset(struct AUTH,ah_private,36,6,32038)
#elif __powerpc64__
CheckTypeSize(struct AUTH,72, 9896, 9)
CheckMemberSize(struct AUTH,ah_verf,0,9,32030)
CheckOffset(struct AUTH,ah_verf,24,9,32030)
CheckMemberSize(struct AUTH,ah_key,0,9,32031)
CheckOffset(struct AUTH,ah_key,48,9,32031)
CheckMemberSize(struct AUTH,ah_ops,0,9,32037)
CheckOffset(struct AUTH,ah_ops,56,9,32037)
CheckMemberSize(struct AUTH,ah_private,0,9,32038)
...
CheckMemberSize(struct auth_ops,ah_validate,0,10,32034)
CheckOffset(struct auth_ops,ah_validate,8,10,32034)
CheckMemberSize(struct auth_ops,ah_refresh,0,10,32035)
CheckOffset(struct auth_ops,ah_refresh,12,10,32035)
CheckMemberSize(struct auth_ops,ah_destroy,0,10,32036)
...
CheckMemberSize(struct auth_ops,ah_marshal,0,6,32033)
CheckOffset(struct auth_ops,ah_marshal,4,6,32033)
CheckMemberSize(struct auth_ops,ah_validate,0,6,32034)
CheckOffset(struct auth_ops,ah_validate,8,6,32034)
CheckMemberSize(struct auth_ops,ah_refresh,0,6,32035)
CheckOffset(struct auth_ops,ah_refresh,12,6,32035)
CheckMemberSize(struct auth_ops,ah_destroy,0,6,32036)
CheckOffset(struct auth_ops,ah_destroy,16,6,32036)
#elif __powerpc64__
CheckTypeSize(struct auth_ops,40, 9897, 9)
CheckMemberSize(struct auth_ops,ah_marshal,0,9,32033)
CheckOffset(struct auth_ops,ah_marshal,8,9,32033)
CheckMemberSize(struct auth_ops,ah_validate,0,9,32034)
CheckOffset(struct auth_ops,ah_validate,16,9,32034)
CheckMemberSize(struct auth_ops,ah_refresh,0,9,32035)
CheckOffset(struct auth_ops,ah_refresh,24,9,32035)
CheckMemberSize(struct auth_ops,ah_destroy,0,9,32036)
...
CheckMemberSize(union des_block,key,4,6,32024)
...
CheckMemberSize(union des_block,key,4,9,32024)
