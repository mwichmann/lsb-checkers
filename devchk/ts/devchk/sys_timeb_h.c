...
#elif 1
CheckTypeSize(struct timeb,0, 10216, 1);
Msg("Missing member data for timeb on All\n");
CheckOffset(struct timeb,time,0,1,34298);
CheckOffset(struct timeb,millitm,0,1,34299);
CheckOffset(struct timeb,timezone,0,1,34300);
CheckOffset(struct timeb,dstflag,0,1,34301);
#endif
