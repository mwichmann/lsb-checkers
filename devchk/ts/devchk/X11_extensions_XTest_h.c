...
#if _LSB_DEFAULT_ARCH
#ifdef XTestExtensionName
	CompareStringConstant(XTestExtensionName,"XTEST",15535,architecture,4.0,NULL)
#else
Msg( "Error: Constant not found: XTestExtensionName\n");
cnt++;
#endif
...
return;
#else
Msg("%d tests passed out of %d tests in X11/extensions/XTest.h\n\n",pcnt,cnt);
return cnt;
#endif
