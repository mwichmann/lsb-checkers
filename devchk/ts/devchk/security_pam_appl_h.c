...
cnt++;
	...
	CompareConstant(PAM_AUTHTOKEN_REQD,27,5056,architecture)
#else
Msg( "Error: Constant not found: PAM_AUTHTOKEN_REQD\n");
cnt++;
#endif
...
#elif __s390__
CheckTypeSize(struct pam_conv,0, 10352, 10)
#else
...
#elif __s390__
CheckTypeSize(pam_handle_t,0, 10354, 10)
#else
...
#elif __s390__
CheckTypeSize(struct pam_message,0, 10356, 10)
#else
...
#elif __s390__
CheckTypeSize(struct pam_response,0, 10358, 10)
#else
