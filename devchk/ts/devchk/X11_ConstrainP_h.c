...
CheckTypeSize(struct _ConstraintClassPart,48, 100649, 3, 1.3, NULL, 0, NULL)
...
#elif defined __s390__ && !defined __s390x__
CheckTypeSize(struct _ConstraintClassPart,28, 100649, 10, 1.3, NULL, 0, NULL)
...
#elif defined __powerpc64__
CheckTypeSize(struct _ConstraintClassPart,48, 100649, 9, 2.0, NULL, 0, NULL)
...
#elif defined __x86_64__
CheckTypeSize(struct _ConstraintClassPart,48, 100649, 11, 2.0, NULL, 0, NULL)
...
#elif defined __s390x__
CheckTypeSize(struct _ConstraintClassPart,48, 100649, 12, 1.3, NULL, 0, NULL)
...
#elif defined __ia64__
CheckTypeSize(ConstraintClassPart,48, 100650, 3, 1.3, NULL, 100649, NULL)
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(ConstraintClassPart,28, 100650, 6, 1.2, NULL, 100649, NULL)
#elif defined __s390__ && !defined __s390x__
CheckTypeSize(ConstraintClassPart,28, 100650, 10, 1.3, NULL, 100649, NULL)
#elif defined __powerpc64__
CheckTypeSize(ConstraintClassPart,48, 100650, 9, 2.0, NULL, 100649, NULL)
#elif defined __x86_64__
CheckTypeSize(ConstraintClassPart,48, 100650, 11, 2.0, NULL, 100649, NULL)
#elif defined __s390x__
CheckTypeSize(ConstraintClassPart,48, 100650, 12, 1.3, NULL, 100649, NULL)
#else
Msg("Find size of ConstraintClassPart (100650)\n");
Msg("REPLACE INTO ArchType VALUES (%d,%d,%d,'""1.3""',NULL,100649,NULL);\n",architecture,100650,0);
#endif
...
#elif defined __ia64__
CheckTypeSize(struct _ConstraintClassRec,312, 100651, 3, 1.3, NULL, 0, NULL)
...
#elif defined __s390__ && !defined __s390x__
CheckTypeSize(struct _ConstraintClassRec,164, 100651, 10, 1.3, NULL, 0, NULL)
...
#elif defined __powerpc64__
CheckTypeSize(struct _ConstraintClassRec,312, 100651, 9, 2.0, NULL, 0, NULL)
...
#elif defined __x86_64__
CheckTypeSize(struct _ConstraintClassRec,312, 100651, 11, 2.0, NULL, 0, NULL)
...
#elif defined __s390x__
CheckTypeSize(struct _ConstraintClassRec,312, 100651, 12, 1.3, NULL, 0, NULL)
