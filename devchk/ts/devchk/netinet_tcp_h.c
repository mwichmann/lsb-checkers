...
CheckBitField(struct tcphdr,res2,2,2,217209)
CheckBitField(struct tcphdr,res2,2,2,217208)
CheckBitField(struct tcphdr,res2,2,2,217207)
CheckBitField(struct tcphdr,res2,2,2,217211)
...
CheckBitField(struct tcphdr,res2,2,2,217206)
CheckBitField(struct tcphdr,res2,2,2,217210)
#endif
