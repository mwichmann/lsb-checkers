...
CheckTypeSize(FT_List_Destructor,0, 16736, 10, 3.2, NULL, 16735, NULL)
#elif defined __s390x__
CheckTypeSize(FT_List_Destructor,0, 16736, 12, 3.2, NULL, 16735, NULL)
#else
...
#elif defined __s390__ && !defined __s390x__
CheckTypeSize(FT_List_Iterator,0, 16739, 10, 3.2, NULL, 16738, NULL)
#elif defined __s390x__
CheckTypeSize(FT_List_Iterator,0, 16739, 12, 3.2, NULL, 16738, NULL)
#else
