...
#if _LSB_DEFAULT_ARCH
#ifdef FAR
	CompareMacro(FAR,,,5752,architecture,3.1,NULL)
#else
Msg( "Error: Constant not found: FAR\n");
cnt++;
#endif
...
CheckTypeSize(struct jpeg_decompress_struct,632, 11249, 12, 3.1, NULL, 0, NULL)
...
CheckTypeSize(struct jpeg_decompress_struct,632, 11249, 11, 3.1, NULL, 0, NULL)
...
CheckTypeSize(struct jpeg_decompress_struct,464, 11249, 10, 3.1, NULL, 0, NULL)
...
CheckTypeSize(struct jpeg_decompress_struct,632, 11249, 9, 3.1, NULL, 0, NULL)
...
CheckTypeSize(struct jpeg_decompress_struct,464, 11249, 6, 3.1, NULL, 0, NULL)
...
CheckTypeSize(struct jpeg_decompress_struct,632, 11249, 3, 3.1, NULL, 0, NULL)
...
CheckTypeSize(struct jpeg_decompress_struct,464, 11249, 2, 3.1, NULL, 0, NULL)
...
#if defined __s390x__
CheckTypeSize(struct jpeg_error_mgr,168, 11250, 12, 3.1, NULL, 0, NULL)
...
#elif defined __x86_64__
CheckTypeSize(struct jpeg_error_mgr,168, 11250, 11, 3.1, NULL, 0, NULL)
...
#elif defined __s390__ && !defined __s390x__
CheckTypeSize(struct jpeg_error_mgr,132, 11250, 10, 3.1, NULL, 0, NULL)
...
#elif defined __powerpc64__
CheckTypeSize(struct jpeg_error_mgr,168, 11250, 9, 3.1, NULL, 0, NULL)
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(struct jpeg_error_mgr,132, 11250, 6, 3.1, NULL, 0, NULL)
...
#elif defined __ia64__
CheckTypeSize(struct jpeg_error_mgr,168, 11250, 3, 3.1, NULL, 0, NULL)
...
#elif defined __i386__
CheckTypeSize(struct jpeg_error_mgr,132, 11250, 2, 3.1, NULL, 0, NULL)
...
#if defined __s390x__
CheckTypeSize(struct jpeg_common_struct,40, 11251, 12, 3.1, NULL, 0, NULL)
...
#elif defined __x86_64__
CheckTypeSize(struct jpeg_common_struct,40, 11251, 11, 3.1, NULL, 0, NULL)
...
#elif defined __s390__ && !defined __s390x__
CheckTypeSize(struct jpeg_common_struct,24, 11251, 10, 3.1, NULL, 0, NULL)
...
#elif defined __powerpc64__
CheckTypeSize(struct jpeg_common_struct,40, 11251, 9, 3.1, NULL, 0, NULL)
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(struct jpeg_common_struct,24, 11251, 6, 3.1, NULL, 0, NULL)
...
#elif defined __ia64__
CheckTypeSize(struct jpeg_common_struct,40, 11251, 3, 3.1, NULL, 0, NULL)
...
#elif defined __i386__
CheckTypeSize(struct jpeg_common_struct,24, 11251, 2, 3.1, NULL, 0, NULL)
...
#if defined __s390x__
CheckTypeSize(struct jpeg_memory_mgr,104, 11253, 12, 3.1, NULL, 0, NULL)
...
#elif defined __x86_64__
CheckTypeSize(struct jpeg_memory_mgr,104, 11253, 11, 3.1, NULL, 0, NULL)
...
#elif defined __s390__ && !defined __s390x__
CheckTypeSize(struct jpeg_memory_mgr,52, 11253, 10, 3.1, NULL, 0, NULL)
...
#elif defined __powerpc64__
CheckTypeSize(struct jpeg_memory_mgr,104, 11253, 9, 3.1, NULL, 0, NULL)
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(struct jpeg_memory_mgr,52, 11253, 6, 3.1, NULL, 0, NULL)
...
#elif defined __ia64__
CheckTypeSize(struct jpeg_memory_mgr,104, 11253, 3, 3.1, NULL, 0, NULL)
...
#elif defined __i386__
CheckTypeSize(struct jpeg_memory_mgr,52, 11253, 2, 3.1, NULL, 0, NULL)
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.1""',NULL,11254,NULL);\n",architecture,11255,0);
#endif
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.1""',NULL,11258,NULL);\n",architecture,11259,0);
#endif
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.1""',NULL,11260,NULL);\n",architecture,11261,0);
#endif
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.1""',NULL,11266,NULL);\n",architecture,11267,0);
#endif
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.1""',NULL,11268,NULL);\n",architecture,11269,0);
#endif
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.1""',NULL,11270,NULL);\n",architecture,11271,0);
#endif
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.1""',NULL,11274,NULL);\n",architecture,11275,0);
#endif
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.1""',NULL,11279,NULL);\n",architecture,11280,0);
#endif

#if defined __s390x__
CheckTypeSize(struct jpeg_progress_mgr,32, 11287, 12, 3.1, NULL, 0, NULL)
...
#elif defined __x86_64__
CheckTypeSize(struct jpeg_progress_mgr,32, 11287, 11, 3.1, NULL, 0, NULL)
...
#elif defined __s390__ && !defined __s390x__
CheckTypeSize(struct jpeg_progress_mgr,20, 11287, 10, 3.1, NULL, 0, NULL)
...
#elif defined __powerpc64__
CheckTypeSize(struct jpeg_progress_mgr,32, 11287, 9, 3.1, NULL, 0, NULL)
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(struct jpeg_progress_mgr,20, 11287, 6, 3.1, NULL, 0, NULL)
...
#elif defined __ia64__
CheckTypeSize(struct jpeg_progress_mgr,32, 11287, 3, 3.1, NULL, 0, NULL)
...
#elif defined __i386__
CheckTypeSize(struct jpeg_progress_mgr,20, 11287, 2, 3.1, NULL, 0, NULL)
...
#if defined __s390x__
CheckTypeSize(struct jpeg_source_mgr,56, 11295, 12, 3.1, NULL, 0, NULL)
...
#elif defined __x86_64__
CheckTypeSize(struct jpeg_source_mgr,56, 11295, 11, 3.1, NULL, 0, NULL)
...
#elif defined __s390__ && !defined __s390x__
CheckTypeSize(struct jpeg_source_mgr,28, 11295, 10, 3.1, NULL, 0, NULL)
...
#elif defined __powerpc64__
CheckTypeSize(struct jpeg_source_mgr,56, 11295, 9, 3.1, NULL, 0, NULL)
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(struct jpeg_source_mgr,28, 11295, 6, 3.1, NULL, 0, NULL)
...
#elif defined __ia64__
CheckTypeSize(struct jpeg_source_mgr,56, 11295, 3, 3.1, NULL, 0, NULL)
...
#elif defined __i386__
CheckTypeSize(struct jpeg_source_mgr,28, 11295, 2, 3.1, NULL, 0, NULL)
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.1""',NULL,11299,NULL);\n",architecture,11300,0);
#endif
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.1""',NULL,11306,NULL);\n",architecture,11307,0);
#endif
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.1""',NULL,11308,NULL);\n",architecture,11309,0);
#endif
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.1""',NULL,11310,NULL);\n",architecture,11311,0);
#endif
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.1""',NULL,11316,NULL);\n",architecture,11317,0);
#endif
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.1""',NULL,11323,NULL);\n",architecture,11324,0);
#endif
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.1""',NULL,11327,NULL);\n",architecture,11328,0);
#endif

#if defined __s390x__
CheckTypeSize(struct jpeg_marker_struct,32, 11331, 12, 3.1, NULL, 0, NULL)
...
#elif defined __x86_64__
CheckTypeSize(struct jpeg_marker_struct,32, 11331, 11, 3.1, NULL, 0, NULL)
...
#elif defined __s390__ && !defined __s390x__
CheckTypeSize(struct jpeg_marker_struct,20, 11331, 10, 3.1, NULL, 0, NULL)
...
#elif defined __powerpc64__
CheckTypeSize(struct jpeg_marker_struct,32, 11331, 9, 3.1, NULL, 0, NULL)
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(struct jpeg_marker_struct,20, 11331, 6, 3.1, NULL, 0, NULL)
...
#elif defined __ia64__
CheckTypeSize(struct jpeg_marker_struct,32, 11331, 3, 3.1, NULL, 0, NULL)
...
#elif defined __i386__
CheckTypeSize(struct jpeg_marker_struct,20, 11331, 2, 3.1, NULL, 0, NULL)
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.1""',NULL,11332,NULL);\n",architecture,11333,0);
#endif

#if defined __s390x__
CheckTypeSize(struct jpeg_compress_struct,520, 11359, 12, 3.1, NULL, 0, NULL)
...
#elif defined __x86_64__
CheckTypeSize(struct jpeg_compress_struct,520, 11359, 11, 3.1, NULL, 0, NULL)
...
#elif defined __s390__ && !defined __s390x__
CheckTypeSize(struct jpeg_compress_struct,376, 11359, 10, 3.1, NULL, 0, NULL)
...
#elif defined __powerpc64__
CheckTypeSize(struct jpeg_compress_struct,520, 11359, 9, 3.1, NULL, 0, NULL)
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(struct jpeg_compress_struct,376, 11359, 6, 3.1, NULL, 0, NULL)
...
#elif defined __ia64__
CheckTypeSize(struct jpeg_compress_struct,520, 11359, 3, 3.1, NULL, 0, NULL)
...
#elif defined __i386__
CheckTypeSize(struct jpeg_compress_struct,372, 11359, 2, 3.1, NULL, 0, NULL)
...
#if defined __s390x__
CheckTypeSize(struct jpeg_destination_mgr,40, 11360, 12, 3.1, NULL, 0, NULL)
...
#elif defined __x86_64__
CheckTypeSize(struct jpeg_destination_mgr,40, 11360, 11, 3.1, NULL, 0, NULL)
...
#elif defined __s390__ && !defined __s390x__
CheckTypeSize(struct jpeg_destination_mgr,20, 11360, 10, 3.1, NULL, 0, NULL)
...
#elif defined __powerpc64__
CheckTypeSize(struct jpeg_destination_mgr,40, 11360, 9, 3.1, NULL, 0, NULL)
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(struct jpeg_destination_mgr,20, 11360, 6, 3.1, NULL, 0, NULL)
...
#elif defined __ia64__
CheckTypeSize(struct jpeg_destination_mgr,40, 11360, 3, 3.1, NULL, 0, NULL)
...
#elif defined __i386__
CheckTypeSize(struct jpeg_destination_mgr,20, 11360, 2, 3.1, NULL, 0, NULL)
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.1""',NULL,11361,NULL);\n",architecture,11362,0);
#endif
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.1""',NULL,11367,NULL);\n",architecture,11368,0);
#endif
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.1""',NULL,11391,NULL);\n",architecture,11392,0);
#endif
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.1""',NULL,11302, NULL);\n",architecture,11393,0);
#endif
...
return;
#else
Msg("%d tests passed out of %d tests in jpeglib.h\n\n",pcnt,cnt);
return cnt;
#endif
