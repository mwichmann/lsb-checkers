...
CheckEnum("PTRACE_PEEKTEXT",PTRACE_PEEKTEXT,1,220399)
CheckEnum("PTRACE_PEEKDATA",PTRACE_PEEKDATA,2,220400)
CheckEnum("PTRACE_PEEKUSER",PTRACE_PEEKUSER,3,220401)
CheckEnum("PTRACE_POKETEXT",PTRACE_POKETEXT,4,220402)
CheckEnum("PTRACE_POKEDATA",PTRACE_POKEDATA,5,220403)
CheckEnum("PTRACE_POKEUSER",PTRACE_POKEUSER,6,220404)
CheckEnum("PTRACE_CONT",PTRACE_CONT,7,220405)
CheckEnum("PTRACE_KILL",PTRACE_KILL,8,220406)
CheckEnum("PTRACE_SINGLESTEP",PTRACE_SINGLESTEP,9,220407)
CheckEnum("PTRACE_ATTACH",PTRACE_ATTACH,16,220412)
CheckEnum("PTRACE_DETACH",PTRACE_DETACH,17,220413)
CheckEnum("PTRACE_SYSCALL",PTRACE_SYSCALL,24,220416)
CheckEnum("PTRACE_SETOPTIONS",PTRACE_SETOPTIONS,0x4200,220417)
CheckEnum("PTRACE_GETEVENTMSG",PTRACE_GETEVENTMSG,0x4201,220418)
CheckEnum("PTRACE_GETSIGINFO",PTRACE_GETSIGINFO,0x4202,220419)
CheckEnum("PTRACE_SETSIGINFO",PTRACE_SETSIGINFO,0x4203,220420)
#endif
