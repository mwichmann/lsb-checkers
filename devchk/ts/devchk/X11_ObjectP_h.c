...
CheckMemberSize(struct _ObjectPart,widget_class,4,10,34364);
CheckOffset(struct _ObjectPart,widget_class,4,10,34364);
CheckMemberSize(struct _ObjectPart,parent,4,10,34365);
CheckOffset(struct _ObjectPart,parent,8,10,34365);
CheckMemberSize(struct _ObjectPart,xrm_name,4,10,34366);
CheckOffset(struct _ObjectPart,xrm_name,12,10,34366);
CheckMemberSize(struct _ObjectPart,being_destroyed,1,10,34367);
CheckOffset(struct _ObjectPart,being_destroyed,16,10,34367);
CheckMemberSize(struct _ObjectPart,destroy_callbacks,4,10,34368);
CheckOffset(struct _ObjectPart,destroy_callbacks,20,10,34368);
CheckMemberSize(struct _ObjectPart,constraints,4,10,34369);
...
#elif __s390x__
CheckTypeSize(struct _ObjectPart,48, 10261, 12);
CheckMemberSize(struct _ObjectPart,widget_class,8,12,34364);
CheckOffset(struct _ObjectPart,widget_class,8,12,34364);
CheckMemberSize(struct _ObjectPart,parent,8,12,34365);
CheckOffset(struct _ObjectPart,parent,16,12,34365);
CheckMemberSize(struct _ObjectPart,xrm_name,4,12,34366);
CheckOffset(struct _ObjectPart,xrm_name,24,12,34366);
CheckMemberSize(struct _ObjectPart,being_destroyed,1,12,34367);
CheckOffset(struct _ObjectPart,being_destroyed,28,12,34367);
CheckMemberSize(struct _ObjectPart,destroy_callbacks,8,12,34368);
...
#elif 1
CheckTypeSize(struct _ObjectPart,0, 10261, 1);
Msg("Missing member data for _ObjectPart on All\n");
CheckOffset(struct _ObjectPart,self,0,1,34363);
CheckOffset(struct _ObjectPart,widget_class,0,1,34364);
CheckOffset(struct _ObjectPart,parent,0,1,34365);
CheckOffset(struct _ObjectPart,xrm_name,0,1,34366);
CheckOffset(struct _ObjectPart,being_destroyed,0,1,34367);
CheckOffset(struct _ObjectPart,destroy_callbacks,0,1,34368);
CheckOffset(struct _ObjectPart,constraints,0,1,34369);
#endif
...
#elif 1
CheckTypeSize(ObjectPart,0, 10264, 1);
#endif
...
CheckMemberSize(struct _ObjectRec,object,28,10,34409);
...
#elif 1
CheckTypeSize(struct _ObjectRec,0, 10262, 1);
Msg("Missing member data for _ObjectRec on All\n");
CheckOffset(struct _ObjectRec,object,0,1,34409);
#endif
...
#elif 1
CheckTypeSize(ObjectRec,0, 10263, 1);
#endif
...
CheckMemberSize(struct _ObjectClassPart,class_name,4,10,34371);
CheckOffset(struct _ObjectClassPart,class_name,4,10,34371);
CheckMemberSize(struct _ObjectClassPart,widget_size,4,10,34372);
CheckOffset(struct _ObjectClassPart,widget_size,8,10,34372);
CheckMemberSize(struct _ObjectClassPart,class_initialize,4,10,34373);
CheckOffset(struct _ObjectClassPart,class_initialize,12,10,34373);
CheckMemberSize(struct _ObjectClassPart,class_part_initialize,4,10,34374);
CheckOffset(struct _ObjectClassPart,class_part_initialize,16,10,34374);
CheckMemberSize(struct _ObjectClassPart,class_inited,1,10,34375);
CheckOffset(struct _ObjectClassPart,class_inited,20,10,34375);
CheckMemberSize(struct _ObjectClassPart,initialize,4,10,34376);
CheckOffset(struct _ObjectClassPart,initialize,24,10,34376);
CheckMemberSize(struct _ObjectClassPart,initialize_hook,4,10,34377);
CheckOffset(struct _ObjectClassPart,initialize_hook,28,10,34377);
CheckMemberSize(struct _ObjectClassPart,obj1,4,10,34378);
CheckOffset(struct _ObjectClassPart,obj1,32,10,34378);
CheckMemberSize(struct _ObjectClassPart,obj2,4,10,34379);
CheckOffset(struct _ObjectClassPart,obj2,36,10,34379);
CheckMemberSize(struct _ObjectClassPart,obj3,4,10,34380);
CheckOffset(struct _ObjectClassPart,obj3,40,10,34380);
CheckMemberSize(struct _ObjectClassPart,resources,4,10,34381);
CheckOffset(struct _ObjectClassPart,resources,44,10,34381);
CheckMemberSize(struct _ObjectClassPart,num_resources,4,10,34382);
CheckOffset(struct _ObjectClassPart,num_resources,48,10,34382);
CheckMemberSize(struct _ObjectClassPart,xrm_class,4,10,34383);
CheckOffset(struct _ObjectClassPart,xrm_class,52,10,34383);
CheckMemberSize(struct _ObjectClassPart,obj4,1,10,34384);
CheckOffset(struct _ObjectClassPart,obj4,56,10,34384);
CheckMemberSize(struct _ObjectClassPart,obj5,1,10,34385);
CheckOffset(struct _ObjectClassPart,obj5,57,10,34385);
CheckMemberSize(struct _ObjectClassPart,obj6,1,10,34386);
CheckOffset(struct _ObjectClassPart,obj6,58,10,34386);
CheckMemberSize(struct _ObjectClassPart,obj7,1,10,34387);
CheckOffset(struct _ObjectClassPart,obj7,59,10,34387);
CheckMemberSize(struct _ObjectClassPart,destroy,4,10,34388);
CheckOffset(struct _ObjectClassPart,destroy,60,10,34388);
CheckMemberSize(struct _ObjectClassPart,obj8,4,10,34389);
CheckOffset(struct _ObjectClassPart,obj8,64,10,34389);
CheckMemberSize(struct _ObjectClassPart,obj9,4,10,34390);
CheckOffset(struct _ObjectClassPart,obj9,68,10,34390);
CheckMemberSize(struct _ObjectClassPart,set_values,4,10,34391);
CheckOffset(struct _ObjectClassPart,set_values,72,10,34391);
CheckMemberSize(struct _ObjectClassPart,set_values_hook,4,10,34392);
CheckOffset(struct _ObjectClassPart,set_values_hook,76,10,34392);
CheckMemberSize(struct _ObjectClassPart,obj10,4,10,34393);
CheckOffset(struct _ObjectClassPart,obj10,80,10,34393);
CheckMemberSize(struct _ObjectClassPart,get_values_hook,4,10,34394);
CheckOffset(struct _ObjectClassPart,get_values_hook,84,10,34394);
CheckMemberSize(struct _ObjectClassPart,obj11,4,10,34395);
CheckOffset(struct _ObjectClassPart,obj11,88,10,34395);
CheckMemberSize(struct _ObjectClassPart,version,4,10,34396);
CheckOffset(struct _ObjectClassPart,version,92,10,34396);
CheckMemberSize(struct _ObjectClassPart,callback_private,4,10,34397);
CheckOffset(struct _ObjectClassPart,callback_private,96,10,34397);
CheckMemberSize(struct _ObjectClassPart,obj12,4,10,34398);
CheckOffset(struct _ObjectClassPart,obj12,100,10,34398);
CheckMemberSize(struct _ObjectClassPart,obj13,4,10,34399);
CheckOffset(struct _ObjectClassPart,obj13,104,10,34399);
CheckMemberSize(struct _ObjectClassPart,obj14,4,10,34400);
CheckOffset(struct _ObjectClassPart,obj14,108,10,34400);
CheckMemberSize(struct _ObjectClassPart,extension,4,10,34401);
...
#elif __s390x__
CheckTypeSize(struct _ObjectClassPart,224, 10265, 12);
CheckMemberSize(struct _ObjectClassPart,class_name,8,12,34371);
CheckOffset(struct _ObjectClassPart,class_name,8,12,34371);
CheckMemberSize(struct _ObjectClassPart,widget_size,4,12,34372);
CheckOffset(struct _ObjectClassPart,widget_size,16,12,34372);
CheckMemberSize(struct _ObjectClassPart,class_initialize,8,12,34373);
CheckOffset(struct _ObjectClassPart,class_initialize,24,12,34373);
CheckMemberSize(struct _ObjectClassPart,class_part_initialize,8,12,34374);
CheckOffset(struct _ObjectClassPart,class_part_initialize,32,12,34374);
CheckMemberSize(struct _ObjectClassPart,class_inited,1,12,34375);
CheckOffset(struct _ObjectClassPart,class_inited,40,12,34375);
CheckMemberSize(struct _ObjectClassPart,initialize,8,12,34376);
CheckOffset(struct _ObjectClassPart,initialize,48,12,34376);
CheckMemberSize(struct _ObjectClassPart,initialize_hook,8,12,34377);
CheckOffset(struct _ObjectClassPart,initialize_hook,56,12,34377);
CheckMemberSize(struct _ObjectClassPart,obj1,8,12,34378);
CheckOffset(struct _ObjectClassPart,obj1,64,12,34378);
CheckMemberSize(struct _ObjectClassPart,obj2,8,12,34379);
CheckOffset(struct _ObjectClassPart,obj2,72,12,34379);
CheckMemberSize(struct _ObjectClassPart,obj3,4,12,34380);
CheckOffset(struct _ObjectClassPart,obj3,80,12,34380);
CheckMemberSize(struct _ObjectClassPart,resources,8,12,34381);
CheckOffset(struct _ObjectClassPart,resources,88,12,34381);
CheckMemberSize(struct _ObjectClassPart,num_resources,4,12,34382);
CheckOffset(struct _ObjectClassPart,num_resources,96,12,34382);
CheckMemberSize(struct _ObjectClassPart,xrm_class,4,12,34383);
CheckOffset(struct _ObjectClassPart,xrm_class,100,12,34383);
CheckMemberSize(struct _ObjectClassPart,obj4,1,12,34384);
CheckOffset(struct _ObjectClassPart,obj4,104,12,34384);
CheckMemberSize(struct _ObjectClassPart,obj5,1,12,34385);
CheckOffset(struct _ObjectClassPart,obj5,105,12,34385);
CheckMemberSize(struct _ObjectClassPart,obj6,1,12,34386);
CheckOffset(struct _ObjectClassPart,obj6,106,12,34386);
CheckMemberSize(struct _ObjectClassPart,obj7,1,12,34387);
CheckOffset(struct _ObjectClassPart,obj7,107,12,34387);
CheckMemberSize(struct _ObjectClassPart,destroy,8,12,34388);
CheckOffset(struct _ObjectClassPart,destroy,112,12,34388);
CheckMemberSize(struct _ObjectClassPart,obj8,8,12,34389);
CheckOffset(struct _ObjectClassPart,obj8,120,12,34389);
CheckMemberSize(struct _ObjectClassPart,obj9,8,12,34390);
CheckOffset(struct _ObjectClassPart,obj9,128,12,34390);
CheckMemberSize(struct _ObjectClassPart,set_values,8,12,34391);
CheckOffset(struct _ObjectClassPart,set_values,136,12,34391);
CheckMemberSize(struct _ObjectClassPart,set_values_hook,8,12,34392);
CheckOffset(struct _ObjectClassPart,set_values_hook,144,12,34392);
CheckMemberSize(struct _ObjectClassPart,obj10,8,12,34393);
CheckOffset(struct _ObjectClassPart,obj10,152,12,34393);
CheckMemberSize(struct _ObjectClassPart,get_values_hook,8,12,34394);
CheckOffset(struct _ObjectClassPart,get_values_hook,160,12,34394);
CheckMemberSize(struct _ObjectClassPart,obj11,8,12,34395);
CheckOffset(struct _ObjectClassPart,obj11,168,12,34395);
CheckMemberSize(struct _ObjectClassPart,version,8,12,34396);
CheckOffset(struct _ObjectClassPart,version,176,12,34396);
CheckMemberSize(struct _ObjectClassPart,callback_private,8,12,34397);
CheckOffset(struct _ObjectClassPart,callback_private,184,12,34397);
CheckMemberSize(struct _ObjectClassPart,obj12,8,12,34398);
CheckOffset(struct _ObjectClassPart,obj12,192,12,34398);
CheckMemberSize(struct _ObjectClassPart,obj13,8,12,34399);
CheckOffset(struct _ObjectClassPart,obj13,200,12,34399);
CheckMemberSize(struct _ObjectClassPart,obj14,8,12,34400);
...
#elif 1
CheckTypeSize(struct _ObjectClassPart,0, 10265, 1);
Msg("Missing member data for _ObjectClassPart on All\n");
CheckOffset(struct _ObjectClassPart,superclass,0,1,34370);
CheckOffset(struct _ObjectClassPart,class_name,0,1,34371);
CheckOffset(struct _ObjectClassPart,widget_size,0,1,34372);
CheckOffset(struct _ObjectClassPart,class_initialize,0,1,34373);
CheckOffset(struct _ObjectClassPart,class_part_initialize,0,1,34374);
CheckOffset(struct _ObjectClassPart,class_inited,0,1,34375);
CheckOffset(struct _ObjectClassPart,initialize,0,1,34376);
CheckOffset(struct _ObjectClassPart,initialize_hook,0,1,34377);
CheckOffset(struct _ObjectClassPart,obj1,0,1,34378);
CheckOffset(struct _ObjectClassPart,obj2,0,1,34379);
CheckOffset(struct _ObjectClassPart,obj3,0,1,34380);
CheckOffset(struct _ObjectClassPart,resources,0,1,34381);
CheckOffset(struct _ObjectClassPart,num_resources,0,1,34382);
CheckOffset(struct _ObjectClassPart,xrm_class,0,1,34383);
CheckOffset(struct _ObjectClassPart,obj4,0,1,34384);
CheckOffset(struct _ObjectClassPart,obj5,0,1,34385);
CheckOffset(struct _ObjectClassPart,obj6,0,1,34386);
CheckOffset(struct _ObjectClassPart,obj7,0,1,34387);
CheckOffset(struct _ObjectClassPart,destroy,0,1,34388);
CheckOffset(struct _ObjectClassPart,obj8,0,1,34389);
CheckOffset(struct _ObjectClassPart,obj9,0,1,34390);
CheckOffset(struct _ObjectClassPart,set_values,0,1,34391);
CheckOffset(struct _ObjectClassPart,set_values_hook,0,1,34392);
CheckOffset(struct _ObjectClassPart,obj10,0,1,34393);
CheckOffset(struct _ObjectClassPart,get_values_hook,0,1,34394);
CheckOffset(struct _ObjectClassPart,obj11,0,1,34395);
CheckOffset(struct _ObjectClassPart,version,0,1,34396);
CheckOffset(struct _ObjectClassPart,callback_private,0,1,34397);
CheckOffset(struct _ObjectClassPart,obj12,0,1,34398);
CheckOffset(struct _ObjectClassPart,obj13,0,1,34399);
CheckOffset(struct _ObjectClassPart,obj14,0,1,34400);
CheckOffset(struct _ObjectClassPart,extension,0,1,34401);
#endif
...
#elif 1
CheckTypeSize(ObjectClassPart,0, 10266, 1);
#endif
...
#elif 1
CheckTypeSize(ObjectClassExtensionRec,0, 10268, 1);
#endif
...
#elif 1
CheckTypeSize(ObjectClassExtension,0, 10270, 1);
#endif
...
CheckMemberSize(struct _ObjectClassRec,object_class,116,10,34408);
...
#elif 1
CheckTypeSize(struct _ObjectClassRec,0, 10271, 1);
Msg("Missing member data for _ObjectClassRec on All\n");
CheckOffset(struct _ObjectClassRec,object_class,0,1,34408);
#endif
...
#elif 1
CheckTypeSize(ObjectClassRec,0, 10272, 1);
#endif
...
#elif 1
CheckTypeSize(struct _ObjectClassExtensionRec *,0, 10269, 1);
#endif
