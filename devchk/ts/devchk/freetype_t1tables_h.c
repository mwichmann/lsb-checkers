...
CheckTypeSize(PS_PrivateRec,0, 16987, 6, 3.2, NULL, 16980, NULL)
#elif defined __powerpc64__
CheckTypeSize(PS_PrivateRec,0, 16987, 9, 3.2, NULL, 16980, NULL)
#else
...
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(PS_FontInfoRec,0, 16990, 6, 3.2, NULL, 16989, NULL)
#elif defined __powerpc64__
CheckTypeSize(PS_FontInfoRec,0, 16990, 9, 3.2, NULL, 16989, NULL)
#else
