...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.2""',NULL,26326,NULL);\n",architecture,27347,0);
#endif
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.2""',NULL,26328,NULL);\n",architecture,27352,0);
#endif
...
Sql("REPLACE INTO ArchType VALUES (%d,%d,%d,'""3.2""',NULL,27397, NULL);\n",architecture,27400,0);
#endif
...
return;
#else
Msg("%d tests passed out of %d tests in alsa/conf.h\n\n",pcnt,cnt);
return cnt;
#endif
