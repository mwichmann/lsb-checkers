...
CheckMemberSize(struct lastlog,ll_host,0,10,34462)
...
CheckMemberSize(struct utmp,ut_line,0,10,34449)
CheckOffset(struct utmp,ut_line,8,10,34449)
CheckMemberSize(struct utmp,ut_id,0,10,34450)
CheckOffset(struct utmp,ut_id,40,10,34450)
CheckMemberSize(struct utmp,ut_user,0,10,34451)
CheckOffset(struct utmp,ut_user,44,10,34451)
CheckMemberSize(struct utmp,ut_host,0,10,34452)
CheckOffset(struct utmp,ut_host,76,10,34452)
CheckMemberSize(struct utmp,ut_exit,0,10,34455)
CheckOffset(struct utmp,ut_exit,332,10,34455)
CheckMemberSize(struct utmp,ut_session,0,10,34456)
CheckOffset(struct utmp,ut_session,336,10,34456)
CheckMemberSize(struct utmp,ut_tv,0,10,34457)
CheckOffset(struct utmp,ut_tv,340,10,34457)
CheckMemberSize(struct utmp,ut_addr_v6,0,10,34458)
CheckOffset(struct utmp,ut_addr_v6,348,10,34458)
CheckMemberSize(struct utmp,__unused,0,10,34459)
