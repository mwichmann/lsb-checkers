...
CheckMemberSize(struct exit_status,e_exit,0,9,34454)
...
CheckMemberSize(struct lastlog,ll_line,0,9,34461)
CheckOffset(struct lastlog,ll_line,8,9,34461)
CheckMemberSize(struct lastlog,ll_host,0,9,34462)
...
CheckMemberSize(struct utmp,ut_pid,0,9,34448)
CheckOffset(struct utmp,ut_pid,4,9,34448)
CheckMemberSize(struct utmp,ut_line,0,9,34449)
CheckOffset(struct utmp,ut_line,8,9,34449)
CheckMemberSize(struct utmp,ut_id,0,9,34450)
CheckOffset(struct utmp,ut_id,40,9,34450)
CheckMemberSize(struct utmp,ut_user,0,9,34451)
CheckOffset(struct utmp,ut_user,44,9,34451)
CheckMemberSize(struct utmp,ut_host,0,9,34452)
CheckOffset(struct utmp,ut_host,76,9,34452)
CheckMemberSize(struct utmp,ut_exit,0,9,34455)
CheckOffset(struct utmp,ut_exit,332,9,34455)
CheckMemberSize(struct utmp,ut_session,0,9,34456)
CheckOffset(struct utmp,ut_session,336,9,34456)
CheckMemberSize(struct utmp,ut_tv,0,9,34457)
CheckOffset(struct utmp,ut_tv,340,9,34457)
CheckMemberSize(struct utmp,ut_addr_v6,0,9,34458)
CheckOffset(struct utmp,ut_addr_v6,348,9,34458)
CheckMemberSize(struct utmp,__unused,0,9,34459)
