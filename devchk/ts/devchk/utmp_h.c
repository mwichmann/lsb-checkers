...
CheckOffset(struct exit_status,e_termination,0,10,34453)
CheckOffset(struct exit_status,e_exit,0,10,34454)
#else
...
CheckOffset(struct lastlog,ll_line,0,6,34461)
...
CheckOffset(struct lastlog,ll_time,0,10,34460)
CheckOffset(struct lastlog,ll_line,0,10,34461)
CheckOffset(struct lastlog,ll_host,0,10,34462)
#else
...
CheckOffset(struct utmp,ut_pid,0,6,34448)
CheckOffset(struct utmp,ut_line,0,6,34449)
CheckOffset(struct utmp,ut_id,0,6,34450)
CheckOffset(struct utmp,ut_user,0,6,34451)
CheckOffset(struct utmp,ut_host,0,6,34452)
CheckOffset(struct utmp,ut_exit,0,6,34455)
CheckOffset(struct utmp,ut_session,0,6,34456)
CheckOffset(struct utmp,ut_tv,0,6,34457)
CheckOffset(struct utmp,ut_addr_v6,0,6,34458)
...
CheckOffset(struct utmp,ut_type,0,10,34447)
CheckOffset(struct utmp,ut_pid,0,10,34448)
CheckOffset(struct utmp,ut_line,0,10,34449)
CheckOffset(struct utmp,ut_id,0,10,34450)
CheckOffset(struct utmp,ut_user,0,10,34451)
CheckOffset(struct utmp,ut_host,0,10,34452)
CheckOffset(struct utmp,ut_exit,0,10,34455)
CheckOffset(struct utmp,ut_session,0,10,34456)
CheckOffset(struct utmp,ut_tv,0,10,34457)
CheckOffset(struct utmp,ut_addr_v6,0,10,34458)
CheckOffset(struct utmp,__unused,0,10,34459)
#else
