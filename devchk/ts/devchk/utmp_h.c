...
CheckMemberSize(struct utmp,ut_pid,4,3,34448)
CheckOffset(struct utmp,ut_pid,4,3,34448)
CheckMemberSize(struct utmp,ut_line,32,3,34449)
CheckOffset(struct utmp,ut_line,8,3,34449)
CheckMemberSize(struct utmp,ut_id,4,3,34450)
CheckOffset(struct utmp,ut_id,40,3,34450)
CheckMemberSize(struct utmp,ut_user,32,3,34451)
CheckOffset(struct utmp,ut_user,44,3,34451)
CheckMemberSize(struct utmp,ut_host,256,3,34452)
CheckOffset(struct utmp,ut_host,76,3,34452)
CheckMemberSize(struct utmp,ut_exit,4,3,34455)
CheckOffset(struct utmp,ut_exit,332,3,34455)
CheckMemberSize(struct utmp,ut_session,8,3,34456)
CheckOffset(struct utmp,ut_session,336,3,34456)
CheckMemberSize(struct utmp,ut_tv,16,3,34457)
CheckOffset(struct utmp,ut_tv,344,3,34457)
CheckMemberSize(struct utmp,ut_addr_v6,16,3,34458)
...
CheckMemberSize(struct utmp,ut_pid,4,10,34448)
CheckOffset(struct utmp,ut_pid,4,10,34448)
CheckMemberSize(struct utmp,ut_line,32,10,34449)
CheckOffset(struct utmp,ut_line,8,10,34449)
CheckMemberSize(struct utmp,ut_id,4,10,34450)
CheckOffset(struct utmp,ut_id,40,10,34450)
CheckMemberSize(struct utmp,ut_user,32,10,34451)
CheckOffset(struct utmp,ut_user,44,10,34451)
CheckMemberSize(struct utmp,ut_host,256,10,34452)
CheckOffset(struct utmp,ut_host,76,10,34452)
CheckMemberSize(struct utmp,ut_exit,4,10,34455)
CheckOffset(struct utmp,ut_exit,332,10,34455)
CheckMemberSize(struct utmp,ut_session,4,10,34456)
CheckOffset(struct utmp,ut_session,336,10,34456)
CheckMemberSize(struct utmp,ut_tv,8,10,34457)
CheckOffset(struct utmp,ut_tv,340,10,34457)
CheckMemberSize(struct utmp,ut_addr_v6,16,10,34458)
CheckOffset(struct utmp,ut_addr_v6,348,10,34458)
CheckMemberSize(struct utmp,__unused,20,10,34459)
CheckOffset(struct utmp,__unused,364,10,34459)
#elif __powerpc64__
CheckTypeSize(struct utmp,400, 10281, 9)
CheckMemberSize(struct utmp,ut_pid,4,9,34448)
CheckOffset(struct utmp,ut_pid,4,9,34448)
CheckMemberSize(struct utmp,ut_line,32,9,34449)
CheckOffset(struct utmp,ut_line,8,9,34449)
CheckMemberSize(struct utmp,ut_id,4,9,34450)
CheckOffset(struct utmp,ut_id,40,9,34450)
CheckMemberSize(struct utmp,ut_user,32,9,34451)
CheckOffset(struct utmp,ut_user,44,9,34451)
CheckMemberSize(struct utmp,ut_host,256,9,34452)
CheckOffset(struct utmp,ut_host,76,9,34452)
CheckMemberSize(struct utmp,ut_exit,4,9,34455)
CheckOffset(struct utmp,ut_exit,332,9,34455)
CheckMemberSize(struct utmp,ut_session,8,9,34456)
CheckOffset(struct utmp,ut_session,336,9,34456)
CheckMemberSize(struct utmp,ut_tv,16,9,34457)
CheckOffset(struct utmp,ut_tv,344,9,34457)
CheckMemberSize(struct utmp,ut_addr_v6,16,9,34458)
CheckOffset(struct utmp,ut_addr_v6,360,9,34458)
CheckMemberSize(struct utmp,__unused,20,9,34459)
CheckOffset(struct utmp,__unused,376,9,34459)
#elif __s390x__
CheckTypeSize(struct utmp,400, 10281, 12)
CheckMemberSize(struct utmp,ut_pid,4,12,34448)
CheckOffset(struct utmp,ut_pid,4,12,34448)
CheckMemberSize(struct utmp,ut_line,32,12,34449)
CheckOffset(struct utmp,ut_line,8,12,34449)
CheckMemberSize(struct utmp,ut_id,4,12,34450)
CheckOffset(struct utmp,ut_id,40,12,34450)
CheckMemberSize(struct utmp,ut_user,32,12,34451)
CheckOffset(struct utmp,ut_user,44,12,34451)
CheckMemberSize(struct utmp,ut_host,256,12,34452)
CheckOffset(struct utmp,ut_host,76,12,34452)
CheckMemberSize(struct utmp,ut_exit,4,12,34455)
CheckOffset(struct utmp,ut_exit,332,12,34455)
CheckMemberSize(struct utmp,ut_session,8,12,34456)
CheckOffset(struct utmp,ut_session,336,12,34456)
CheckMemberSize(struct utmp,ut_tv,16,12,34457)
CheckOffset(struct utmp,ut_tv,344,12,34457)
CheckMemberSize(struct utmp,ut_addr_v6,16,12,34458)
CheckOffset(struct utmp,ut_addr_v6,360,12,34458)
CheckMemberSize(struct utmp,__unused,20,12,34459)
CheckOffset(struct utmp,__unused,376,12,34459)
#elif __x86_64__
CheckTypeSize(struct utmp,384, 10281, 11)
CheckMemberSize(struct utmp,ut_pid,4,11,34448)
CheckOffset(struct utmp,ut_pid,4,11,34448)
CheckMemberSize(struct utmp,ut_line,32,11,34449)
CheckOffset(struct utmp,ut_line,8,11,34449)
CheckMemberSize(struct utmp,ut_id,4,11,34450)
CheckOffset(struct utmp,ut_id,40,11,34450)
CheckMemberSize(struct utmp,ut_user,32,11,34451)
CheckOffset(struct utmp,ut_user,44,11,34451)
CheckMemberSize(struct utmp,ut_host,256,11,34452)
CheckOffset(struct utmp,ut_host,76,11,34452)
CheckMemberSize(struct utmp,ut_exit,4,11,34455)
CheckOffset(struct utmp,ut_exit,332,11,34455)
CheckMemberSize(struct utmp,ut_session,4,11,34456)
CheckOffset(struct utmp,ut_session,336,11,34456)
CheckMemberSize(struct utmp,ut_tv,8,11,34457)
CheckOffset(struct utmp,ut_tv,340,11,34457)
CheckMemberSize(struct utmp,ut_addr_v6,16,11,34458)
CheckOffset(struct utmp,ut_addr_v6,348,11,34458)
CheckMemberSize(struct utmp,__unused,20,11,34459)
CheckOffset(struct utmp,__unused,364,11,34459)
#else
