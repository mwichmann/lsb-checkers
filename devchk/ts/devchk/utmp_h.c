...
#elif 1
CheckTypeSize(struct exit_status,0, 10282, 1);
Msg("Missing member data for exit_status on All\n");
CheckOffset(struct exit_status,e_termination,0,1,34453);
CheckOffset(struct exit_status,e_exit,0,1,34454);
#endif
