...
CheckMemberSize(struct utmp,ut_session,4,3,40735)
CheckOffset(struct utmp,ut_session,336,3,40735)
CheckMemberSize(struct utmp,ut_tv,8,3,40736)
CheckOffset(struct utmp,ut_tv,340,3,40736)
CheckMemberSize(struct utmp,ut_addr_v6,16,3,40737)
CheckOffset(struct utmp,ut_addr_v6,348,3,40737)
CheckMemberSize(struct utmp,__unused,20,3,40738)
CheckOffset(struct utmp,__unused,364,3,40738)
#endif
...
CheckOffset(struct utmp,ut_host,74,6,40722)
...
CheckMemberSize(struct utmp,ut_session,4,12,40680)
CheckOffset(struct utmp,ut_session,336,12,40680)
CheckMemberSize(struct utmp,ut_tv,8,12,40681)
CheckOffset(struct utmp,ut_tv,340,12,40681)
CheckMemberSize(struct utmp,ut_addr_v6,16,12,40682)
CheckOffset(struct utmp,ut_addr_v6,348,12,40682)
CheckMemberSize(struct utmp,__unused,20,12,40683)
CheckOffset(struct utmp,__unused,364,12,40683)
#endif
