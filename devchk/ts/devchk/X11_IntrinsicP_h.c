...
CheckTypeSize(XrmResource,0, 100559, 11, 1.2, NULL, 100558, NULL)
#elif defined __s390x__
CheckTypeSize(XrmResource,0, 100559, 12, 1.2, NULL, 100558, NULL)
#elif defined __powerpc64__
CheckTypeSize(XrmResource,0, 100559, 9, 1.2, NULL, 100558, NULL)
#else
...
#elif defined __x86_64__
CheckTypeSize(XrmResourceList,0, 100561, 11, 1.2, NULL, 100560, NULL)
#elif defined __s390x__
CheckTypeSize(XrmResourceList,0, 100561, 12, 1.2, NULL, 100560, NULL)
#elif defined __powerpc64__
CheckTypeSize(XrmResourceList,0, 100561, 9, 1.2, NULL, 100560, NULL)
#else
...
#elif defined __x86_64__
CheckTypeSize(struct _XtTMRec,0, 100587, 11, 1.2, NULL, 0, NULL)
...
#elif defined __s390x__
CheckTypeSize(struct _XtTMRec,0, 100587, 12, 1.2, NULL, 0, NULL)
...
#elif defined __powerpc64__
CheckTypeSize(struct _XtTMRec,0, 100587, 9, 1.2, NULL, 0, NULL)
...
#elif defined __x86_64__
CheckTypeSize(XtTM,0, 100589, 11, 1.2, NULL, 100588, NULL)
#elif defined __s390x__
CheckTypeSize(XtTM,0, 100589, 12, 1.2, NULL, 100588, NULL)
#elif defined __powerpc64__
CheckTypeSize(XtTM,0, 100589, 9, 1.2, NULL, 100588, NULL)
#else
...
#elif defined __x86_64__
CheckTypeSize(XtTypedArg,0, 100593, 11, 1.2, NULL, 100592, NULL)
#elif defined __s390x__
CheckTypeSize(XtTypedArg,0, 100593, 12, 1.2, NULL, 100592, NULL)
#elif defined __powerpc64__
CheckTypeSize(XtTypedArg,0, 100593, 9, 1.2, NULL, 100592, NULL)
#else
...
#elif defined __x86_64__
CheckTypeSize(XtTypedArgList,0, 100595, 11, 1.2, NULL, 100594, NULL)
#elif defined __s390x__
CheckTypeSize(XtTypedArgList,0, 100595, 12, 1.2, NULL, 100594, NULL)
#elif defined __powerpc64__
CheckTypeSize(XtTypedArgList,0, 100595, 9, 1.2, NULL, 100594, NULL)
#else
...
#elif defined __x86_64__
CheckTypeSize(XtProc,0, 100618, 11, 1.2, NULL, 20504, NULL)
#elif defined __s390x__
CheckTypeSize(XtProc,0, 100618, 12, 1.2, NULL, 20504, NULL)
#elif defined __powerpc64__
CheckTypeSize(XtProc,0, 100618, 9, 1.2, NULL, 20504, NULL)
#else
...
#elif defined __x86_64__
CheckTypeSize(XtWidgetClassProc,0, 100620, 11, 1.2, NULL, 100619, NULL)
#elif defined __s390x__
CheckTypeSize(XtWidgetClassProc,0, 100620, 12, 1.2, NULL, 100619, NULL)
#elif defined __powerpc64__
CheckTypeSize(XtWidgetClassProc,0, 100620, 9, 1.2, NULL, 100619, NULL)
#else
...
#elif defined __x86_64__
CheckTypeSize(XtInitProc,0, 100622, 11, 1.2, NULL, 100621, NULL)
#elif defined __s390x__
CheckTypeSize(XtInitProc,0, 100622, 12, 1.2, NULL, 100621, NULL)
#elif defined __powerpc64__
CheckTypeSize(XtInitProc,0, 100622, 9, 1.2, NULL, 100621, NULL)
#else
...
#elif defined __x86_64__
CheckTypeSize(XtArgsProc,0, 100624, 11, 1.2, NULL, 100623, NULL)
#elif defined __s390x__
CheckTypeSize(XtArgsProc,0, 100624, 12, 1.2, NULL, 100623, NULL)
#elif defined __powerpc64__
CheckTypeSize(XtArgsProc,0, 100624, 9, 1.2, NULL, 100623, NULL)
#else
...
#elif defined __x86_64__
CheckTypeSize(XtRealizeProc,0, 100627, 11, 1.2, NULL, 100626, NULL)
#elif defined __s390x__
CheckTypeSize(XtRealizeProc,0, 100627, 12, 1.2, NULL, 100626, NULL)
#elif defined __powerpc64__
CheckTypeSize(XtRealizeProc,0, 100627, 9, 1.2, NULL, 100626, NULL)
#else
...
#elif defined __x86_64__
CheckTypeSize(XtWidgetProc,0, 100629, 11, 1.2, NULL, 100628, NULL)
#elif defined __s390x__
CheckTypeSize(XtWidgetProc,0, 100629, 12, 1.2, NULL, 100628, NULL)
#elif defined __powerpc64__
CheckTypeSize(XtWidgetProc,0, 100629, 9, 1.2, NULL, 100628, NULL)
#else
...
#elif defined __x86_64__
CheckTypeSize(XtExposeProc,0, 100631, 11, 1.2, NULL, 100630, NULL)
#elif defined __s390x__
CheckTypeSize(XtExposeProc,0, 100631, 12, 1.2, NULL, 100630, NULL)
#elif defined __powerpc64__
CheckTypeSize(XtExposeProc,0, 100631, 9, 1.2, NULL, 100630, NULL)
#else
...
#elif defined __x86_64__
CheckTypeSize(XtSetValuesFunc,0, 100633, 11, 1.2, NULL, 100632, NULL)
#elif defined __s390x__
CheckTypeSize(XtSetValuesFunc,0, 100633, 12, 1.2, NULL, 100632, NULL)
#elif defined __powerpc64__
CheckTypeSize(XtSetValuesFunc,0, 100633, 9, 1.2, NULL, 100632, NULL)
#else
...
#elif defined __x86_64__
CheckTypeSize(XtArgsFunc,0, 100635, 11, 1.2, NULL, 100634, NULL)
#elif defined __s390x__
CheckTypeSize(XtArgsFunc,0, 100635, 12, 1.2, NULL, 100634, NULL)
#elif defined __powerpc64__
CheckTypeSize(XtArgsFunc,0, 100635, 9, 1.2, NULL, 100634, NULL)
#else
...
#elif defined __x86_64__
CheckTypeSize(XtAlmostProc,0, 100637, 11, 1.2, NULL, 100636, NULL)
#elif defined __s390x__
CheckTypeSize(XtAlmostProc,0, 100637, 12, 1.2, NULL, 100636, NULL)
#elif defined __powerpc64__
CheckTypeSize(XtAlmostProc,0, 100637, 9, 1.2, NULL, 100636, NULL)
#else
...
#elif defined __x86_64__
CheckTypeSize(XtAcceptFocusProc,0, 100639, 11, 1.2, NULL, 100638, NULL)
#elif defined __s390x__
CheckTypeSize(XtAcceptFocusProc,0, 100639, 12, 1.2, NULL, 100638, NULL)
#elif defined __powerpc64__
CheckTypeSize(XtAcceptFocusProc,0, 100639, 9, 1.2, NULL, 100638, NULL)
#else
...
#elif defined __x86_64__
CheckTypeSize(XtVersionType,0, 100640, 11, 1.2, NULL, 11186, NULL)
#elif defined __s390x__
CheckTypeSize(XtVersionType,0, 100640, 12, 1.2, NULL, 11186, NULL)
#elif defined __powerpc64__
CheckTypeSize(XtVersionType,0, 100640, 9, 1.2, NULL, 11186, NULL)
#else
...
#elif defined __x86_64__
CheckTypeSize(XtGeometryHandler,0, 100642, 11, 1.2, NULL, 100641, NULL)
#elif defined __s390x__
CheckTypeSize(XtGeometryHandler,0, 100642, 12, 1.2, NULL, 100641, NULL)
#elif defined __powerpc64__
CheckTypeSize(XtGeometryHandler,0, 100642, 9, 1.2, NULL, 100641, NULL)
#else
...
#elif defined __x86_64__
CheckTypeSize(XtStringProc,0, 100644, 11, 1.2, NULL, 100643, NULL)
#elif defined __s390x__
CheckTypeSize(XtStringProc,0, 100644, 12, 1.2, NULL, 100643, NULL)
#elif defined __powerpc64__
CheckTypeSize(XtStringProc,0, 100644, 9, 1.2, NULL, 100643, NULL)
#else
