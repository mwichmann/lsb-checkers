...
#if defined __i386__
CheckTypeSize(timer_t,4, 10208, 2, 1.2, NULL, 6, NULL)
#elif defined __ia64__
CheckTypeSize(timer_t,4, 10208, 3, 1.3, NULL, 6, NULL)
#elif defined __powerpc__ && !defined __powerpc64__
CheckTypeSize(timer_t,4, 10208, 6, 1.2, NULL, 6, NULL)
#elif defined __s390__ && !defined __s390x__
CheckTypeSize(timer_t,4, 10208, 10, 1.3, NULL, 6, NULL)
#elif defined __powerpc64__
CheckTypeSize(timer_t,4, 10208, 9, 2.0, NULL, 6, NULL)
#elif defined __s390x__
CheckTypeSize(timer_t,4, 10208, 12, 1.3, NULL, 6, NULL)
#elif defined __x86_64__
CheckTypeSize(timer_t,4, 10208, 11, 2.0, NULL, 6, NULL)
#else
