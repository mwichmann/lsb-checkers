...
#elif 1
CheckTypeSize(const uLongf,0, 10517, 1);
#endif
...
#elif 1
CheckTypeSize(z_off_t,0, 10519, 1);
#endif
...
#elif 1
CheckTypeSize(voidpc,0, 10995, 1);
#endif
...
#elif 1
CheckTypeSize(struct z_stream_s,0, 9875, 1);
Msg("Missing member data for z_stream_s on All\n");
CheckOffset(struct z_stream_s,next_in,0,1,34067);
CheckOffset(struct z_stream_s,avail_in,0,1,34068);
CheckOffset(struct z_stream_s,total_in,0,1,34069);
CheckOffset(struct z_stream_s,next_out,0,1,34070);
CheckOffset(struct z_stream_s,avail_out,0,1,34071);
CheckOffset(struct z_stream_s,total_out,0,1,34072);
CheckOffset(struct z_stream_s,msg,0,1,34073);
CheckOffset(struct z_stream_s,state,0,1,34074);
CheckOffset(struct z_stream_s,zalloc,0,1,34075);
CheckOffset(struct z_stream_s,zfree,0,1,34076);
CheckOffset(struct z_stream_s,opaque,0,1,34077);
CheckOffset(struct z_stream_s,data_type,0,1,34078);
CheckOffset(struct z_stream_s,adler,0,1,34079);
CheckOffset(struct z_stream_s,reserved,0,1,34080);
#endif
...
#elif 1
CheckTypeSize(z_stream,0, 9880, 1);
#endif
...
#elif 1
CheckTypeSize(z_streamp,0, 9882, 1);
#endif
...
#elif 1
CheckTypeSize(alloc_func,0, 9871, 1);
#endif
...
#elif 1
CheckTypeSize(free_func,0, 9873, 1);
#endif
...
#elif 1
CheckTypeSize(struct internal_state,0, 9874, 1);
Msg("Missing member data for internal_state on All\n");
CheckOffset(struct internal_state,dummy,0,1,34081);
#endif
...
#elif 1
CheckTypeSize(const Bytef,0, 10511, 1);
#endif
