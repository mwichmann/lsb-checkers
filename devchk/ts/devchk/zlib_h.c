...
CheckMemberSize(struct z_stream_s,avail_in,0,9,34068)
CheckOffset(struct z_stream_s,avail_in,8,9,34068)
CheckMemberSize(struct z_stream_s,total_in,0,9,34069)
CheckOffset(struct z_stream_s,total_in,16,9,34069)
CheckMemberSize(struct z_stream_s,next_out,0,9,34070)
CheckOffset(struct z_stream_s,next_out,24,9,34070)
CheckMemberSize(struct z_stream_s,avail_out,0,9,34071)
CheckOffset(struct z_stream_s,avail_out,32,9,34071)
CheckMemberSize(struct z_stream_s,total_out,0,9,34072)
CheckOffset(struct z_stream_s,total_out,40,9,34072)
CheckMemberSize(struct z_stream_s,msg,0,9,34073)
CheckOffset(struct z_stream_s,msg,48,9,34073)
CheckMemberSize(struct z_stream_s,state,0,9,34074)
CheckOffset(struct z_stream_s,state,56,9,34074)
CheckMemberSize(struct z_stream_s,zalloc,0,9,34075)
CheckOffset(struct z_stream_s,zalloc,64,9,34075)
CheckMemberSize(struct z_stream_s,zfree,0,9,34076)
CheckOffset(struct z_stream_s,zfree,72,9,34076)
CheckMemberSize(struct z_stream_s,opaque,0,9,34077)
CheckOffset(struct z_stream_s,opaque,80,9,34077)
CheckMemberSize(struct z_stream_s,data_type,0,9,34078)
CheckOffset(struct z_stream_s,data_type,88,9,34078)
CheckMemberSize(struct z_stream_s,adler,0,9,34079)
CheckOffset(struct z_stream_s,adler,96,9,34079)
CheckMemberSize(struct z_stream_s,reserved,0,9,34080)
