...
CheckMemberSize(struct pdat,_pad_x,0,6,29726)
CheckOffset(struct pdat,_pad_x,2,6,29726)
CheckMemberSize(struct pdat,_pad_top,0,6,29727)
CheckOffset(struct pdat,_pad_top,4,6,29727)
CheckMemberSize(struct pdat,_pad_left,0,6,29728)
CheckOffset(struct pdat,_pad_left,6,6,29728)
CheckMemberSize(struct pdat,_pad_bottom,0,6,29729)
CheckOffset(struct pdat,_pad_bottom,8,6,29729)
CheckMemberSize(struct pdat,_pad_right,0,6,29730)
CheckOffset(struct pdat,_pad_right,10,6,29730)
#elif __ia64__
CheckTypeSize(struct pdat,12, 8663, 3)
CheckMemberSize(struct pdat,_pad_y,0,3,29725)
CheckOffset(struct pdat,_pad_y,0,3,29725)
CheckMemberSize(struct pdat,_pad_x,0,3,29726)
CheckOffset(struct pdat,_pad_x,2,3,29726)
CheckMemberSize(struct pdat,_pad_top,0,3,29727)
CheckOffset(struct pdat,_pad_top,4,3,29727)
CheckMemberSize(struct pdat,_pad_left,0,3,29728)
CheckOffset(struct pdat,_pad_left,6,3,29728)
CheckMemberSize(struct pdat,_pad_bottom,0,3,29729)
CheckOffset(struct pdat,_pad_bottom,8,3,29729)
CheckMemberSize(struct pdat,_pad_right,0,3,29730)
...
CheckMemberSize(struct pdat,_pad_top,0,10,29727)
CheckOffset(struct pdat,_pad_top,4,10,29727)
CheckMemberSize(struct pdat,_pad_left,0,10,29728)
CheckOffset(struct pdat,_pad_left,6,10,29728)
CheckMemberSize(struct pdat,_pad_bottom,0,10,29729)
CheckOffset(struct pdat,_pad_bottom,8,10,29729)
CheckMemberSize(struct pdat,_pad_right,0,10,29730)
CheckOffset(struct pdat,_pad_right,10,10,29730)
#elif __powerpc64__
CheckTypeSize(struct pdat,12, 8663, 9)
CheckMemberSize(struct pdat,_pad_x,0,9,29726)
CheckOffset(struct pdat,_pad_x,2,9,29726)
CheckMemberSize(struct pdat,_pad_top,0,9,29727)
CheckOffset(struct pdat,_pad_top,4,9,29727)
CheckMemberSize(struct pdat,_pad_left,0,9,29728)
CheckOffset(struct pdat,_pad_left,6,9,29728)
CheckMemberSize(struct pdat,_pad_bottom,0,9,29729)
CheckOffset(struct pdat,_pad_bottom,8,9,29729)
CheckMemberSize(struct pdat,_pad_right,0,9,29730)
...
CheckMemberSize(struct _win_st,_cury,0,3,29700)
CheckOffset(struct _win_st,_cury,0,3,29700)
CheckMemberSize(struct _win_st,_curx,0,3,29701)
CheckOffset(struct _win_st,_curx,2,3,29701)
CheckMemberSize(struct _win_st,_maxy,0,3,29702)
CheckOffset(struct _win_st,_maxy,4,3,29702)
CheckMemberSize(struct _win_st,_maxx,0,3,29703)
CheckOffset(struct _win_st,_maxx,6,3,29703)
CheckMemberSize(struct _win_st,_begy,0,3,29704)
CheckOffset(struct _win_st,_begy,8,3,29704)
CheckMemberSize(struct _win_st,_begx,0,3,29705)
CheckOffset(struct _win_st,_begx,10,3,29705)
CheckMemberSize(struct _win_st,_flags,0,3,29706)
CheckOffset(struct _win_st,_flags,12,3,29706)
CheckMemberSize(struct _win_st,_attrs,0,3,29707)
CheckOffset(struct _win_st,_attrs,16,3,29707)
CheckMemberSize(struct _win_st,_bkgd,0,3,29708)
CheckOffset(struct _win_st,_bkgd,24,3,29708)
CheckMemberSize(struct _win_st,_notimeout,0,3,29709)
CheckOffset(struct _win_st,_notimeout,32,3,29709)
CheckMemberSize(struct _win_st,_clear,0,3,29710)
CheckOffset(struct _win_st,_clear,36,3,29710)
CheckMemberSize(struct _win_st,_leaveok,0,3,29711)
CheckOffset(struct _win_st,_leaveok,40,3,29711)
CheckMemberSize(struct _win_st,_scroll,0,3,29712)
CheckOffset(struct _win_st,_scroll,44,3,29712)
CheckMemberSize(struct _win_st,_idlok,0,3,29713)
CheckOffset(struct _win_st,_idlok,48,3,29713)
CheckMemberSize(struct _win_st,_idcok,0,3,29714)
CheckOffset(struct _win_st,_idcok,52,3,29714)
CheckMemberSize(struct _win_st,_immed,0,3,29715)
CheckOffset(struct _win_st,_immed,56,3,29715)
CheckMemberSize(struct _win_st,_sync,0,3,29716)
CheckOffset(struct _win_st,_sync,60,3,29716)
CheckMemberSize(struct _win_st,_use_keypad,0,3,29717)
CheckOffset(struct _win_st,_use_keypad,64,3,29717)
CheckMemberSize(struct _win_st,_delay,0,3,29718)
CheckOffset(struct _win_st,_delay,68,3,29718)
CheckMemberSize(struct _win_st,_line,0,3,29719)
CheckOffset(struct _win_st,_line,72,3,29719)
CheckMemberSize(struct _win_st,_regtop,0,3,29720)
CheckOffset(struct _win_st,_regtop,80,3,29720)
CheckMemberSize(struct _win_st,_regbottom,0,3,29721)
CheckOffset(struct _win_st,_regbottom,82,3,29721)
CheckMemberSize(struct _win_st,_parx,0,3,29722)
CheckOffset(struct _win_st,_parx,84,3,29722)
CheckMemberSize(struct _win_st,_pary,0,3,29723)
CheckOffset(struct _win_st,_pary,88,3,29723)
CheckMemberSize(struct _win_st,_parent,0,3,29724)
CheckOffset(struct _win_st,_parent,96,3,29724)
CheckMemberSize(struct _win_st,_pad,0,3,29731)
CheckOffset(struct _win_st,_pad,104,3,29731)
CheckMemberSize(struct _win_st,_yoffset,0,3,29732)
CheckOffset(struct _win_st,_yoffset,116,3,29732)
CheckMemberSize(struct _win_st,_bkgrnd,0,3,34437)
CheckOffset(struct _win_st,_bkgrnd,120,3,34437)
#elif __powerpc__ && !__powerpc64__
CheckTypeSize(struct _win_st,124, 8654, 6)
CheckMemberSize(struct _win_st,_curx,0,6,29701)
CheckOffset(struct _win_st,_curx,2,6,29701)
CheckMemberSize(struct _win_st,_maxy,0,6,29702)
CheckOffset(struct _win_st,_maxy,4,6,29702)
CheckMemberSize(struct _win_st,_maxx,0,6,29703)
CheckOffset(struct _win_st,_maxx,6,6,29703)
CheckMemberSize(struct _win_st,_begy,0,6,29704)
CheckOffset(struct _win_st,_begy,8,6,29704)
CheckMemberSize(struct _win_st,_begx,0,6,29705)
CheckOffset(struct _win_st,_begx,10,6,29705)
CheckMemberSize(struct _win_st,_flags,0,6,29706)
CheckOffset(struct _win_st,_flags,12,6,29706)
CheckMemberSize(struct _win_st,_attrs,0,6,29707)
CheckOffset(struct _win_st,_attrs,16,6,29707)
CheckMemberSize(struct _win_st,_bkgd,0,6,29708)
CheckOffset(struct _win_st,_bkgd,20,6,29708)
CheckMemberSize(struct _win_st,_notimeout,0,6,29709)
CheckOffset(struct _win_st,_notimeout,24,6,29709)
CheckMemberSize(struct _win_st,_clear,0,6,29710)
CheckOffset(struct _win_st,_clear,28,6,29710)
CheckMemberSize(struct _win_st,_leaveok,0,6,29711)
CheckOffset(struct _win_st,_leaveok,32,6,29711)
CheckMemberSize(struct _win_st,_scroll,0,6,29712)
CheckOffset(struct _win_st,_scroll,36,6,29712)
CheckMemberSize(struct _win_st,_idlok,0,6,29713)
CheckOffset(struct _win_st,_idlok,40,6,29713)
CheckMemberSize(struct _win_st,_idcok,0,6,29714)
CheckOffset(struct _win_st,_idcok,44,6,29714)
CheckMemberSize(struct _win_st,_immed,0,6,29715)
CheckOffset(struct _win_st,_immed,48,6,29715)
CheckMemberSize(struct _win_st,_sync,0,6,29716)
CheckOffset(struct _win_st,_sync,52,6,29716)
CheckMemberSize(struct _win_st,_use_keypad,0,6,29717)
CheckOffset(struct _win_st,_use_keypad,56,6,29717)
CheckMemberSize(struct _win_st,_delay,0,6,29718)
CheckOffset(struct _win_st,_delay,60,6,29718)
CheckMemberSize(struct _win_st,_line,0,6,29719)
CheckOffset(struct _win_st,_line,64,6,29719)
CheckMemberSize(struct _win_st,_regtop,0,6,29720)
CheckOffset(struct _win_st,_regtop,68,6,29720)
CheckMemberSize(struct _win_st,_regbottom,0,6,29721)
CheckOffset(struct _win_st,_regbottom,70,6,29721)
CheckMemberSize(struct _win_st,_parx,0,6,29722)
CheckOffset(struct _win_st,_parx,72,6,29722)
CheckMemberSize(struct _win_st,_pary,0,6,29723)
CheckOffset(struct _win_st,_pary,76,6,29723)
CheckMemberSize(struct _win_st,_parent,0,6,29724)
CheckOffset(struct _win_st,_parent,80,6,29724)
CheckMemberSize(struct _win_st,_pad,0,6,29731)
CheckOffset(struct _win_st,_pad,84,6,29731)
CheckMemberSize(struct _win_st,_yoffset,0,6,29732)
CheckOffset(struct _win_st,_yoffset,96,6,29732)
CheckMemberSize(struct _win_st,_bkgrnd,0,6,34437)
...
CheckMemberSize(struct _win_st,_maxy,0,10,29702)
CheckOffset(struct _win_st,_maxy,4,10,29702)
CheckMemberSize(struct _win_st,_maxx,0,10,29703)
CheckOffset(struct _win_st,_maxx,6,10,29703)
CheckMemberSize(struct _win_st,_begy,0,10,29704)
CheckOffset(struct _win_st,_begy,8,10,29704)
CheckMemberSize(struct _win_st,_begx,0,10,29705)
CheckOffset(struct _win_st,_begx,10,10,29705)
CheckMemberSize(struct _win_st,_flags,0,10,29706)
CheckOffset(struct _win_st,_flags,12,10,29706)
CheckMemberSize(struct _win_st,_attrs,0,10,29707)
CheckOffset(struct _win_st,_attrs,16,10,29707)
CheckMemberSize(struct _win_st,_bkgd,0,10,29708)
CheckOffset(struct _win_st,_bkgd,20,10,29708)
CheckMemberSize(struct _win_st,_notimeout,0,10,29709)
CheckOffset(struct _win_st,_notimeout,24,10,29709)
CheckMemberSize(struct _win_st,_clear,0,10,29710)
CheckOffset(struct _win_st,_clear,28,10,29710)
CheckMemberSize(struct _win_st,_leaveok,0,10,29711)
CheckOffset(struct _win_st,_leaveok,32,10,29711)
CheckMemberSize(struct _win_st,_scroll,0,10,29712)
CheckOffset(struct _win_st,_scroll,36,10,29712)
CheckMemberSize(struct _win_st,_idlok,0,10,29713)
CheckOffset(struct _win_st,_idlok,40,10,29713)
CheckMemberSize(struct _win_st,_idcok,0,10,29714)
CheckOffset(struct _win_st,_idcok,44,10,29714)
CheckMemberSize(struct _win_st,_immed,0,10,29715)
CheckOffset(struct _win_st,_immed,48,10,29715)
CheckMemberSize(struct _win_st,_sync,0,10,29716)
CheckOffset(struct _win_st,_sync,52,10,29716)
CheckMemberSize(struct _win_st,_use_keypad,0,10,29717)
CheckOffset(struct _win_st,_use_keypad,56,10,29717)
CheckMemberSize(struct _win_st,_delay,0,10,29718)
CheckOffset(struct _win_st,_delay,60,10,29718)
CheckMemberSize(struct _win_st,_line,0,10,29719)
CheckOffset(struct _win_st,_line,64,10,29719)
CheckMemberSize(struct _win_st,_regtop,0,10,29720)
CheckOffset(struct _win_st,_regtop,68,10,29720)
CheckMemberSize(struct _win_st,_regbottom,0,10,29721)
CheckOffset(struct _win_st,_regbottom,70,10,29721)
CheckMemberSize(struct _win_st,_parx,0,10,29722)
CheckOffset(struct _win_st,_parx,72,10,29722)
CheckMemberSize(struct _win_st,_pary,0,10,29723)
CheckOffset(struct _win_st,_pary,76,10,29723)
CheckMemberSize(struct _win_st,_parent,0,10,29724)
CheckOffset(struct _win_st,_parent,80,10,29724)
CheckMemberSize(struct _win_st,_pad,0,10,29731)
CheckOffset(struct _win_st,_pad,84,10,29731)
CheckMemberSize(struct _win_st,_yoffset,0,10,29732)
CheckOffset(struct _win_st,_yoffset,96,10,29732)
CheckMemberSize(struct _win_st,_bkgrnd,0,10,34437)
CheckOffset(struct _win_st,_bkgrnd,100,10,34437)
#elif __powerpc64__
CheckTypeSize(struct _win_st,128, 8654, 9)
CheckMemberSize(struct _win_st,_curx,0,9,29701)
CheckOffset(struct _win_st,_curx,2,9,29701)
CheckMemberSize(struct _win_st,_maxy,0,9,29702)
CheckOffset(struct _win_st,_maxy,4,9,29702)
CheckMemberSize(struct _win_st,_maxx,0,9,29703)
CheckOffset(struct _win_st,_maxx,6,9,29703)
CheckMemberSize(struct _win_st,_begy,0,9,29704)
CheckOffset(struct _win_st,_begy,8,9,29704)
CheckMemberSize(struct _win_st,_begx,0,9,29705)
CheckOffset(struct _win_st,_begx,10,9,29705)
CheckMemberSize(struct _win_st,_flags,0,9,29706)
CheckOffset(struct _win_st,_flags,12,9,29706)
CheckMemberSize(struct _win_st,_attrs,0,9,29707)
CheckOffset(struct _win_st,_attrs,16,9,29707)
CheckMemberSize(struct _win_st,_bkgd,0,9,29708)
CheckOffset(struct _win_st,_bkgd,24,9,29708)
CheckMemberSize(struct _win_st,_notimeout,0,9,29709)
CheckOffset(struct _win_st,_notimeout,32,9,29709)
CheckMemberSize(struct _win_st,_clear,0,9,29710)
CheckOffset(struct _win_st,_clear,33,9,29710)
CheckMemberSize(struct _win_st,_leaveok,0,9,29711)
CheckOffset(struct _win_st,_leaveok,34,9,29711)
CheckMemberSize(struct _win_st,_scroll,0,9,29712)
CheckOffset(struct _win_st,_scroll,35,9,29712)
CheckMemberSize(struct _win_st,_idlok,0,9,29713)
CheckOffset(struct _win_st,_idlok,36,9,29713)
CheckMemberSize(struct _win_st,_idcok,0,9,29714)
CheckOffset(struct _win_st,_idcok,37,9,29714)
CheckMemberSize(struct _win_st,_immed,0,9,29715)
CheckOffset(struct _win_st,_immed,38,9,29715)
CheckMemberSize(struct _win_st,_sync,0,9,29716)
CheckOffset(struct _win_st,_sync,39,9,29716)
CheckMemberSize(struct _win_st,_use_keypad,0,9,29717)
CheckOffset(struct _win_st,_use_keypad,40,9,29717)
CheckMemberSize(struct _win_st,_delay,0,9,29718)
CheckOffset(struct _win_st,_delay,44,9,29718)
CheckMemberSize(struct _win_st,_line,0,9,29719)
CheckOffset(struct _win_st,_line,48,9,29719)
CheckMemberSize(struct _win_st,_regtop,0,9,29720)
CheckOffset(struct _win_st,_regtop,56,9,29720)
CheckMemberSize(struct _win_st,_regbottom,0,9,29721)
CheckOffset(struct _win_st,_regbottom,58,9,29721)
CheckMemberSize(struct _win_st,_parx,0,9,29722)
CheckOffset(struct _win_st,_parx,60,9,29722)
CheckMemberSize(struct _win_st,_pary,0,9,29723)
CheckOffset(struct _win_st,_pary,64,9,29723)
CheckMemberSize(struct _win_st,_parent,0,9,29724)
CheckOffset(struct _win_st,_parent,72,9,29724)
CheckMemberSize(struct _win_st,_pad,0,9,29731)
CheckOffset(struct _win_st,_pad,80,9,29731)
CheckMemberSize(struct _win_st,_yoffset,0,9,29732)
CheckOffset(struct _win_st,_yoffset,92,9,29732)
CheckMemberSize(struct _win_st,_bkgrnd,0,9,34437)
