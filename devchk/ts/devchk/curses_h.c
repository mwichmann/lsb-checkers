...
extern int mvprintw_db(int, int, const char *, ...);
...
extern int mvwprintw_db(WINDOW *, int, int, const char *, ...);
...
extern int printw_db(const char *, ...);
...
extern int vwprintw_db(WINDOW *, const char *, va_list);
...
extern int wprintw_db(WINDOW *, const char *, ...);
