...
CheckOffset(struct pdat,_pad_x,0,6,29726)
CheckOffset(struct pdat,_pad_top,0,6,29727)
CheckOffset(struct pdat,_pad_left,0,6,29728)
CheckOffset(struct pdat,_pad_bottom,0,6,29729)
CheckOffset(struct pdat,_pad_right,0,6,29730)
#elif __ia64__
...
Msg("Missing member data for pdat on S390\n");
CheckOffset(struct pdat,_pad_y,0,10,29725)
CheckOffset(struct pdat,_pad_x,0,10,29726)
CheckOffset(struct pdat,_pad_top,0,10,29727)
CheckOffset(struct pdat,_pad_left,0,10,29728)
CheckOffset(struct pdat,_pad_bottom,0,10,29729)
CheckOffset(struct pdat,_pad_right,0,10,29730)
#else
Msg("REPLACE INTO ArchType VALUES (%d,%d,%d);\n",architecture,8663,0);
...
CheckOffset(struct _win_st,_curx,0,6,29701)
CheckOffset(struct _win_st,_maxy,0,6,29702)
CheckOffset(struct _win_st,_maxx,0,6,29703)
CheckOffset(struct _win_st,_begy,0,6,29704)
CheckOffset(struct _win_st,_begx,0,6,29705)
CheckOffset(struct _win_st,_flags,0,6,29706)
CheckOffset(struct _win_st,_attrs,0,6,29707)
CheckOffset(struct _win_st,_bkgd,0,6,29708)
CheckOffset(struct _win_st,_notimeout,0,6,29709)
CheckOffset(struct _win_st,_clear,0,6,29710)
CheckOffset(struct _win_st,_leaveok,0,6,29711)
CheckOffset(struct _win_st,_scroll,0,6,29712)
CheckOffset(struct _win_st,_idlok,0,6,29713)
CheckOffset(struct _win_st,_idcok,0,6,29714)
CheckOffset(struct _win_st,_immed,0,6,29715)
CheckOffset(struct _win_st,_sync,0,6,29716)
CheckOffset(struct _win_st,_use_keypad,0,6,29717)
CheckOffset(struct _win_st,_delay,0,6,29718)
CheckOffset(struct _win_st,_line,0,6,29719)
CheckOffset(struct _win_st,_regtop,0,6,29720)
CheckOffset(struct _win_st,_regbottom,0,6,29721)
CheckOffset(struct _win_st,_parx,0,6,29722)
CheckOffset(struct _win_st,_pary,0,6,29723)
CheckOffset(struct _win_st,_parent,0,6,29724)
CheckOffset(struct _win_st,_pad,0,6,29731)
CheckOffset(struct _win_st,_yoffset,0,6,29732)
CheckOffset(struct _win_st,_bkgrnd,0,6,34437)
#elif __s390__
CheckTypeSize(struct _win_st,124, 8654, 10)
Msg("Missing member data for _win_st on S390\n");
CheckOffset(struct _win_st,_cury,0,10,29700)
CheckOffset(struct _win_st,_curx,0,10,29701)
CheckOffset(struct _win_st,_maxy,0,10,29702)
CheckOffset(struct _win_st,_maxx,0,10,29703)
CheckOffset(struct _win_st,_begy,0,10,29704)
CheckOffset(struct _win_st,_begx,0,10,29705)
CheckOffset(struct _win_st,_flags,0,10,29706)
CheckOffset(struct _win_st,_attrs,0,10,29707)
CheckOffset(struct _win_st,_bkgd,0,10,29708)
CheckOffset(struct _win_st,_notimeout,0,10,29709)
CheckOffset(struct _win_st,_clear,0,10,29710)
CheckOffset(struct _win_st,_leaveok,0,10,29711)
CheckOffset(struct _win_st,_scroll,0,10,29712)
CheckOffset(struct _win_st,_idlok,0,10,29713)
CheckOffset(struct _win_st,_idcok,0,10,29714)
CheckOffset(struct _win_st,_immed,0,10,29715)
CheckOffset(struct _win_st,_sync,0,10,29716)
CheckOffset(struct _win_st,_use_keypad,0,10,29717)
CheckOffset(struct _win_st,_delay,0,10,29718)
CheckOffset(struct _win_st,_line,0,10,29719)
CheckOffset(struct _win_st,_regtop,0,10,29720)
CheckOffset(struct _win_st,_regbottom,0,10,29721)
CheckOffset(struct _win_st,_parx,0,10,29722)
CheckOffset(struct _win_st,_pary,0,10,29723)
CheckOffset(struct _win_st,_parent,0,10,29724)
CheckOffset(struct _win_st,_pad,0,10,29731)
CheckOffset(struct _win_st,_yoffset,0,10,29732)
CheckOffset(struct _win_st,_bkgrnd,0,10,34437)
#else
Msg("REPLACE INTO ArchType VALUES (%d,%d,%d);\n",architecture,8654,0);
