...
Msg("Missing member data for linger on IA64\n");
CheckOffset(struct linger,l_onoff,0,3,33674)
CheckOffset(struct linger,l_linger,0,3,33675)
#elif __powerpc__
...
Msg("Missing member data for linger on S390\n");
CheckOffset(struct linger,l_onoff,0,10,33674)
CheckOffset(struct linger,l_linger,0,10,33675)
#else
...
Msg("Missing member data for cmsghdr on IA64\n");
CheckOffset(struct cmsghdr,cmsg_len,0,3,33685)
CheckOffset(struct cmsghdr,cmsg_level,0,3,33686)
CheckOffset(struct cmsghdr,cmsg_type,0,3,33687)
#elif __powerpc__
...
Msg("Missing member data for cmsghdr on S390\n");
CheckOffset(struct cmsghdr,cmsg_len,0,10,33685)
CheckOffset(struct cmsghdr,cmsg_level,0,10,33686)
CheckOffset(struct cmsghdr,cmsg_type,0,10,33687)
#else
Msg("REPLACE INTO ArchType VALUES (%d,%d,%d);\n",architecture,6909,0);
...
Msg("Missing member data for iovec on IA64\n");
CheckOffset(struct iovec,iov_base,0,3,33676)
CheckOffset(struct iovec,iov_len,0,3,33677)
#elif __powerpc__
...
Msg("Missing member data for iovec on S390\n");
CheckOffset(struct iovec,iov_base,0,10,33676)
CheckOffset(struct iovec,iov_len,0,10,33677)
#else
Msg("REPLACE INTO ArchType VALUES (%d,%d,%d);\n",architecture,9022,0);
...
Msg("Missing member data for sockaddr on IA64\n");
CheckOffset(struct sockaddr,sa_family,0,3,33672)
CheckOffset(struct sockaddr,sa_data,0,3,33673)
#elif __powerpc__
...
Msg("Missing member data for sockaddr on S390\n");
CheckOffset(struct sockaddr,sa_family,0,10,33672)
CheckOffset(struct sockaddr,sa_data,0,10,33673)
#else
Msg("REPLACE INTO ArchType VALUES (%d,%d,%d);\n",architecture,6906,0);
...
Msg("Missing member data for msghdr on IA64\n");
CheckOffset(struct msghdr,msg_name,0,3,33678)
CheckOffset(struct msghdr,msg_namelen,0,3,33679)
CheckOffset(struct msghdr,msg_iov,0,3,33680)
CheckOffset(struct msghdr,msg_iovlen,0,3,33681)
CheckOffset(struct msghdr,msg_control,0,3,33682)
CheckOffset(struct msghdr,msg_controllen,0,3,33683)
CheckOffset(struct msghdr,msg_flags,0,3,33684)
#elif __powerpc__
...
Msg("Missing member data for msghdr on S390\n");
CheckOffset(struct msghdr,msg_name,0,10,33678)
CheckOffset(struct msghdr,msg_namelen,0,10,33679)
CheckOffset(struct msghdr,msg_iov,0,10,33680)
CheckOffset(struct msghdr,msg_iovlen,0,10,33681)
CheckOffset(struct msghdr,msg_control,0,10,33682)
CheckOffset(struct msghdr,msg_controllen,0,10,33683)
CheckOffset(struct msghdr,msg_flags,0,10,33684)
#else
Msg("REPLACE INTO ArchType VALUES (%d,%d,%d);\n",architecture,6908,0);
