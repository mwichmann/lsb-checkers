...
#if __x86_64__
CheckTypeSize(struct statvfs64,100, 10806, 11)
...
CheckOffset(struct statvfs64,f_frsize,0,11,40491)
CheckMemberSize(struct statvfs64,f_blocks,8,11,40492)
CheckOffset(struct statvfs64,f_blocks,0,11,40492)
CheckMemberSize(struct statvfs64,f_bfree,8,11,40493)
CheckOffset(struct statvfs64,f_bfree,0,11,40493)
CheckMemberSize(struct statvfs64,f_bavail,8,11,40494)
CheckOffset(struct statvfs64,f_bavail,0,11,40494)
CheckMemberSize(struct statvfs64,f_files,8,11,40495)
CheckOffset(struct statvfs64,f_files,0,11,40495)
CheckMemberSize(struct statvfs64,f_ffree,8,11,40496)
CheckOffset(struct statvfs64,f_ffree,0,11,40496)
CheckMemberSize(struct statvfs64,f_favail,8,11,40497)
CheckOffset(struct statvfs64,f_favail,0,11,40497)
CheckMemberSize(struct statvfs64,f_fsid,8,11,40498)
CheckOffset(struct statvfs64,f_fsid,0,11,40498)
CheckMemberSize(struct statvfs64,f_flag,8,11,40499)
CheckOffset(struct statvfs64,f_flag,0,11,40499)
CheckMemberSize(struct statvfs64,f_namemax,8,11,40500)
CheckOffset(struct statvfs64,f_namemax,0,11,40500)
CheckMemberSize(struct statvfs64,__f_spare,24,11,40501)
CheckOffset(struct statvfs64,__f_spare,0,11,40501)
#endif

#if __x86_64__
CheckTypeSize(struct statvfs,100, 10807, 11)
...
CheckOffset(struct statvfs,f_frsize,0,11,40503)
CheckMemberSize(struct statvfs,f_blocks,8,11,40504)
CheckOffset(struct statvfs,f_blocks,0,11,40504)
CheckMemberSize(struct statvfs,f_bfree,8,11,40505)
CheckOffset(struct statvfs,f_bfree,0,11,40505)
CheckMemberSize(struct statvfs,f_bavail,8,11,40506)
CheckOffset(struct statvfs,f_bavail,0,11,40506)
CheckMemberSize(struct statvfs,f_files,8,11,40507)
CheckOffset(struct statvfs,f_files,0,11,40507)
CheckMemberSize(struct statvfs,f_ffree,8,11,40508)
CheckOffset(struct statvfs,f_ffree,0,11,40508)
CheckMemberSize(struct statvfs,f_favail,8,11,40509)
CheckOffset(struct statvfs,f_favail,0,11,40509)
CheckMemberSize(struct statvfs,f_fsid,8,11,40510)
CheckOffset(struct statvfs,f_fsid,0,11,40510)
CheckMemberSize(struct statvfs,f_flag,8,11,40511)
CheckOffset(struct statvfs,f_flag,0,11,40511)
CheckMemberSize(struct statvfs,f_namemax,8,11,40512)
CheckOffset(struct statvfs,f_namemax,0,11,40512)
CheckMemberSize(struct statvfs,__f_spare,24,11,40513)
CheckOffset(struct statvfs,__f_spare,0,11,40513)
#endif
