...
#if __s390x__
CheckTypeSize(struct statvfs,44, 10552, 12)
...
CheckMemberSize(struct statvfs,f_blocks,0,12,40264)
CheckOffset(struct statvfs,f_blocks,16,12,40264)
CheckMemberSize(struct statvfs,f_bfree,0,12,40265)
CheckOffset(struct statvfs,f_bfree,16,12,40265)
CheckMemberSize(struct statvfs,f_bavail,0,12,40266)
CheckOffset(struct statvfs,f_bavail,16,12,40266)
CheckMemberSize(struct statvfs,f_files,0,12,40267)
CheckOffset(struct statvfs,f_files,16,12,40267)
CheckMemberSize(struct statvfs,f_ffree,0,12,40268)
CheckOffset(struct statvfs,f_ffree,16,12,40268)
CheckMemberSize(struct statvfs,f_favail,0,12,40269)
CheckOffset(struct statvfs,f_favail,16,12,40269)
CheckMemberSize(struct statvfs,f_fsid,8,12,40270)
CheckOffset(struct statvfs,f_fsid,16,12,40270)
CheckMemberSize(struct statvfs,__f_unused,4,12,40271)
CheckOffset(struct statvfs,__f_unused,24,12,40271)
CheckMemberSize(struct statvfs,f_flag,8,12,40272)
CheckOffset(struct statvfs,f_flag,28,12,40272)
CheckMemberSize(struct statvfs,f_namemax,8,12,40273)
CheckOffset(struct statvfs,f_namemax,36,12,40273)
#endif

#if __s390x__
CheckTypeSize(struct statvfs64,44, 10553, 12)
...
CheckMemberSize(struct statvfs64,f_blocks,0,12,40276)
CheckOffset(struct statvfs64,f_blocks,16,12,40276)
CheckMemberSize(struct statvfs64,f_bfree,0,12,40277)
CheckOffset(struct statvfs64,f_bfree,16,12,40277)
CheckMemberSize(struct statvfs64,f_bavail,0,12,40278)
CheckOffset(struct statvfs64,f_bavail,16,12,40278)
CheckMemberSize(struct statvfs64,f_files,0,12,40279)
CheckOffset(struct statvfs64,f_files,16,12,40279)
CheckMemberSize(struct statvfs64,f_ffree,0,12,40280)
CheckOffset(struct statvfs64,f_ffree,16,12,40280)
CheckMemberSize(struct statvfs64,f_favail,0,12,40281)
CheckOffset(struct statvfs64,f_favail,16,12,40281)
CheckMemberSize(struct statvfs64,f_fsid,8,12,40282)
CheckOffset(struct statvfs64,f_fsid,16,12,40282)
CheckMemberSize(struct statvfs64,__f_unused,4,12,40283)
CheckOffset(struct statvfs64,__f_unused,24,12,40283)
CheckMemberSize(struct statvfs64,f_flag,8,12,40284)
CheckOffset(struct statvfs64,f_flag,28,12,40284)
CheckMemberSize(struct statvfs64,f_namemax,8,12,40285)
CheckOffset(struct statvfs64,f_namemax,36,12,40285)
#endif
