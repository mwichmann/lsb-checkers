...
CheckMemberSize(struct statvfs,f_frsize,0,10,34519)
CheckOffset(struct statvfs,f_frsize,4,10,34519)
CheckMemberSize(struct statvfs,f_blocks,0,10,34520)
CheckOffset(struct statvfs,f_blocks,8,10,34520)
CheckMemberSize(struct statvfs,f_bfree,0,10,34521)
CheckOffset(struct statvfs,f_bfree,12,10,34521)
CheckMemberSize(struct statvfs,f_bavail,0,10,34522)
CheckOffset(struct statvfs,f_bavail,16,10,34522)
CheckMemberSize(struct statvfs,f_files,0,10,34523)
CheckOffset(struct statvfs,f_files,20,10,34523)
CheckMemberSize(struct statvfs,f_ffree,0,10,34524)
CheckOffset(struct statvfs,f_ffree,24,10,34524)
CheckMemberSize(struct statvfs,f_favail,0,10,34525)
CheckOffset(struct statvfs,f_favail,28,10,34525)
CheckMemberSize(struct statvfs,f_fsid,0,10,34526)
CheckOffset(struct statvfs,f_fsid,32,10,34526)
CheckMemberSize(struct statvfs,__f_unused,0,10,34527)
CheckOffset(struct statvfs,__f_unused,36,10,34527)
CheckMemberSize(struct statvfs,f_flag,0,10,34528)
CheckOffset(struct statvfs,f_flag,40,10,34528)
CheckMemberSize(struct statvfs,f_namemax,0,10,34529)
CheckOffset(struct statvfs,f_namemax,44,10,34529)
CheckMemberSize(struct statvfs,__f_spare,0,10,34530)
...
CheckMemberSize(struct statvfs64,f_frsize,0,10,34533)
CheckOffset(struct statvfs64,f_frsize,4,10,34533)
CheckMemberSize(struct statvfs64,f_blocks,0,10,34534)
CheckOffset(struct statvfs64,f_blocks,8,10,34534)
CheckMemberSize(struct statvfs64,f_bfree,0,10,34535)
CheckOffset(struct statvfs64,f_bfree,16,10,34535)
CheckMemberSize(struct statvfs64,f_bavail,0,10,34536)
CheckOffset(struct statvfs64,f_bavail,24,10,34536)
CheckMemberSize(struct statvfs64,f_files,0,10,34537)
CheckOffset(struct statvfs64,f_files,32,10,34537)
CheckMemberSize(struct statvfs64,f_ffree,0,10,34538)
CheckOffset(struct statvfs64,f_ffree,40,10,34538)
CheckMemberSize(struct statvfs64,f_favail,0,10,34539)
CheckOffset(struct statvfs64,f_favail,48,10,34539)
CheckMemberSize(struct statvfs64,f_fsid,0,10,34540)
CheckOffset(struct statvfs64,f_fsid,56,10,34540)
CheckMemberSize(struct statvfs64,__f_unused,0,10,34541)
CheckOffset(struct statvfs64,__f_unused,60,10,34541)
CheckMemberSize(struct statvfs64,f_flag,0,10,34542)
CheckOffset(struct statvfs64,f_flag,64,10,34542)
CheckMemberSize(struct statvfs64,f_namemax,0,10,34543)
CheckOffset(struct statvfs64,f_namemax,68,10,34543)
CheckMemberSize(struct statvfs64,__f_spare,0,10,34544)
