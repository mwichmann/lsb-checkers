...
#elif __powerpc64__
CheckTypeSize(struct utmpx,384, 10555, 9)
...
CheckMemberSize(struct utmpx,ut_session,4,9,40293)
CheckOffset(struct utmpx,ut_session,336,9,40293)
CheckMemberSize(struct utmpx,ut_tv,8,9,40294)
CheckOffset(struct utmpx,ut_tv,340,9,40294)
CheckMemberSize(struct utmpx,ut_addr_v6,16,9,40295)
CheckOffset(struct utmpx,ut_addr_v6,348,9,40295)
CheckMemberSize(struct utmpx,__unused,20,9,40296)
CheckOffset(struct utmpx,__unused,364,9,40296)
#elif __ia64__
