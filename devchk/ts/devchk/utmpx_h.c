...
#elif __s390x__
CheckTypeSize(struct utmpx,400, 10555, 12)
...
CheckMemberSize(struct utmpx,ut_session,8,12,40293)
CheckOffset(struct utmpx,ut_session,336,12,40293)
CheckMemberSize(struct utmpx,ut_tv,16,12,40294)
CheckOffset(struct utmpx,ut_tv,344,12,40294)
CheckMemberSize(struct utmpx,ut_addr_v6,16,12,40295)
CheckOffset(struct utmpx,ut_addr_v6,360,12,40295)
CheckMemberSize(struct utmpx,__unused,20,12,40296)
CheckOffset(struct utmpx,__unused,376,12,40296)
#elif __s390__ && !__s390x__
...
#elif __powerpc64__
CheckTypeSize(struct utmpx,400, 10555, 9)
CheckMemberSize(struct utmpx,ut_pid,4,9,40287)
CheckOffset(struct utmpx,ut_pid,4,9,40287)
CheckMemberSize(struct utmpx,ut_line,32,9,40288)
CheckOffset(struct utmpx,ut_line,8,9,40288)
CheckMemberSize(struct utmpx,ut_id,4,9,40289)
CheckOffset(struct utmpx,ut_id,40,9,40289)
CheckMemberSize(struct utmpx,ut_user,32,9,40290)
CheckOffset(struct utmpx,ut_user,44,9,40290)
CheckMemberSize(struct utmpx,ut_host,256,9,40291)
CheckOffset(struct utmpx,ut_host,76,9,40291)
CheckMemberSize(struct utmpx,ut_exit,4,9,40292)
CheckOffset(struct utmpx,ut_exit,332,9,40292)
CheckMemberSize(struct utmpx,ut_session,8,9,40293)
CheckOffset(struct utmpx,ut_session,336,9,40293)
CheckMemberSize(struct utmpx,ut_tv,16,9,40294)
CheckOffset(struct utmpx,ut_tv,344,9,40294)
CheckMemberSize(struct utmpx,ut_addr_v6,16,9,40295)
CheckOffset(struct utmpx,ut_addr_v6,360,9,40295)
CheckMemberSize(struct utmpx,__unused,20,9,40296)
CheckOffset(struct utmpx,__unused,376,9,40296)
#elif __ia64__
CheckTypeSize(struct utmpx,400, 10555, 3)
CheckMemberSize(struct utmpx,ut_pid,4,3,40287)
CheckOffset(struct utmpx,ut_pid,4,3,40287)
CheckMemberSize(struct utmpx,ut_line,32,3,40288)
CheckOffset(struct utmpx,ut_line,8,3,40288)
CheckMemberSize(struct utmpx,ut_id,4,3,40289)
CheckOffset(struct utmpx,ut_id,40,3,40289)
CheckMemberSize(struct utmpx,ut_user,32,3,40290)
CheckOffset(struct utmpx,ut_user,44,3,40290)
CheckMemberSize(struct utmpx,ut_host,256,3,40291)
CheckOffset(struct utmpx,ut_host,76,3,40291)
CheckMemberSize(struct utmpx,ut_exit,4,3,40292)
CheckOffset(struct utmpx,ut_exit,332,3,40292)
CheckMemberSize(struct utmpx,ut_session,8,3,40293)
CheckOffset(struct utmpx,ut_session,336,3,40293)
CheckMemberSize(struct utmpx,ut_tv,16,3,40294)
CheckOffset(struct utmpx,ut_tv,344,3,40294)
CheckMemberSize(struct utmpx,ut_addr_v6,16,3,40295)
CheckOffset(struct utmpx,ut_addr_v6,360,3,40295)
CheckMemberSize(struct utmpx,__unused,20,3,40296)
CheckOffset(struct utmpx,__unused,376,3,40296)
#else
