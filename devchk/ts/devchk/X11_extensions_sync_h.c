...
CheckInterfacedef(XSyncAwait,XSyncAwait_db);
extern int XSyncChangeAlarm_db(Display *, XSyncAlarm, unsigned long int, XSyncAlarmAttributes *);
CheckInterfacedef(XSyncChangeAlarm,XSyncChangeAlarm_db);
extern int XSyncChangeCounter_db(Display *, XSyncCounter, XSyncValue);
CheckInterfacedef(XSyncChangeCounter,XSyncChangeCounter_db);
extern XSyncAlarm XSyncCreateAlarm_db(Display *, unsigned long int, XSyncAlarmAttributes *);
CheckInterfacedef(XSyncCreateAlarm,XSyncCreateAlarm_db);
extern XSyncCounter XSyncCreateCounter_db(Display *, XSyncValue);
CheckInterfacedef(XSyncCreateCounter,XSyncCreateCounter_db);
extern int XSyncDestroyAlarm_db(Display *, XSyncAlarm);
CheckInterfacedef(XSyncDestroyAlarm,XSyncDestroyAlarm_db);
extern int XSyncDestroyCounter_db(Display *, XSyncCounter);
CheckInterfacedef(XSyncDestroyCounter,XSyncDestroyCounter_db);
extern void XSyncFreeSystemCounterList_db(XSyncSystemCounter *);
CheckInterfacedef(XSyncFreeSystemCounterList,XSyncFreeSystemCounterList_db);
extern int XSyncGetPriority_db(Display *, XID, int *);
CheckInterfacedef(XSyncGetPriority,XSyncGetPriority_db);
extern int XSyncInitialize_db(Display *, int *, int *);
CheckInterfacedef(XSyncInitialize,XSyncInitialize_db);
extern void XSyncIntToValue_db(XSyncValue *, int);
CheckInterfacedef(XSyncIntToValue,XSyncIntToValue_db);
extern void XSyncIntsToValue_db(XSyncValue *, unsigned int, int);
CheckInterfacedef(XSyncIntsToValue,XSyncIntsToValue_db);
extern XSyncSystemCounter * XSyncListSystemCounters_db(Display *, int *);
CheckInterfacedef(XSyncListSystemCounters,XSyncListSystemCounters_db);
extern void XSyncMaxValue_db(XSyncValue *);
CheckInterfacedef(XSyncMaxValue,XSyncMaxValue_db);
extern void XSyncMinValue_db(XSyncValue *);
CheckInterfacedef(XSyncMinValue,XSyncMinValue_db);
extern int XSyncQueryAlarm_db(Display *, XSyncAlarm, XSyncAlarmAttributes *);
CheckInterfacedef(XSyncQueryAlarm,XSyncQueryAlarm_db);
extern int XSyncQueryCounter_db(Display *, XSyncCounter, XSyncValue *);
CheckInterfacedef(XSyncQueryCounter,XSyncQueryCounter_db);
extern int XSyncQueryExtension_db(Display *, int *, int *);
CheckInterfacedef(XSyncQueryExtension,XSyncQueryExtension_db);
extern int XSyncSetCounter_db(Display *, XSyncCounter, XSyncValue);
CheckInterfacedef(XSyncSetCounter,XSyncSetCounter_db);
extern int XSyncSetPriority_db(Display *, XID, int);
CheckInterfacedef(XSyncSetPriority,XSyncSetPriority_db);
extern void XSyncValueAdd_db(XSyncValue *, XSyncValue, XSyncValue, int *);
CheckInterfacedef(XSyncValueAdd,XSyncValueAdd_db);
extern int XSyncValueEqual_db(XSyncValue, XSyncValue);
CheckInterfacedef(XSyncValueEqual,XSyncValueEqual_db);
extern int XSyncValueGreaterOrEqual_db(XSyncValue, XSyncValue);
CheckInterfacedef(XSyncValueGreaterOrEqual,XSyncValueGreaterOrEqual_db);
extern int XSyncValueGreaterThan_db(XSyncValue, XSyncValue);
CheckInterfacedef(XSyncValueGreaterThan,XSyncValueGreaterThan_db);
extern int XSyncValueHigh32_db(XSyncValue);
CheckInterfacedef(XSyncValueHigh32,XSyncValueHigh32_db);
extern int XSyncValueIsNegative_db(XSyncValue);
CheckInterfacedef(XSyncValueIsNegative,XSyncValueIsNegative_db);
extern int XSyncValueIsPositive_db(XSyncValue);
CheckInterfacedef(XSyncValueIsPositive,XSyncValueIsPositive_db);
extern int XSyncValueIsZero_db(XSyncValue);
CheckInterfacedef(XSyncValueIsZero,XSyncValueIsZero_db);
extern int XSyncValueLessOrEqual_db(XSyncValue, XSyncValue);
CheckInterfacedef(XSyncValueLessOrEqual,XSyncValueLessOrEqual_db);
extern int XSyncValueLessThan_db(XSyncValue, XSyncValue);
CheckInterfacedef(XSyncValueLessThan,XSyncValueLessThan_db);
extern unsigned int XSyncValueLow32_db(XSyncValue);
CheckInterfacedef(XSyncValueLow32,XSyncValueLow32_db);
extern void XSyncValueSubtract_db(XSyncValue *, XSyncValue, XSyncValue, int *);
CheckInterfacedef(XSyncValueSubtract,XSyncValueSubtract_db);
#ifdef TET_TEST
if (pcnt == cnt )
	tet_result(TET_PASS);
else
