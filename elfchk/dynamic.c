...
int
checkDT_HASH(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_INIT(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_NEEDED(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
  int  j;
...
int
checkDT_NULL(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_PLTGOT(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_PLTRELSZ(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_RELA(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_RELAENT(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_RELASZ(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_STRSZ(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_STRTAB(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_SYMENT(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_SYMTAB(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_ADDRRNGHI(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_ADDRRNGLO(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_AUXILIARY(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_BIND_NOW(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_DEBUG(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_FILTER(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_FINI(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_FINI_ARRAY(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_FINI_ARRAYSZ(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_FLAGS_1(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_HIOS(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_HIPROC(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_INIT_ARRAY(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_INIT_ARRAYSZ(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_JMPREL(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_LOOS(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_LOPROC(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_NUM(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_PLTREL(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_POSFLAG_1(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_REL(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_RELCOUNT(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_RELACOUNT(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_RELENT(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_RELSZ(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_RPATH(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_RUNPATH(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_FLAGS(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_PREINIT_ARRAY(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_PREINIT_ARRAYSZ(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_SONAME(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_SYMBOLIC(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_SYMINENT(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_SYMINFO(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_SYMINSZ(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_TEXTREL(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_VALRNGHI(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_VALRNGLO(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_VERDEF(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_VERDEFNUM(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_VERNEED(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_VERNEEDNUM(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDT_VERSYM(ElfFile *file1, Elf_Shdr *hdr1, Elf_Dyn *dyn1, tetjp journal)
{
#ifdef VERBOSE
...
int
checkDYNAMIC(ElfFile *file1, Elf_Shdr *hdr1, tetjp journal )
{
  ...
  for(i=0;i<numdyn;i++) {
    ...
    if( j == numDynamicInfo[LSB_Version] ) {
      if ((u_long)dyn1[i].d_tag < 256)
        snprintf(tmp_string, TMP_STRING_SIZE,
                 "Dynamic entry with tag %ld (%s) is not allowed to be present in the DYNAMIC section",
                  (u_long)dyn1[i].d_tag, 
                  get_tag_name((u_long)dyn1[i].d_tag));
      else
        snprintf(tmp_string, TMP_STRING_SIZE,
                 "Dynamic entry with tag 0x%lx (%s) is not allowed to be present in the DYNAMIC section",
                 (u_long)dyn1[i].d_tag,
                 get_tag_name((u_long)dyn1[i].d_tag));
      fprintf(stderr, "%s\n", tmp_string);
      tetj_testcase_info(journal, tetj_activity_count, tetj_tp_count,
