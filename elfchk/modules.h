...
#define LSB_Perl	0x10
#define LSB_Printing	0x20
#define LSB_Python	0x40
#define LSB_Toolkit_Gtk	0x80
#define LSB_Toolkit_Qt	0x100
#define LSB_Toolkit_Qt3	0x200
#define LSB_TUM	0x400
#define LSB_XML	0x800
