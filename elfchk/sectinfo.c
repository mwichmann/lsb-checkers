...
struct SectionInfo* SectionInfo[] = {SectionInfo_LSB30, SectionInfo_LSB31, SectionInfo_LSB32};
int numSectionInfo[] = {sizeof(SectionInfo_LSB30)/sizeof(struct SectionInfo), sizeof(SectionInfo_LSB31)/sizeof(struct SectionInfo), sizeof(SectionInfo_LSB32)/sizeof(struct SectionInfo)};
