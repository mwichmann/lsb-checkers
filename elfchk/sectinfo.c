...
struct SectionInfo SectionInfo_LSB50[] = {
#if defined __powerpc64__
	{".branch_lt",SHT_PROGBITS,SHF_ALLOC+SHF_WRITE,checkPROGBITS},
#endif /* defined __powerpc64__ */
	{".bss",SHT_NOBITS,SHF_ALLOC+SHF_WRITE,checkNOBITS},
...
int numSectionInfo_LSB50 = sizeof(SectionInfo_LSB50)/sizeof(struct SectionInfo);

struct SectionInfo* SectionInfo[] = {SectionInfo_LSB30, SectionInfo_LSB31, SectionInfo_LSB32, SectionInfo_LSB40, SectionInfo_LSB41, SectionInfo_LSB50};
int numSectionInfo[] = {sizeof(SectionInfo_LSB30)/sizeof(struct SectionInfo), sizeof(SectionInfo_LSB31)/sizeof(struct SectionInfo), sizeof(SectionInfo_LSB32)/sizeof(struct SectionInfo), sizeof(SectionInfo_LSB40)/sizeof(struct SectionInfo), sizeof(SectionInfo_LSB41)/sizeof(struct SectionInfo), sizeof(SectionInfo_LSB50)/sizeof(struct SectionInfo)};
