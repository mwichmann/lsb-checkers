...
{RPMTAG_CHANGELOGTIME,	"RPMTAG_CHANGELOGTIME",	INT32,	1,	checkRpmIdxCHANGELOGTIME,	Required,	NotSeen},
...
{RPMTAG_OPTFLAGS,	"RPMTAG_OPTFLAGS",	STRING,	1,	checkRpmIdxOPTFLAGS,	Required,	NotSeen},
