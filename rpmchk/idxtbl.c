...
{RPMTAG_HEADERIMMUTABLE,	"RPMTAG_HEADERIMMUTABLE",	BIN,	16,	checkRpmIdxHEADERIMMUTABLE,	Reserved,	NotSeen},
...
{RPMTAG_PREREQ,	"RPMTAG_PREREQ",	STRING_ARRAY,	0,	checkRpmIdxPREREQ,	Optional,	NotSeen},
