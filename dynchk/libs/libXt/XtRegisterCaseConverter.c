...
static void(*funcptr) (Display * , XtCaseProc , KeySym , KeySym ) = 0;
...
void XtRegisterCaseConverter (Display * arg0 , XtCaseProc arg1 , KeySym arg2 , KeySym arg3 )
{
	...
	__lsb_output(5-__lsb_check_params, "XtRegisterCaseConverter()");
	validate_RWaddress( arg0, "XtRegisterCaseConverter - arg0");
		...
		validate_NULL_TYPETYPE(  arg3, "XtRegisterCaseConverter - arg3");
	}
