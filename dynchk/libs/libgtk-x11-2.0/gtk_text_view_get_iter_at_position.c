...
static void(*funcptr) (GtkTextView * , GtkTextIter * , gint * , gint , gint ) = 0;

extern int __lsb_check_params;
void gtk_text_view_get_iter_at_position (GtkTextView * arg0 , GtkTextIter * arg1 , gint * arg2 , gint arg3 , gint arg4 )
{
	int reset_flag = __lsb_check_params;
	__lsb_output(4, "Invoking wrapper for gtk_text_view_get_iter_at_position()");
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "gtk_text_view_get_iter_at_position");
	if(!funcptr) {
		__lsb_output(-1, "Failed to load gtk_text_view_get_iter_at_position. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
