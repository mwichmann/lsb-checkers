...
void gtk_paned_pack2 (GtkPaned * arg0 , GtkWidget * arg1 , gboolean arg2 , gboolean arg3 )
{
	int reset_flag = __lsb_check_params;
	__lsb_output(4, "Invoking wrapper for gtk_paned_pack2()");
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "gtk_paned_pack2");
	if(!funcptr) {
		__lsb_output(-1, "Failed to load gtk_paned_pack2. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
