...
void gtk_box_set_child_packing (GtkBox * arg0 , GtkWidget * arg1 , gboolean arg2 , gboolean arg3 , guint arg4 , GtkPackType arg5 )
{
	int reset_flag = __lsb_check_params;
	__lsb_output(4, "Invoking wrapper for gtk_box_set_child_packing()");
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "gtk_box_set_child_packing");
	if(!funcptr) {
		__lsb_output(-1, "Failed to load gtk_box_set_child_packing. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
	if(__lsb_check_params)
	{
		...
		validate_NULL_TYPETYPE(  arg4, "gtk_box_set_child_packing - arg4 (padding)");
		validate_NULL_TYPETYPE(  arg5, "gtk_box_set_child_packing - arg5 (pack_type)");
	}
