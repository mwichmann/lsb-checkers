...
static void(*funcptr) (GtkStyle * , GdkWindow * , GtkStateType , const GdkRectangle * , GtkWidget * , const gchar * , gint , gint , GtkExpanderStyle ) = 0;

extern int __lsb_check_params;
void gtk_paint_expander (GtkStyle * arg0 , GdkWindow * arg1 , GtkStateType arg2 , const GdkRectangle * arg3 , GtkWidget * arg4 , const gchar * arg5 , gint arg6 , gint arg7 , GtkExpanderStyle arg8 )
{
	int reset_flag = __lsb_check_params;
	__lsb_output(4, "Invoking wrapper for gtk_paint_expander()");
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "gtk_paint_expander");
	if(!funcptr) {
		__lsb_output(-1, "Failed to load gtk_paint_expander. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
	if(__lsb_check_params)
	{
		...
		validate_NULL_TYPETYPE(  arg8, "gtk_paint_expander - arg8 (expander_style)");
	}
