...
static gboolean(*funcptr) (GtkClipboard * , const GtkTargetEntry * , guint , GtkClipboardGetFunc , GtkClipboardClearFunc , GObject * ) = 0;

extern int __lsb_check_params;
gboolean gtk_clipboard_set_with_owner (GtkClipboard * arg0 , const GtkTargetEntry * arg1 , guint arg2 , GtkClipboardGetFunc arg3 , GtkClipboardClearFunc arg4 , GObject * arg5 )
{
	int reset_flag = __lsb_check_params;
	gboolean ret_value  ;
	__lsb_output(4, "Invoking wrapper for gtk_clipboard_set_with_owner()");
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "gtk_clipboard_set_with_owner");
	if(!funcptr) {
		__lsb_output(-1, "Failed to load gtk_clipboard_set_with_owner. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
