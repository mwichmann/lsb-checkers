...
void gtk_ruler_get_range (GtkRuler * arg0 , gdouble * arg1 , gdouble * arg2 , gdouble * arg3 , gdouble * arg4 )
{
	int reset_flag = __lsb_check_params;
	__lsb_output(4, "Invoking wrapper for gtk_ruler_get_range()");
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "gtk_ruler_get_range");
	if(!funcptr) {
		__lsb_output(-1, "Failed to load gtk_ruler_get_range. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
