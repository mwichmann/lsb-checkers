...
void gtk_alignment_get_padding (GtkAlignment * arg0 , guint * arg1 , guint * arg2 , guint * arg3 , guint * arg4 )
{
	int reset_flag = __lsb_check_params;
	__lsb_output(4, "Invoking wrapper for gtk_alignment_get_padding()");
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "gtk_alignment_get_padding");
	if(!funcptr) {
		__lsb_output(-1, "Failed to load gtk_alignment_get_padding. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
