...
void gtk_tree_view_tree_to_widget_coords (GtkTreeView * arg0 , gint arg1 , gint arg2 , gint * arg3 , gint * arg4 )
{
	int reset_flag = __lsb_check_params;
	__lsb_output(4, "Invoking wrapper for gtk_tree_view_tree_to_widget_coords()");
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "gtk_tree_view_tree_to_widget_coords");
	if(!funcptr) {
		__lsb_output(-1, "Failed to load gtk_tree_view_tree_to_widget_coords. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
