...
static void(*funcptr) (GtkListStore * , GtkTreeIter * , gint , gint * , GValue * , gint ) = 0;

extern int __lsb_check_params;
void gtk_list_store_insert_with_valuesv (GtkListStore * arg0 , GtkTreeIter * arg1 , gint arg2 , gint * arg3 , GValue * arg4 , gint arg5 )
{
	int reset_flag = __lsb_check_params;
	__lsb_output(4, "Invoking wrapper for gtk_list_store_insert_with_valuesv()");
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "gtk_list_store_insert_with_valuesv");
	if(!funcptr) {
		__lsb_output(-1, "Failed to load gtk_list_store_insert_with_valuesv. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
