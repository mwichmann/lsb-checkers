...
void gtk_paint_shadow (GtkStyle * arg0 , GdkWindow * arg1 , GtkStateType arg2 , GtkShadowType arg3 , const GdkRectangle * arg4 , GtkWidget * arg5 , const gchar * arg6 , gint arg7 , gint arg8 , gint arg9 , gint arg10 )
{
	int reset_flag = __lsb_check_params;
	__lsb_output(4, "Invoking wrapper for gtk_paint_shadow()");
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "gtk_paint_shadow");
	if(!funcptr) {
		__lsb_output(-1, "Failed to load gtk_paint_shadow. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
	if(__lsb_check_params)
	{
		...
		validate_NULL_TYPETYPE(  arg9, "gtk_paint_shadow - arg9 (width)");
		validate_NULL_TYPETYPE(  arg10, "gtk_paint_shadow - arg10 (height)");
	}
