...
static void(*funcptr) (GtkActionGroup * , const GtkToggleActionEntry * , guint , gpointer ) = 0;

extern int __lsb_check_params;
void gtk_action_group_add_toggle_actions (GtkActionGroup * arg0 , const GtkToggleActionEntry * arg1 , guint arg2 , gpointer arg3 )
{
	int reset_flag = __lsb_check_params;
	__lsb_output(4, "Invoking wrapper for gtk_action_group_add_toggle_actions()");
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "gtk_action_group_add_toggle_actions");
	if(!funcptr) {
		__lsb_output(-1, "Failed to load gtk_action_group_add_toggle_actions. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
