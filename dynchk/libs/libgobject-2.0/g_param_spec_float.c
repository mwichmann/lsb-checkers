...
GParamSpec * g_param_spec_float (const gchar * arg0 , const gchar * arg1 , const gchar * arg2 , gfloat arg3 , gfloat arg4 , gfloat arg5 , GParamFlags arg6 )
{
	...
	if(__lsb_check_params)
	{
		...
		if( arg0 ) {
		validate_Rdaddress( arg0, "g_param_spec_float - arg0 (name)");
		}
		validate_NULL_TYPETYPE(  arg0, "g_param_spec_float - arg0 (name)");
		if( arg1 ) {
		validate_Rdaddress( arg1, "g_param_spec_float - arg1 (nick)");
		}
		validate_NULL_TYPETYPE(  arg1, "g_param_spec_float - arg1 (nick)");
		if( arg2 ) {
		validate_Rdaddress( arg2, "g_param_spec_float - arg2 (blurb)");
		}
		validate_NULL_TYPETYPE(  arg2, "g_param_spec_float - arg2 (blurb)");
		validate_NULL_TYPETYPE(  arg3, "g_param_spec_float - arg3 (minimum)");
		validate_NULL_TYPETYPE(  arg4, "g_param_spec_float - arg4 (maximum)");
		validate_NULL_TYPETYPE(  arg5, "g_param_spec_float - arg5 (default_value)");
		validate_NULL_TYPETYPE(  arg6, "g_param_spec_float - arg6 (flags)");
	}
