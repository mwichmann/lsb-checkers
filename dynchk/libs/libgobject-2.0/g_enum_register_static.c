...
GType g_enum_register_static (const gchar * arg0 , const GEnumValue * arg1 )
{
	...
	if(__lsb_check_params)
	{
		...
		if( arg0 ) {
		validate_Rdaddress( arg0, "g_enum_register_static - arg0 (name)");
		}
		validate_NULL_TYPETYPE(  arg0, "g_enum_register_static - arg0 (name)");
		if( arg1 ) {
		validate_Rdaddress( arg1, "g_enum_register_static - arg1 (const_static_values)");
		}
		validate_NULL_TYPETYPE(  arg1, "g_enum_register_static - arg1 (const_static_values)");
	}
