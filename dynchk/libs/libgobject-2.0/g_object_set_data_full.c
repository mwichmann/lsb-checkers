...
void g_object_set_data_full (GObject * arg0 , const gchar * arg1 , gpointer arg2 , GDestroyNotify arg3 )
{
	...
	if(__lsb_check_params)
	{
		...
		if( arg0 ) {
		validate_RWaddress( arg0, "g_object_set_data_full - arg0 (object)");
		}
		validate_NULL_TYPETYPE(  arg0, "g_object_set_data_full - arg0 (object)");
		if( arg1 ) {
		validate_Rdaddress( arg1, "g_object_set_data_full - arg1 (key)");
		}
		validate_NULL_TYPETYPE(  arg1, "g_object_set_data_full - arg1 (key)");
		validate_NULL_TYPETYPE(  arg2, "g_object_set_data_full - arg2 (data)");
		validate_NULL_TYPETYPE(  arg3, "g_object_set_data_full - arg3 (destroy)");
	}
