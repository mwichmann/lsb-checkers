...
gpointer g_object_newv (GType arg0 , guint arg1 , GParameter * arg2 )
{
	...
	if(__lsb_check_params)
	{
		...
		validate_NULL_TYPETYPE(  arg0, "g_object_newv - arg0 (object_type)");
		validate_NULL_TYPETYPE(  arg1, "g_object_newv - arg1 (n_parameters)");
		if( arg2 ) {
		validate_RWaddress( arg2, "g_object_newv - arg2 (parameters)");
		}
		validate_NULL_TYPETYPE(  arg2, "g_object_newv - arg2 (parameters)");
	}
