...
gboolean g_param_value_validate (GParamSpec * arg0 , GValue * arg1 )
{
	...
	if(__lsb_check_params)
	{
		...
		if( arg0 ) {
		validate_RWaddress( arg0, "g_param_value_validate - arg0 (pspec)");
		}
		validate_NULL_TYPETYPE(  arg0, "g_param_value_validate - arg0 (pspec)");
		if( arg1 ) {
		validate_RWaddress( arg1, "g_param_value_validate - arg1 (value)");
		}
		validate_NULL_TYPETYPE(  arg1, "g_param_value_validate - arg1 (value)");
	}
