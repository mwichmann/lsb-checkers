...
void g_signal_emitv (const GValue * arg0 , guint arg1 , GQuark arg2 , GValue * arg3 )
{
	...
	if(__lsb_check_params)
	{
		...
		if( arg0 ) {
		validate_Rdaddress( arg0, "g_signal_emitv - arg0 (instance_and_params)");
		}
		validate_NULL_TYPETYPE(  arg0, "g_signal_emitv - arg0 (instance_and_params)");
		validate_NULL_TYPETYPE(  arg1, "g_signal_emitv - arg1 (signal_id)");
		validate_NULL_TYPETYPE(  arg2, "g_signal_emitv - arg2 (detail)");
		if( arg3 ) {
		validate_RWaddress( arg3, "g_signal_emitv - arg3 (return_value)");
		}
		validate_NULL_TYPETYPE(  arg3, "g_signal_emitv - arg3 (return_value)");
	}
