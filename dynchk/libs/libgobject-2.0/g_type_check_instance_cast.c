...
GTypeInstance * g_type_check_instance_cast (GTypeInstance * arg0 , GType arg1 )
{
	...
	if(__lsb_check_params)
	{
		...
		if( arg0 ) {
		validate_RWaddress( arg0, "g_type_check_instance_cast - arg0 (instance)");
		}
		validate_NULL_TYPETYPE(  arg0, "g_type_check_instance_cast - arg0 (instance)");
		validate_NULL_TYPETYPE(  arg1, "g_type_check_instance_cast - arg1 (iface_type)");
	}
