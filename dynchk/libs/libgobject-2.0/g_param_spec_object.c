...
GParamSpec * g_param_spec_object (const gchar * arg0 , const gchar * arg1 , const gchar * arg2 , GType arg3 , GParamFlags arg4 )
{
	...
	if(__lsb_check_params)
	{
		...
		if( arg0 ) {
		validate_Rdaddress( arg0, "g_param_spec_object - arg0 (name)");
		}
		validate_NULL_TYPETYPE(  arg0, "g_param_spec_object - arg0 (name)");
		if( arg1 ) {
		validate_Rdaddress( arg1, "g_param_spec_object - arg1 (nick)");
		}
		validate_NULL_TYPETYPE(  arg1, "g_param_spec_object - arg1 (nick)");
		if( arg2 ) {
		validate_Rdaddress( arg2, "g_param_spec_object - arg2 (blurb)");
		}
		validate_NULL_TYPETYPE(  arg2, "g_param_spec_object - arg2 (blurb)");
		validate_NULL_TYPETYPE(  arg3, "g_param_spec_object - arg3 (object_type)");
		validate_NULL_TYPETYPE(  arg4, "g_param_spec_object - arg4 (flags)");
	}
