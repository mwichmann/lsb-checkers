...
void g_dbus_error_register_error_domain (const gchar * arg0 , gsize volatile  * arg1 ,  arg2, guint arg3 )
{
	...
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "g_dbus_error_register_error_domain");
	if(!funcptr) {
		__lsb_output(-1, "Failed to load g_dbus_error_register_error_domain. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
	if(__lsb_check_params)
	{
		__lsb_check_params=0;
		__lsb_output(4, "g_dbus_error_register_error_domain() - validating");
		if( arg0 ) {
		validate_Rdaddress( arg0, "g_dbus_error_register_error_domain - arg0 (error_domain_quark_name)");
		}
		validate_NULL_TYPETYPE(  arg0, "g_dbus_error_register_error_domain - arg0 (error_domain_quark_name)");
		if( arg1 ) {
