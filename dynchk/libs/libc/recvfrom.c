...
#include <dlfcn.h>
#include <stddef.h>
static int(*funcptr)(int, void *, size_t, int, sockaddr *, socklen_t *) = 0;

int recvfrom(int arg0, void * arg1, size_t arg2, int arg3, sockaddr * arg4, socklen_t * arg5)
{
	if(!funcptr)
...
int lsb_recvfrom(int arg0, void * arg1, size_t arg2, int arg3, sockaddr * arg4, socklen_t * arg5)
{
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "recvfrom");
	return funcptr(arg0, arg1, arg2, arg3, arg4, arg5);
