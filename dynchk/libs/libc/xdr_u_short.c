...
bool_t xdr_u_short (XDR * arg0 , u_short * arg1 )
{
	...
	bool_t ret_value  ;
	if(!funcptr)
		funcptr = lsb_dlvsym(RTLD_NEXT, "xdr_u_short", "GLIBC_2.0");
	if(__lsb_check_params)
	{
		__lsb_check_params=0;
		__lsb_output(4, "xdr_u_short()");
		validate_RWaddress( arg0, "xdr_u_short - arg0");
		validate_NULL_TYPETYPE(  arg0, "xdr_u_short - arg0");
		validate_RWaddress( arg1, "xdr_u_short - arg1");
