...
#include <dlfcn.h>
static int(*funcptr)(int, int, int, int array) = 0;

int socketpair(int arg0, int arg1, int arg2, int array arg3)
{
	if(!funcptr)
...
int lsb_socketpair(int arg0, int arg1, int arg2, int array arg3)
{
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "socketpair");
	return funcptr(arg0, arg1, arg2, arg3);
