...
float __wcstof_internal (const wchar_t * arg0 , wchar_t * * arg1 , int arg2 )
{
	...
	float ret_value  ;
	__lsb_output(4, "Invoking wrapper for __wcstof_internal()");
	if(!funcptr)
		#if defined __i386__
		...
		#endif
		#if defined __ia64__
			funcptr = dlvsym(RTLD_NEXT, "__wcstof_internal", "GLIBC_2.2");
		#endif
		#if defined __s390x__
			funcptr = dlvsym(RTLD_NEXT, "__wcstof_internal", "GLIBC_2.2");
		#endif
		#if defined __x86_64__
			funcptr = dlvsym(RTLD_NEXT, "__wcstof_internal", "GLIBC_2.2.5");
		#endif
		#if defined __powerpc64__
			funcptr = dlvsym(RTLD_NEXT, "__wcstof_internal", "GLIBC_2.3");
		#endif
	if(!funcptr) {
		__lsb_output(-1, "Failed to load __wcstof_internal. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
	if(__lsb_check_params)
	{
		__lsb_check_params=0;
		__lsb_output(4, "__wcstof_internal() - validating");
