...
static void *(*funcptr) (xmlHashTablePtr , const xmlChar * , const xmlChar * , const xmlChar * , const xmlChar * ) = 0;

extern int __lsb_check_params;
void * xmlHashQLookup2 (xmlHashTablePtr arg0 , const xmlChar * arg1 , const xmlChar * arg2 , const xmlChar * arg3 , const xmlChar * arg4 )
{
	int reset_flag = __lsb_check_params;
	void * ret_value  ;
	__lsb_output(4, "Invoking wrapper for xmlHashQLookup2()");
	if(!funcptr)
		#if 1
			funcptr = dlvsym(RTLD_NEXT, "xmlHashQLookup2", "LIBXML2_2.6.0");
		#endif
	if(!funcptr) {
		__lsb_output(-1, "Failed to load xmlHashQLookup2. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
