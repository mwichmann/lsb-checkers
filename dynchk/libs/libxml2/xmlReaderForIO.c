...
static xmlTextReaderPtr(*funcptr) (xmlInputReadCallback , xmlInputCloseCallback , void * , const char * , const char * , int ) = 0;

extern int __lsb_check_params;
xmlTextReaderPtr xmlReaderForIO (xmlInputReadCallback arg0 , xmlInputCloseCallback arg1 , void * arg2 , const char * arg3 , const char * arg4 , int arg5 )
{
	int reset_flag = __lsb_check_params;
	xmlTextReaderPtr ret_value  ;
	__lsb_output(4, "Invoking wrapper for xmlReaderForIO()");
	if(!funcptr)
		#if 1
			funcptr = dlvsym(RTLD_NEXT, "xmlReaderForIO", "LIBXML2_2.6.0");
		#endif
	if(!funcptr) {
		__lsb_output(-1, "Failed to load xmlReaderForIO. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
