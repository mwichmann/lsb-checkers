...
static void(*funcptr) (void * , const xmlChar * , const xmlChar * , const xmlChar * , int , const xmlChar * * , int , int , const xmlChar * * ) = 0;

extern int __lsb_check_params;
void xmlSAX2StartElementNs (void * arg0 , const xmlChar * arg1 , const xmlChar * arg2 , const xmlChar * arg3 , int arg4 , const xmlChar * * arg5 , int arg6 , int arg7 , const xmlChar * * arg8 )
{
	int reset_flag = __lsb_check_params;
	__lsb_output(4, "Invoking wrapper for xmlSAX2StartElementNs()");
	if(!funcptr)
		#if 1
			funcptr = dlvsym(RTLD_NEXT, "xmlSAX2StartElementNs", "LIBXML2_2.6.0");
		#endif
	if(!funcptr) {
		__lsb_output(-1, "Failed to load xmlSAX2StartElementNs. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
