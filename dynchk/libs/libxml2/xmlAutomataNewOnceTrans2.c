...
xmlAutomataStatePtr xmlAutomataNewOnceTrans2 (xmlAutomataPtr arg0 , xmlAutomataStatePtr arg1 , xmlAutomataStatePtr arg2 , const xmlChar * arg3 , const xmlChar * arg4 , int arg5 , int arg6 , void * arg7 )
{
	int reset_flag = __lsb_check_params;
	xmlAutomataStatePtr ret_value  ;
	__lsb_output(4, "Invoking wrapper for xmlAutomataNewOnceTrans2()");
	if(!funcptr)
		#if 1
			funcptr = dlvsym(RTLD_NEXT, "xmlAutomataNewOnceTrans2", "LIBXML2_2.6.14");
		#endif
	if(!funcptr) {
		__lsb_output(-1, "Failed to load xmlAutomataNewOnceTrans2. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
	if(__lsb_check_params)
	{
		__lsb_check_params=0;
		__lsb_output(4, "xmlAutomataNewOnceTrans2() - validating");
