...
static png_int_32(*funcptr) (png_const_bytep ) = 0;

extern int __lsb_check_params;
png_int_32 png_get_int_32 (png_const_bytep arg0 )
{
	...
	if(__lsb_check_params)
	{
		...
		__lsb_output(4, "png_get_int_32() - validating");
		validate_NULL_TYPETYPE(  arg0, "png_get_int_32 - arg0 (buf)");
	}
