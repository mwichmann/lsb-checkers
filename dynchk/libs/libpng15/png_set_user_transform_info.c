...
static void(*funcptr) (png_rw_ptr , png_rw_ptr , int , int ) = 0;

extern int __lsb_check_params;
void png_set_user_transform_info (png_rw_ptr arg0 , png_rw_ptr arg1 , int arg2 , int arg3 )
{
	int reset_flag = __lsb_check_params;
	__lsb_output(4, "Invoking wrapper for png_set_user_transform_info()");
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "png_set_user_transform_info");
	if(!funcptr) {
