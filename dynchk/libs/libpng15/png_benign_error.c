...
void png_benign_error (png_structp arg0 , png_const_charp arg1 )
{
	...
	if(__lsb_check_params)
	{
		...
		__lsb_output(4, "png_benign_error() - validating");
		validate_NULL_TYPETYPE(  arg0, "png_benign_error - arg0 (png_ptr)");
		validate_NULL_TYPETYPE(  arg1, "png_benign_error - arg1 (warning_message)");
	}
	funcptr(arg0, arg1);
