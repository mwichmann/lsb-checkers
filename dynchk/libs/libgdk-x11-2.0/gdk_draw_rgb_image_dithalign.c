...
void gdk_draw_rgb_image_dithalign (GdkDrawable * arg0 , GdkGC * arg1 , gint arg2 , gint arg3 , gint arg4 , gint arg5 , GdkRgbDither arg6 , const guchar * arg7 , gint arg8 , gint arg9 , gint arg10 )
{
	int reset_flag = __lsb_check_params;
	__lsb_output(4, "Invoking wrapper for gdk_draw_rgb_image_dithalign()");
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "gdk_draw_rgb_image_dithalign");
	if(!funcptr) {
		__lsb_output(-1, "Failed to load gdk_draw_rgb_image_dithalign. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
	if(__lsb_check_params)
	{
		...
		validate_NULL_TYPETYPE(  arg10, "gdk_draw_rgb_image_dithalign - arg10 (ydith)");
	}
