...
static gint(*funcptr) (GdkDisplay * , const gchar * , GdkAtom * , gint * , guchar * * , gint * ) = 0;

extern int __lsb_check_params;
gint gdk_string_to_compound_text_for_display (GdkDisplay * arg0 , const gchar * arg1 , GdkAtom * arg2 , gint * arg3 , guchar * * arg4 , gint * arg5 )
{
	int reset_flag = __lsb_check_params;
	gint ret_value  ;
	__lsb_output(4, "Invoking wrapper for gdk_string_to_compound_text_for_display()");
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "gdk_string_to_compound_text_for_display");
	if(!funcptr) {
		__lsb_output(-1, "Failed to load gdk_string_to_compound_text_for_display. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
