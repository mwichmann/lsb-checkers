...
static void(*funcptr) (GdkDrawable * , GdkGC * , int , int , PangoLayout * , const GdkColor * , const GdkColor * ) = 0;

extern int __lsb_check_params;
void gdk_draw_layout_with_colors (GdkDrawable * arg0 , GdkGC * arg1 , int arg2 , int arg3 , PangoLayout * arg4 , const GdkColor * arg5 , const GdkColor * arg6 )
{
	int reset_flag = __lsb_check_params;
	__lsb_output(4, "Invoking wrapper for gdk_draw_layout_with_colors()");
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "gdk_draw_layout_with_colors");
	if(!funcptr) {
		__lsb_output(-1, "Failed to load gdk_draw_layout_with_colors. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
