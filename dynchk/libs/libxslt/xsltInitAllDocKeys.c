...
#undef xsltInitAllDocKeys
static int(*funcptr) (xsltTransformContextPtr ) = 0;

extern int __lsb_check_params;
int xsltInitAllDocKeys (xsltTransformContextPtr arg0 )
{
	...
	if(__lsb_check_params)
	{
		...
		__lsb_output(4, "xsltInitAllDocKeys() - validating");
		validate_NULL_TYPETYPE(  arg0, "xsltInitAllDocKeys - arg0 (ctxt)");
	}
