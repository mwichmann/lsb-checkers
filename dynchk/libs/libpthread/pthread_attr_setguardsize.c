...
int pthread_attr_setguardsize (pthread_attr_t * arg0 , size_t arg1 )
{
	...
	int ret_value  ;
	if(!funcptr)
		funcptr = lsb_dlvsym(RTLD_NEXT, "pthread_attr_setguardsize", "GLIBC_2.1");
	if(__lsb_check_params)
	{
		__lsb_check_params=0;
		__lsb_output(4, "pthread_attr_setguardsize()");
		validate_RWaddress( arg0, "pthread_attr_setguardsize - arg0");
