...
int pthread_attr_setstackaddr (pthread_attr_t * arg0 , void * arg1 )
{
	...
	int ret_value  ;
	if(!funcptr)
		funcptr = lsb_dlvsym(RTLD_NEXT, "pthread_attr_setstackaddr", "GLIBC_2.1");
	if(__lsb_check_params)
	{
		__lsb_check_params=0;
		__lsb_output(4, "pthread_attr_setstackaddr()");
		validate_RWaddress( arg0, "pthread_attr_setstackaddr - arg0");
		validate_NULL_TYPETYPE(  arg0, "pthread_attr_setstackaddr - arg0");
		validate_RWaddress( arg1, "pthread_attr_setstackaddr - arg1");
