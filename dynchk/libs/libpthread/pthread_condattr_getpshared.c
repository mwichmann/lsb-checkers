...
int pthread_condattr_getpshared (const pthread_condattr_t * arg0 , int * arg1 )
{
	...
	if(__lsb_check_params)
	{
		...
		__lsb_output(4, "pthread_condattr_getpshared() - validating");
		validate_Rdaddress( arg0, "pthread_condattr_getpshared - arg0 (__attr)");
		validate_NULL_TYPETYPE(  arg0, "pthread_condattr_getpshared - arg0 (__attr)");
		validate_RWaddress( arg1, "pthread_condattr_getpshared - arg1 (__pshared)");
		validate_NULL_TYPETYPE(  arg1, "pthread_condattr_getpshared - arg1 (__pshared)");
	}
