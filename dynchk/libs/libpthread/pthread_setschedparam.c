...
int pthread_setschedparam(pthread_t arg0, int arg1, struct sched_param * arg2)
{
	if(!funcptr)
...
int lsb_pthread_setschedparam(pthread_t arg0, int arg1, struct sched_param * arg2)
{
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "pthread_setschedparam");
	return funcptr(arg0, arg1, arg2);
