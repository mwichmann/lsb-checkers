...
const struct _GtkWidgetPath * gtk_theming_engine_get_path (GtkThemingEngine * arg0 )
{
	...
	if(!funcptr) {
		__lsb_output(-1, "Failed to load gtk_theming_engine_get_path. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
	if(__lsb_check_params)
	{
		__lsb_check_params=0;
		__lsb_output(4, "gtk_theming_engine_get_path() - validating");
		if( arg0 ) {
		validate_RWaddress( arg0, "gtk_theming_engine_get_path - arg0 (engine)");
		}
		validate_NULL_TYPETYPE(  arg0, "gtk_theming_engine_get_path - arg0 (engine)");
	}
