...
static void(*funcptr) (GtkWidget * , const char * , const struct _GdkRGBA * ) = 0;

extern int __lsb_check_params;
void gtk_widget_override_symbolic_color (GtkWidget * arg0 , const char * arg1 , const struct _GdkRGBA * arg2 )
{
