...
void gtk_style_properties_set_valist (GtkStyleProperties * arg0 , GtkStateFlags arg1 , struct __va_list_tag * arg2 )
{
	...
	if(__lsb_check_params)
	{
		...
		validate_NULL_TYPETYPE(  arg1, "gtk_style_properties_set_valist - arg1");
		if( arg2 ) {
		validate_RWaddress( arg2, "gtk_style_properties_set_valist - arg2");
		}
