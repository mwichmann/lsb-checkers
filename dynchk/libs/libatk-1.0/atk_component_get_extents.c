...
#undef atk_component_get_extents
static void(*funcptr) (AtkComponent * , gint * , gint * , gint * , gint * , AtkCoordType ) = 0;

extern int __lsb_check_params;
void atk_component_get_extents (AtkComponent * arg0 , gint * arg1 , gint * arg2 , gint * arg3 , gint * arg4 , AtkCoordType arg5 )
{
	int reset_flag = __lsb_check_params;
	__lsb_output(4, "Invoking wrapper for atk_component_get_extents()");
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "atk_component_get_extents");
	if(!funcptr) {
		__lsb_output(-1, "Failed to load atk_component_get_extents. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
