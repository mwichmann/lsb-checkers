...
void XSetWMSizeHints (Display * arg0 , Window arg1 , XSizeHints * arg2 , Atom arg3 )
{
	...
	__lsb_output(4, "Invoking wrapper for XSetWMSizeHints()");
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "XSetWMSizeHints");
	if(!funcptr) {
		__lsb_output(-1, "Failed to load XSetWMSizeHints. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
	if(__lsb_check_params)
	{
		__lsb_check_params=0;
		__lsb_output(4, "XSetWMSizeHints() - validating");
