...
int XFontsOfFontSet (XFontSet arg0 , XFontStruct * * * arg1 , char * * * arg2 )
{
	...
	int ret_value  ;
	__lsb_output(4, "Invoking wrapper for XFontsOfFontSet()");
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "XFontsOfFontSet");
	if(!funcptr) {
		__lsb_output(-1, "Failed to load XFontsOfFontSet. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
	if(__lsb_check_params)
	{
		__lsb_check_params=0;
		__lsb_output(4, "XFontsOfFontSet() - validating");
