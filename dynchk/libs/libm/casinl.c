...
long double complex casinl (long double complex arg0 )
{
	...
	__lsb_output(4, "Invoking wrapper for casinl()");
	if(!funcptr)
		#if defined __i386__
		...
		#endif
	if(!funcptr) {
		__lsb_output(-1, "Failed to load casinl. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
	if(__lsb_check_params)
	{
		__lsb_check_params=0;
		__lsb_output(4, "casinl() - validating");
