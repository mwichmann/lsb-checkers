...
gchar * g_filename_from_utf8 (const gchar * arg0 , gssize arg1 , gsize * arg2 , gsize * arg3 , GError * * arg4 )
{
	int reset_flag = __lsb_check_params;
	gchar * ret_value  ;
	__lsb_output(4, "Invoking wrapper for g_filename_from_utf8()");
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "g_filename_from_utf8");
	if(!funcptr) {
		__lsb_output(-1, "Failed to load g_filename_from_utf8. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
