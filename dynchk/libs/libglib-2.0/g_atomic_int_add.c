...
gint g_atomic_int_add (gint volatile  * arg0 , gint arg1 )
{
	...
	if(!funcptr) {
		__lsb_output(-1, "Failed to load g_atomic_int_add. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
	if(__lsb_check_params)
	{
		__lsb_check_params=0;
		__lsb_output(4, "g_atomic_int_add() - validating");
		validate_RWaddress( arg0, "g_atomic_int_add - arg0 (atomic)");
