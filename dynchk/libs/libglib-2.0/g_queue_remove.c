...
void g_queue_remove (GQueue * arg0 , gconstpointer arg1 )
{
	...
	if(!funcptr) {
		__lsb_output(-1, "Failed to load g_queue_remove. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
	if(__lsb_check_params)
	{
		__lsb_check_params=0;
		__lsb_output(4, "g_queue_remove() - validating");
		if( arg0 ) {
		validate_RWaddress( arg0, "g_queue_remove - arg0 (queue)");
		}
