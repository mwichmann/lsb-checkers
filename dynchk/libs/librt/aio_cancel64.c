...
int aio_cancel64 (int arg0 , struct aiocb64 * arg1 )
{
	int reset_flag = __lsb_check_params;
	int ret_value  ;
	__lsb_output(4, "Invoking wrapper for aio_cancel64()");
	if(!funcptr)
		#if defined __i386__
	...
	if(__lsb_check_params)
	{
		...
		__lsb_output(4, "aio_cancel64() - validating");
		validate_NULL_TYPETYPE(  arg0, "aio_cancel64 - arg0 (fildes)");
		if( arg1 ) {
		validate_RWaddress( arg1, "aio_cancel64 - arg1 (aiocbp)");
		}
		validate_NULL_TYPETYPE(  arg1, "aio_cancel64 - arg1 (aiocbp)");
	}
