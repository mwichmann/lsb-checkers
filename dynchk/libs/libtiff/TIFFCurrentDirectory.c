...
uint16 TIFFCurrentDirectory (TIFF * arg0 )
{
	...
	if(__lsb_check_params)
	{
		...
		__lsb_output(4, "TIFFCurrentDirectory() - validating");
		if( arg0 ) {
		validate_RWaddress( arg0, "TIFFCurrentDirectory - arg0");
		}
		validate_NULL_TYPETYPE(  arg0, "TIFFCurrentDirectory - arg0");
	}
