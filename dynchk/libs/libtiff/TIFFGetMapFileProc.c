...
#include "stdlib.h"
#include <tiffio.h>
#undef TIFFGetMapFileProc
static TIFFMapFileProc(*funcptr) (TIFF * ) = 0;

extern int __lsb_check_params;
TIFFMapFileProc TIFFGetMapFileProc (TIFF * arg0 )
{
	...
	if(__lsb_check_params)
	{
		...
		__lsb_output(4, "TIFFGetMapFileProc() - validating");
		if( arg0 ) {
		validate_RWaddress( arg0, "TIFFGetMapFileProc - arg0");
		}
		validate_NULL_TYPETYPE(  arg0, "TIFFGetMapFileProc - arg0");
	}
