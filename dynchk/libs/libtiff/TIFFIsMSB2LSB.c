...
int TIFFIsMSB2LSB (TIFF * arg0 )
{
	...
	if(__lsb_check_params)
	{
		...
		__lsb_output(4, "TIFFIsMSB2LSB() - validating");
		if( arg0 ) {
		validate_RWaddress( arg0, "TIFFIsMSB2LSB - arg0");
		}
		validate_NULL_TYPETYPE(  arg0, "TIFFIsMSB2LSB - arg0");
	}
