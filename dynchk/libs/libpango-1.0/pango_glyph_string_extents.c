...
#undef pango_glyph_string_extents
static void(*funcptr) (PangoGlyphString * , PangoFont * , PangoRectangle * , PangoRectangle * ) = 0;

extern int __lsb_check_params;
void pango_glyph_string_extents (PangoGlyphString * arg0 , PangoFont * arg1 , PangoRectangle * arg2 , PangoRectangle * arg3 )
{
	int reset_flag = __lsb_check_params;
	__lsb_output(4, "Invoking wrapper for pango_glyph_string_extents()");
	if(!funcptr)
		funcptr = dlsym(RTLD_NEXT, "pango_glyph_string_extents");
	if(!funcptr) {
		__lsb_output(-1, "Failed to load pango_glyph_string_extents. Probably the library was loaded using dlopen, we don't support this at the moment.");
		exit(1);
	}
