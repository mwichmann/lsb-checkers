...
int validate_struct__GtkEntryClass(struct _GtkEntryClass  * input, char *name)
{
int failure = 0;
	...
	if(validate_NULL_TYPETYPE(input-> toggle_overwrite,name ))
		failure = 1;
	if(validate_NULL_TYPETYPE(input-> get_text_area_size,name ))
		failure = 1;
	if(validate_NULL_TYPETYPE(input-> get_frame_size,name ))
		failure = 1;
