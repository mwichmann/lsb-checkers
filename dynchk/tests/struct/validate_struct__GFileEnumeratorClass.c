...
int validate_struct__GFileEnumeratorClass(struct _GFileEnumeratorClass  * input, char *name)
{
int failure = 0;
	if(validate_NULL_TYPETYPE(input-> parent_class,name ))
		failure = 1;
	if(validate_NULL_TYPETYPE(input-> next_file,name ))
		failure = 1;
	if(validate_NULL_TYPETYPE(input-> close_fn,name ))
		failure = 1;
	if(validate_NULL_TYPETYPE(input-> next_files_async,name ))
		failure = 1;
	if(validate_NULL_TYPETYPE(input-> next_files_finish,name ))
		failure = 1;
