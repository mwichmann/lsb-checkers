...
#if defined __i386__
int validate_struct_statfs64(struct statfs64  * input, char *name)
{
int failure = 0;
	if(validate_NULL_TYPETYPE(input-> f_type,name ))
		failure = 1;
	...
	if(validate_NULL_TYPETYPE(input-> f_fsid,name ))
		failure = 1;
	if(validate_NULL_TYPETYPE(input-> f_namelen,name ))
		failure = 1;
	if(validate_NULL_TYPETYPE(input-> f_frsize,name ))
		failure = 1;
	if(validate_NULL_TYPETYPE(input-> f_spare,name ))
		failure = 1;
return failure;
}
