...
int validate_struct__GtkToolItemClass(struct _GtkToolItemClass  * input, char *name)
{
int failure = 0;
	if(validate_NULL_TYPETYPE(input-> parent_class,name ))
		failure = 1;
	if(validate_NULL_TYPETYPE(input-> create_menu_proxy,name ))
		failure = 1;
	if(validate_NULL_TYPETYPE(input-> toolbar_reconfigured,name ))
		failure = 1;
