...
int validate_struct__GtkTreeModelFilterClass(struct _GtkTreeModelFilterClass  * input, char *name)
{
int failure = 0;
	if(validate_NULL_TYPETYPE(input-> parent_class,name ))
		failure = 1;
	if(validate_NULL_TYPETYPE(input-> visible,name ))
		failure = 1;
	if(validate_NULL_TYPETYPE(input-> modify,name ))
		failure = 1;
