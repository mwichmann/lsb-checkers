...
int validate_struct__GtkTextTagTableClass(struct _GtkTextTagTableClass  * input, char *name)
{
int failure = 0;
	if(validate_NULL_TYPETYPE(input-> parent_class,name ))
		failure = 1;
	if(validate_NULL_TYPETYPE(input-> tag_changed,name ))
		failure = 1;
	if(validate_NULL_TYPETYPE(input-> tag_added,name ))
		failure = 1;
	if(validate_NULL_TYPETYPE(input-> tag_removed,name ))
		failure = 1;
