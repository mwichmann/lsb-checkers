...
int validate_struct__GtkScaleClass(struct _GtkScaleClass  * input, char *name)
{
int failure = 0;
	if(validate_NULL_TYPETYPE(input-> parent_class,name ))
		failure = 1;
	if(validate_NULL_TYPETYPE(input-> format_value,name ))
		failure = 1;
	if(validate_NULL_TYPETYPE(input-> draw_value,name ))
		failure = 1;
	if(validate_NULL_TYPETYPE(input-> get_layout_offsets,name ))
		failure = 1;
