...
int validate_struct__GtkAssistantClass(struct _GtkAssistantClass  * input, char *name)
{
int failure = 0;
	if(validate_NULL_TYPETYPE(input-> parent_class,name ))
		failure = 1;
	if(validate_NULL_TYPETYPE(input-> prepare,name ))
		failure = 1;
	if(validate_NULL_TYPETYPE(input-> apply,name ))
		failure = 1;
