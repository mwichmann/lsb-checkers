...
int validate_struct__GtkStatusbarClass(struct _GtkStatusbarClass  * input, char *name)
{
int failure = 0;
	...
	if(validate_NULL_TYPETYPE(input-> reserved,name ))
		failure = 1;
	if(validate_NULL_TYPETYPE(input-> text_pushed,name ))
		failure = 1;
	if(validate_NULL_TYPETYPE(input-> text_popped,name ))
		failure = 1;
