...
#endif
#if defined __i386__
	{"dlvsym","GLIBC_2.1",0,LSB_Core,0,1},
#endif
#if defined __ia64__
	{"dlvsym","GLIBC_2.1",0,LSB_Core,8,1},
#endif
#if defined __powerpc__ && !defined __powerpc64__
	{"dlvsym","GLIBC_2.1",0,LSB_Core,4,1},
#endif
#if defined __powerpc64__
	{"dlvsym","GLIBC_2.3",0,LSB_Core,8,1},
#endif
#if defined __s390__ && !defined __s390x__
	{"dlvsym","GLIBC_2.1",0,LSB_Core,4,1},
#endif
#if defined __s390x__
	{"dlvsym","GLIBC_2.2",0,LSB_Core,8,1},
#endif
#if defined __x86_64__
	{"dlvsym","GLIBC_2.2.5",0,LSB_Core,8,1},
#endif
	{0,0}};
